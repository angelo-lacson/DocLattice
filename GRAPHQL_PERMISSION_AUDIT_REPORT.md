# DocLattice GraphQL Permissions Audit Report
...
This comprehensive audit reviewed all GraphQL mutations and queries in the DocLattice codebase for compliance with the consolidated permissioning guide. The audit identified **24 critical security violations**, **15 high-severity issues**, and significant opportunities to DRY up duplicative permission checking code.
...
#### `doclatticeserver/conversations/models.py`
...
8. **Extract helper functions** (6 patterns, ~340 lines duplicated)
   - Create `/home/user/DocLattice/config/graphql/permission_helpers.py`
