- **Authority Console — Phase 1 (namespace management API).** Added a runtime
  ...
  `AuthorityNamespaceService` (`doclatticeserver/enrichment/services/authority_namespace_service.py`)
...
- **Single authority-admin permission gate.** New
  `doclatticeserver/enrichment/services/authority_permissions.py::is_authority_admin`
