- **AgenticWebLocatorProvider** (Phase 4): opt-in, lowest-priority (9999) universal
  ...
  Located at `doclatticeserver/pipeline/authority_source_providers/agentic_web_locator_provider.py`.
  ...
  Covered by 17 unit + integration tests in `doclatticeserver/tests/test_agentic_web_locator.py`;
