- **Stop structural annotations leaking a private document via their shared structural set.**
  ...
  (`doclatticeserver/annotations/services/annotation_service.py`), which now requires a
  ...
  `doclatticeserver/tests/test_corpus_cards_structural_document_resolution.py`, including a
