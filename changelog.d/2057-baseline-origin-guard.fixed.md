- **Baseline-vs-baseline namespace clobbering fixed (issue #2057).** Two
  ...
  `post_migrate` convergence (`doclatticeserver/enrichment/_namespace_seed.py`)
  ...
  `doclatticeserver/tests/test_authority_mapping_loader.py::BaselineOriginGuardTests`
