- **Manually (re)generate a corpus icon via an agent.** A new
  ...
  (`doclatticeserver/llms/tools/core_tools/corpus_branding.py`) re-runs the
  ...
  `aregenerate_corpus_logo` in `doclatticeserver/corpuses/services/branding.py`
  ...
  (`doclatticeserver/llms/agents/pydantic_ai_agents.py`) alongside
  ...
  `doclatticeserver/tests/test_corpus_icon_tool.py`.
