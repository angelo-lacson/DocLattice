- **`manage.py install_authority_pack`** (`doclatticeserver/corpuses/management/commands/install_authority_pack.py`):
  ...
  `authority_pack_dirs()` (`doclatticeserver/pipeline/registry.py`) now scans the install dir as an
