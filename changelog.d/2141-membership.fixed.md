- **Corpus groups: silent membership data loss on edit.**
  `doclatticeserver/corpuses/services/corpus_groups.py::CorpusGroupService.update_group`
  ...
  Regression tests in `doclatticeserver/tests/test_corpus_groups.py`; rule
