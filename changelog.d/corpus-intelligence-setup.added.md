- **One-click collection-intelligence setup** — the orchestration layer the
  ...
  - `CorpusIntelligenceSetupService`
    (`doclatticeserver/corpuses/services/intelligence_setup.py`):
    ...
    *Document Description Updater* and *Document Summary Generator*
    ...
    `doclatticeserver/constants/corpus_actions.py`
  ...
  - Tests: `doclatticeserver/tests/test_intelligence_setup.py` (service +
