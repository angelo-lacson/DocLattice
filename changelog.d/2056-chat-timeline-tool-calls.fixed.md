- **Non-streaming `agent.chat()` now reports tool calls in `metadata["timeline"]`.**
  `PydanticAICoreAgent._chat_raw` (`doclatticeserver/llms/agents/pydantic_ai_agents.py`)
  ...
  `doclatticeserver/benchmarks/traversal_benchmark.py::run_one`, which reads
  ...
  `doclatticeserver/tests/test_pydantic_ai_agents.py::TestPydanticAIAgents::test_chat_metadata_includes_tool_call_timeline`.
