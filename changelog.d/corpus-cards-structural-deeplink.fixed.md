- **Corpus "Annotations" tab: structural annotations showed "Unknown Document" and produced broken deep links.**
  ...
  helper (`doclatticeserver/annotations/services/annotation_service.py`),
  ...
  `doclatticeserver/mcp/tools.py::search_corpus`. This adds no per-row queries
  ...
  `doclatticeserver/tests/test_corpus_cards_structural_document_resolution.py`.
