...
if __name__ == '__main__':
    ...
    result = subprocess.run(
        [
            ...
            'doclatticeserver.tests.test_admin',
            'doclatticeserver.tests.test_agent_api',
            'doclatticeserver.tests.test_agent_factory',
            'doclatticeserver.tests.test_agent_framework_api',
