...
(hundreds of thousands of files) into an DocLattice corpus — performantly and
...
```bash
export OC_API_BASE=https://your-doclattice.example.com
...
2. **Disable `ADD_DOCUMENT` CorpusActions during the load — most important.**
   ...
   (`doclatticeserver/corpuses/models.py`). An enabled auto-analysis/extract
   ...
   from doclatticeserver.corpuses.models import CorpusAction, CorpusActionTrigger
