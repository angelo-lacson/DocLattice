...
Feeds a local directory tree of PDFs into an DocLattice corpus through the
...
class OCClient:
    """Thin DocLattice API client for the multipart/chunked import endpoints
...
def build_parser() -> argparse.ArgumentParser:
    ...
    common.add_argument(
        ...
        help="DocLattice base URL (default: env OC_API_BASE "
    ...
    p = argparse.ArgumentParser(
        prog="oc_bulk_import",
        description="Resumable bulk import of a local PDF tree into DocLattice.",
    )
