...
This document tracks the implementation status of DocLattice' discussion and commenting system, including the @ mentions feature for referencing corpuses and documents within conversations.

## Architecture Components

### 1. Backend Models (Complete ✅)

**Conversation Model** (`doclatticeserver/conversations/models.py`)
...
- Tests: `doclatticeserver/tests/test_mentions.py` (search tests passing ✅)
