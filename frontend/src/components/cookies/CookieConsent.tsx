    ...
    <Modal basic size="small" open>
      ...
      <Modal.Content style={{ marginTop: "0", paddingTop: "0" }}>
        ...
        <p>
          ...
          refine DocLattice. We do not sell or share user information. Please
        ...
        {analyticsEnabled && (
          <>
            ...
            <p>
              ...
              understand how DocLattice is used and improve the experience.
              This includes:
            </p>
            <List>
              <List.Item>
            ...
            <p style={{ fontSize: "0.9em", opacity: 0.8 }}>
              Analytics data is used solely to improve DocLattice and is
