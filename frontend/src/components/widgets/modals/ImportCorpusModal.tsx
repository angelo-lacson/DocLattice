/**
 * ImportCorpusModal - Modal for importing a full DocLattice corpus export ZIP.
 *
 ...
 * upload is rejected.
 *
 * The legacy ``importDocLatticeZip`` GraphQL mutation was removed
    ...
    <div>
      <AlertBox $variant="warning">
        ...
        <AlertBody>
          ...
          <p>
            {targetCorpus
              ? "This will hydrate the installed pack corpus from an DocLattice export ZIP. Note:"
              : "This will unpack the DocLattice export ZIP into a brand-new corpus that you own. Note:"}
          </p>
          <ul>
            <li>
