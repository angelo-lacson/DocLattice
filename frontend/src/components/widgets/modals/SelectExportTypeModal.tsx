 ...
 * 1) Choose an export type from a dropdown, e.g. DocLattice, FUNSD, etc.
...
import doclattice_icon from "../../../assets/icons/oc_45_dark.png";
      ...
      <Modal open={open} onClose={onClose} size="lg" closeOnEscape>
        ...
        <ModalBody style={{ position: "relative" }}>
          ...
          <FormSection>
            ...
            <FormatList>
              <FormatOption
                $isSelected={exportFormat === ExportTypes.DOCLATTICE}
                onClick={() => handleFormatSelect(ExportTypes.DOCLATTICE)}
                data-testid="format-doclattice"
              >
                {exportFormat === ExportTypes.DOCLATTICE ? (
                  <SelectedIndicator />
                ) : (
                  <UnselectedIndicator />
                )}
                <FormatIcon src={doclattice_icon} alt="DocLattice" />
                <FormatInfo>
                  <FormatName>DocLattice</FormatName>
                  <FormatDescription>
