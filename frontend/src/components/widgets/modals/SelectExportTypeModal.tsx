...
export function SelectExportTypeModal({ visible }: { visible: boolean }) {
  ...
  const dropdown_options = [
    ...
    {
      key: ExportTypes.DOCLATTICE,
      text: "DocLattice",
      value: ExportTypes.DOCLATTICE,
      image: { avatar: true, src: doclattice_icon },
    },
  ];
            ...
            <Message>
              ...
              <Message.List
                items={[
                  ...
                  "DocLattice - Get a zip archive containing not only annotated pdfs but also the annotation data. This can be used to roundtrip corpuses - export and re-import from one instance to another",
                ]}
              />
            </Message>
            <div
