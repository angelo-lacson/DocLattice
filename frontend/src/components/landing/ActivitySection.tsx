 ...
 * Uses the ActivityFeed component from @doclattice/ui to show user activity.
 *
 * Features:
...
import { ActivityFeed } from "@doclattice/ui/src";
import type { ActivityItemData } from "@doclattice/ui/src";
