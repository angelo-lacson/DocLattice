 ...
 * such tool — the web search tool (`doclatticeserver.llms.tools.web_search_tools.WebSearchTool`,
  ...
  return (
    <Section data-testid="tool-secrets-panel">
      ...
      <FormField>
        ...
        {/* Hardcoded to the two providers DocLattice currently supports
            server-side — there is no generic tool-settings-schema query
            today to derive this dynamically. Mirrors
            doclatticeserver.constants.web_search.SUPPORTED_PROVIDERS;
