...
test.describe("PipelineIcons — getComponentIcon dispatcher", () => {
  ...
  const dispatcherCases: { className: string; expected: string }[] = [
    ...
    {
      className:
        "doclatticeserver.pipeline.thumbnailers.text_thumb.TextThumbnailer",
      expected: "TextThumbnailIcon",
    },
    {
      className:
        "doclatticeserver.pipeline.embedders.modernbert.ModernBertEmbedder",
      expected: "ModernBertIcon",
    },
    {
      className:
        "doclatticeserver.pipeline.embedders.modern_bert.ModernBertEmbedder",
      expected: "ModernBertIcon",
    },
    ...
    {
      className:
        "doclatticeserver.pipeline.embedders.multimodal.MultimodalEmbedder",
    ...
    {
      className: "doclatticeserver.pipeline.parsers.oc_text.OcTextParser",
      expected: "TextParserIcon",
    },
    // Fallback
    {
      className: "doclatticeserver.some.made.up.UnknownThing",
...
test.describe("PipelineIcons — getComponentDisplayName", () => {
  test("derives a friendly name from a class path and applies acronyms", async ({
    ...
    const samples = [
      ...
      {
        className: "doclatticeserver.something.Generic",
      },
    ];
    const component = await mount(
