        ...
        postProcessors: [
          {
            ...
            moduleName:
              "doclatticeserver.pipeline.postprocessors.SummaryPostProcessor",
          ...
          },
          {
            ...
            moduleName:
              "doclatticeserver.pipeline.postprocessors.FormatConverter",
...
test.describe("SelectExportTypeModal - Default State", () => {
  ...
  test("should have DocLattice format selected by default", async ({
    mount,
    page,
  }) => {
    const component = await mount(
    ...
    // DocLattice format option should be selected
    const ocOption = page.locator('[data-testid="format-doclattice"]');
