...
This directory contains comprehensive tests for the DocLattice metadata functionality. The tests follow established patterns in the codebase and ensure full coverage of the metadata feature set.
