        ...
        embedders: [
          {
            ...
            moduleName: "doclatticeserver.pipeline.embedders.DefaultEmbedder",
          ...
          {
            name: "large_embedder",
            moduleName: "doclatticeserver.pipeline.embedders.LargeEmbedder",
            ...
            embedders: [
              {
                name: "default_embedder",
                moduleName:
                  "doclatticeserver.pipeline.embedders.DefaultEmbedder",
                title: "Default Embedder",
                description: "Standard text embedding model",
                author: "DocLattice",
                componentType: "embedder",
              ...
              },
              {
                ...
                moduleName:
                  "doclatticeserver.pipeline.embedders.DisabledEmbedder",
