 ...
 * `doclatticeserver/users/migrations/0003_create_initial_superuser.py`.
...
export function triggerBadgeNotificationViaDocker(username: string): void {
  ...
  runDjangoShell(`
    ...
    from doclatticeserver.badges.models import Badge, UserBadge, BadgeTypeChoices
    User = get_user_model()
 ...
 * handshake — the production hooks always include the `doclattice.jwt.v1`
