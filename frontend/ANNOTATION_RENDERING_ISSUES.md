...
This document catalogs all identified rendering issues in the DocLattice annotation system. Each issue includes detailed analysis, code references, reproduction steps, and fix guidelines suitable for junior developers.
