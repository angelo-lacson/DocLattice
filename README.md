...
| |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| --- |--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| CI/CD | [![codecov](https://codecov.io/gh/angelo-lacson/DocLattice/branch/main/graph/badge.svg?token=RdVsiuaTVz)](https://codecov.io/gh/angelo-lacson/DocLattice)                                                                                                                                                                                                                                                                                                                  |
...
NLmatics was also the inspiration for our data extract grid and parsing pipeline. The company was ahead of its time, and, while the product is no longer available, DocLattice aims to take some of its best and most innovative features and make them open source!
