...
| |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| --- |--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| CI/CD | [![Codecov (Backend)](https://codecov.io/gh/angelo-lacson/DocLattice/branch/main/graph/badge.svg?token=73BJLAO4WY)](https://codecov.io/gh/angelo-lacson/DocLattice)                                                                                                                                                                                                                                                                                                                  |
...
DocLattice is an **Apache-2 Licensed** software application to label, share and search annotate documents.
...
DocLattice not only lets humans collaborate on and share document annotations, it also can analyze and export data
from contracts using state-of-the-art NLP technology.

## Documentation

We use MkDocs for our documentation. Please visit [https://JSv4.github.io/DocLattice/](https://JSv4.github.io/DocLattice/)
for our detailed documentation - including a quick start guide, a walk through, architectural overview and more.

## Why Does it Exist?

The DocLattice stack is designed to provide a cutting edge frontend experience while providing access to the
