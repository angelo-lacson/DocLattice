...
"""Utility to concatenate all files under doclatticeserver/llms into one text file.
...
Each file is wrapped in an XML-like block of the form::
    ...
    <FILE path="doclatticeserver/llms/example.py">
    ... file content ...
    </FILE>
...
def main() -> None:
    """Walk ``doclatticeserver/llms`` and write consolidated file contents."""

    repo_root = Path(__file__).resolve().parent.parent  # project root
    base_dir = repo_root / "doclatticeserver" / "llms"
