    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('icon', models.FileField(blank=True, null=True, upload_to=doclatticeserver.corpuses.models.calculate_icon_filepath)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('file', models.FileField(blank=True, null=True, upload_to=doclatticeserver.corpuses.models.calculate_temporary_filepath)),
            ],
        ),
        migrations.CreateModel(
