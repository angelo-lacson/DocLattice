...
:class:`doclatticeserver.documents.document_service.DocumentService` instead.
    ...
    def permanently_delete_document(
        ...
        *,
        ...
        Permissions:
            Requires corpus DELETE permission
        """
        from doclatticeserver.documents.versioning import permanently_delete_document
