...
from doclatticeserver.constants.artifacts import ARTIFACT_SLUG_RETRY_ATTEMPTS
...
from doclatticeserver.constants.licenses import (
    CUSTOM,
    LICENSE_CHOICES,
    LICENSE_LINK_MAX_LENGTH,
    LICENSE_SPDX_MAX_LENGTH,
)
from doclatticeserver.constants.notifications import (
...
from doclatticeserver.shared.user_can_mixin import InstanceUserCanMixin
from doclatticeserver.shared.utils import (
    calc_oc_file_path,
...
class Corpus(InstanceUserCanMixin, TreeNode):
    ...
    # handlers in ``doclatticeserver/corpuses/signals.py`` whenever a
    ...
    def save(self, *args: Any, **kwargs: Any) -> None:
        ...
        if not self.pk:
            ...
            from doclatticeserver.pipeline.utils import get_default_llm_spec
    ...
    def user_can_moderate(self, user: UserModel | AnonymousUser | None) -> bool:
        ...
        Returns ``True`` iff:
            ...
            * ``user`` is a designated moderator (any row in
              :class:`~doclatticeserver.conversations.models.CorpusModerator`,
        ...
        **doc_kwargs: Any,
        ...
        with transaction.atomic():
            ...
            if corpus_copy.structural_annotation_set:
                from doclatticeserver.tasks.corpus_tasks import (
...
class CorpusVoteType(django.db.models.TextChoices):
    ...
    to import from ``doclatticeserver.conversations`` (which would form
