...
:meth:`doclatticeserver.enrichment.services.customs_ruling_citation_service.CustomsRulingCitationService.enrich_corpus`
— see that module's docstring for scope (purpose-built for CBP CROSS-style
ruling corpora, not a general DocLattice feature).
...
from doclatticeserver.enrichment.services.customs_ruling_citation_service import (
