...
from doclatticeserver.pipeline.base.base_authority_discovery_provider import (
...
from doclatticeserver.pipeline.base.enricher import BaseEnricher
from doclatticeserver.pipeline.base.file_converter import BaseFileConverter
...
from doclatticeserver.pipeline.base.llm_provider import BaseLLMProvider
...
class PipelineComponentRegistry:
    ...
    def _discover_all_components(self) -> None:
        ...
        parser_classes = self._discover_subclasses(
            "doclatticeserver.pipeline.parsers", BaseParser
        )
        parsers = []
        ...
        enricher_classes = self._discover_subclasses(
            "doclatticeserver.pipeline.enrichers", BaseEnricher
        )
        enrichers = []
        ...
        reranker_classes = self._discover_subclasses(
            "doclatticeserver.pipeline.rerankers", BaseReranker
        )
        rerankers = []
        ...
        llm_provider_classes = self._discover_subclasses(
            "doclatticeserver.pipeline.llm_providers", BaseLLMProvider
        )
        llm_providers = []
        ...
        file_converter_classes = self._discover_subclasses(
            "doclatticeserver.pipeline.file_converters", BaseFileConverter
        )
        file_converters = []
        ...
        authority_source_provider_classes = self._discover_subclasses(
            "doclatticeserver.pipeline.authority_source_providers",
            BaseAuthoritySourceProvider,
        )
        ...
        authority_discovery_provider_classes = self._discover_subclasses(
            "doclatticeserver.pipeline.authority_discovery_providers",
            BaseAuthorityDiscoveryProvider,
        )
    ...
    def get_by_class_name(
        ...
        E.g., 'doclatticeserver.pipeline.parsers.docling_parser_rest.DoclingParser'
        """
...
def reset_registry() -> None:
    ...
    from doclatticeserver.enrichment.services.authority_source_hosts import (
