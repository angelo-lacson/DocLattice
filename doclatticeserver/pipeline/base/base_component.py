...
from doclatticeserver.types.protocols import PipelineComponentProtocol  # noqa: F401
...
class PipelineComponentBase(ABC):
    ...
    def validate_settings(self) -> tuple[bool, list[str]]:
        ...
        from doclatticeserver.pipeline.base.settings_schema import validate_settings
