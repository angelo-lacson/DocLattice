...
from doclatticeserver.pipeline.base.chunk_reassembler import ChunkReassembler
    ...
    **Subclass note:** ``chunk_overlap`` defaults to ``DEFAULT_CHUNK_OVERLAP``
    ...
    def parse_pdf_bytes(
        ...
        **all_kwargs,
        ...
        """
        Parse raw PDF bytes into an ``DocLatticeDocExport`` **without any
        database access**.
        ...
        Returns:
            ``DocLatticeDocExport`` with globally-indexed pages, or ``None``
