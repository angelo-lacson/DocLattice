"""Incremental reassembly of per-chunk DocLatticeDocExport results.
...
def _annotation_signature(annotation: DocLatticeAnnotationPythonType) -> tuple:
...
class ChunkReassembler:
    ...
    def __init__(self) -> None:
        self._first: Optional[DocLatticeDocExport] = None
        self._pawls: list[PawlsPagePythonType] = []
        self._annotations: list[DocLatticeAnnotationPythonType] = []
        self._relationships: list[DocLatticeRelationshipPythonType] = []
    ...
    def finalize(self) -> DocLatticeDocExport:
        if self._first is None:
    ...
    def _dedupe_annotations(
        self,
    ) -> tuple[list[DocLatticeAnnotationPythonType], dict[Any, Any]]:
        ...
        deduped: list[DocLatticeAnnotationPythonType] = []
    ...
    def _relink_and_dedupe_relationships(
    ...
    ) -> list[DocLatticeRelationshipPythonType]:
        ...
        """
        seen: set[tuple] = set()
        deduped: list[DocLatticeRelationshipPythonType] = []
    ...
    def _report_residual_orphans(
        ...
        relationships: list[DocLatticeRelationshipPythonType],
    ) -> None:
