...
from doclatticeserver.enrichment.constants import _USC_PREFIX_RE
from doclatticeserver.pipeline.base.base_authority_source_provider import (
    AuthorityRequest,
    BaseAuthoritySourceProvider,
)
from doclatticeserver.utils.safe_http import safe_fetch_bytes
...
class USCodeAuthoritySourceProvider(BaseAuthoritySourceProvider):
    ...
    def _fetch_impl(
        ...
        Returns:
            ...
            :class:`~doclatticeserver.enrichment.authorities.AuthoritySection`,
    ...
    def _load_title_xml(self, request: AuthorityRequest) -> bytes:
        ...
        # Identify as the authority-provider crawler (same UA as the FR/CFR
        # providers) rather than the generic default, so all three deterministic
        # authority fetchers present consistently to .gov hosts.
        zip_bytes, _ = safe_fetch_bytes(
            request.url,
            max_bytes=OLRC_TITLE_ZIP_MAX_BYTES,
    ...
    def _harvest_sourcecredit_equivalences(
        ...
        """
        from doclatticeserver.enrichment.services.authority_equivalence_ingest import (  # noqa: E501
            CREATED,
            SKIPPED_OWNED,
            UPDATED,
            upsert_equivalence,
