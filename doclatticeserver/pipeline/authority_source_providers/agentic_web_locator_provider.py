...
from doclatticeserver.constants.safe_http import UTF8_MAX_BYTES_PER_CHAR
from doclatticeserver.constants.web_search import WEB_SEARCH_DEFAULT_NUM_RESULTS
...
from doclatticeserver.utils.prompt_sanitization import sanitize_for_prompt_strict
...
class AgenticWebLocatorProvider(BaseAuthoritySourceProvider):
    ...
    async def _run_agent(self, *, citation: str, jurisdiction: str) -> _LocatorOutput:
        ...
        from doclatticeserver.llms.agents.pydantic_ai_factory import (
    ...
    async def _tool_web_search(self, query: str) -> str:
        ...
        """
        from doclatticeserver.llms.tools.web_search_tools import aweb_search
