...
from doclatticeserver.utils.files import create_text_thumbnail
import logging
...
class TextThumbnailGenerator(BaseThumbnailGenerator):
    ...
    def _generate_thumbnail_impl(
        ...
        **all_kwargs
        ...
        logger.debug(f"TextThumbnailGenerator generating with height={height}, width={width}. All kwargs: {all_kwargs}")
