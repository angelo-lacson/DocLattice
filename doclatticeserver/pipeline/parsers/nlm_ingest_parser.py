...
class NLMIngestParser(BaseParser):
    ...
    def _parse_document_impl(
        ...
        Returns:
            Optional[DocLatticeDocExport]: The parsed document data,
        ...
        if "labelled_text" in doclattice_data:
            pawls_data = doclattice_data.get("pawls_file_content", [])
        ...
        logger.info(
            f"DocLattice data labelled text: {doclattice_data.get('labelled_text', [])}"
        )
