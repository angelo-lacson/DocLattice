"""
LlamaParse Parser for DocLattice.
...
class LlamaParseParser(BaseParser):
    ...
    def _parse_document_impl(
        ...
        Returns:
            DocLatticeDocExport with the parsed document data, or None if parsing failed.
        """
        ...
        try:
            ...
            try:
                ...
                if result_type == "json" and extract_layout:
                    ...
                    return self._convert_text_to_doclattice(document, documents)
    ...
    def _convert_json_to_doclattice(
        self,
        document: Document,
        ...
        """
        Convert LlamaParse JSON results to DocLattice format.
        ...
        Returns:
            DocLatticeDocExport with parsed data.
        """
    ...
    def _convert_text_to_doclattice(
        self,
        document: Document,
        llama_documents: list[Any],
    ) -> DocLatticeDocExport:
        """
        Convert simple text/markdown LlamaParse output to DocLattice format.
    ...
    def _create_annotation(
        ...
        """
        Create an DocLattice annotation.
        ...
        Returns:
            DocLatticeAnnotationPythonType annotation.
        """
        ...
        page_annotation: DocLatticeSinglePageAnnotationType = {
            "bounds": bounds,
