...
class DoclingParser(BaseParser):
    ...
    def parse_document(
        ...
        try:
            ...
            # # Log the final DocLattice data structure
            # logger.info(f"DocLattice data: {doclattice_data}")
    ...
    def convert_chunks_to_annotations(
        ...
        Returns:
            List[DocLatticeAnnotationPythonType]: The list of annotations extracted from chunks.
        """
        logger.info("Converting chunks to DocLattice annotations")
