...
from doclatticeserver.types.dicts import DocLatticeDocExport, DocLatticeAnnotationPythonType
...
class DoclingParser(BaseParser):
    ...
    def convert_chunks_to_annotations(
        ...
        """
        Converts a DoclingDocument into DocLatticeDocExport format.
        ...
        Returns:
            DocLatticeDocExport: The converted document data.
        """
        ...
        for chunk in chunks:
            ...
            doclattice_data["labelled_text"].append(annotation)

        # Join collected content
        doclattice_data["content"] = "\n".join(content_parts)
