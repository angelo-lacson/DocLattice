...
from doclatticeserver.annotations.models import LABEL_TYPES
...
class DocxodusServiceParser(BaseParser):
    ...
    The microservice wraps Docxodus's DocLatticeExporter.Export(), which produces
    DocLatticeDocExport-compatible JSON with structural annotations and character
    ...
    def _parse_document_impl(
        ...
        Returns:
            DocLatticeDocExport with structural annotations and character offsets.
        """
        ...
        return cast(DocLatticeDocExport, normalized)
    ...
    def _normalize_response(response_data: dict[str, Any]) -> dict[str, Any]:
        ...
        Returns:
            Normalized response compatible with DocLatticeDocExport.
        """
        field_mappings = {
    ...
    def _normalize_annotation(ann: dict[str, Any]) -> dict[str, Any]:
        """Normalize annotation fields to match the DocLatticeDocExport format.
