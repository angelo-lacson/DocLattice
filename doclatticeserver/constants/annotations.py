...
# ``doclatticeserver/utils/span_projection.py::span_annotation_payload`` and
# ``doclatticeserver/utils/annotation_anchoring.py::_anchor_text``.
SPAN_NO_PAGE = 0
...
# Spans that have been geocoded by ``doclatticeserver/utils/geocoding`` carry
