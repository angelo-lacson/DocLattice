...
``doclatticeserver/tasks/import_tasks.py``) — hence the "import"
...
from doclatticeserver.document_imports.models import (
    ChunkedUploadKind,
    ChunkedUploadPart,
...
class CorpusImportResult:
    """Result of an DocLattice corpus-export zip import.
...
def import_corpus_export_for_user(
    *,
    ...
    """
    Resolve or create a destination :class:`Corpus`, stage the DocLattice
