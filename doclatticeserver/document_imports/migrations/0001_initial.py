...
import doclatticeserver.document_imports.models
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ...
                            ("corpus_export", "DocLattice corpus export"),
                        ],
                        max_length=32,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "file",
                    models.FileField(
                        upload_to=doclatticeserver.document_imports.models._chunk_part_path
                    ),
                ),
                (
                    "size",
