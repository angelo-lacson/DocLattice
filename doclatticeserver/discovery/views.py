...
from doclatticeserver.constants.discovery import (
...
try:
    from doclatticeserver.mcp.config import RATE_LIMIT_REQUESTS
except ImportError:
...
def llms_txt(request: HttpRequest) -> HttpResponse:
    ...
    lines = [
        ...
        "",
        (
            "> DocLattice is an open-source document analytics platform for "
    ...
    lines.extend(
        [
            ...
            "- [Source code](https://github.com/angelo-lacson/DocLattice)",
            "- [Project documentation](https://doclattice.opensource.legal)",
            "",
        ]
    )
    return HttpResponse("\n".join(lines), content_type="text/plain; charset=utf-8")
...
def llms_full_txt(request: HttpRequest) -> HttpResponse:
    ...
    lines = [
        "# DocLattice - Full MCP Documentation",
        "",
        (
            "> DocLattice is an open-source document analytics platform for "
            "analyzing, annotating, and querying complex documents. It provides a "
        ...
        "",
        (
            "DocLattice exposes a read-only MCP server so that AI assistants can "
    ...
    lines.extend(
        [
            ...
            "",
            "- [Source code](https://github.com/angelo-lacson/DocLattice)",
            "- [Project site](https://doclattice.opensource.legal)",
