...
def llms_txt(request: HttpRequest) -> HttpResponse:
    ...
    lines = [
        ...
        (
            ...
            "and cite the spans they pulled from. Released as DocLattice since "
...
def llms_full_txt(request: HttpRequest) -> HttpResponse:
    ...
    lines = [
        ...
        (
            ...
            "as DocLattice since 2019; rebranded as cite for the v3 release line."
        ),
        "",
        "## MCP Server Overview",
        "",
...
# mirrors ``doclatticeserver.mcp.server.MCP_AUTHED_PATH`` (kept as a literal
