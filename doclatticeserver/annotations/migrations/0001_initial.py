...
import doclatticeserver.annotations.models
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tokens_jsons', doclatticeserver.shared.fields.NullableJSONField(default=doclatticeserver.shared.defaults.jsonfield_empty_array)),
                ('bounding_box', doclatticeserver.shared.fields.NullableJSONField(default=doclatticeserver.shared.defaults.empty_bounding_box)),
                ('json', doclatticeserver.shared.fields.NullableJSONField(default=doclatticeserver.shared.defaults.jsonfield_default_value)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(default='')),
                ('icon', models.FileField(blank=True, upload_to=doclatticeserver.annotations.models.calculate_labelset_icon_path)),
            ],
            options={
