"""
Simplified Query Optimizers for DocLattice
...
class AnnotationQueryOptimizer:
    ...
    def get_document_annotations(
        ...
        if not user.is_superuser:
            ...
            from doclatticeserver.analyzer.models import AnalysisUserObjectPermission
            ...
            from doclatticeserver.extracts.models import ExtractUserObjectPermission
...
class AnalysisQueryOptimizer:
    ...
    def get_visible_analyses(
        ...
        """
        from doclatticeserver.analyzer.models import Analysis
        from doclatticeserver.corpuses.models import Corpus, CorpusUserObjectPermission
        from doclatticeserver.utils.permissioning import user_has_permission_for_obj
        from doclatticeserver.types.enums import PermissionTypes
