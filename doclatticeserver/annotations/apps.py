...
class AnnotationsConfig(AppConfig):
    ...
    name = "doclatticeserver.annotations"
    verbose_name = _("Annotations")

    def ready(self):
        try:
            import doclatticeserver.annotations.signals  # noqa F401
            from doclatticeserver.annotations.models import (
                Annotation,
                Note,
                Relationship,
            )
            from doclatticeserver.annotations.signals import (  # Relationship signals
                ANNOT_CREATE_UID,
                NOTE_CREATE_UID,
            ...
            from doclatticeserver.enrichment._namespace_seed import (
                ensure_seeded,
            )
