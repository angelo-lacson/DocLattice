...
committing. Every fetch is SSRF-gated (``doclatticeserver/utils/safe_http.py``)
...
from doclatticeserver.enrichment.constants import DISCOVERY_DEFAULT_MAX_CANDIDATES
