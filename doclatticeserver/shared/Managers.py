...
from doclatticeserver.shared.prefetch_attrs import (
    user_group_perm_attr,
    user_perm_attr,
)
from doclatticeserver.shared.QuerySets import (
    AnnotationQuerySet,
    DocumentQuerySet,
    NoteQuerySet,
    PermissionQuerySet,
...
from doclatticeserver.shared.user_can_mixin import UserCanMixin
from doclatticeserver.types.enums import PermissionTypes as _PermissionTypes
...
from doclatticeserver.types.protocols import (  # noqa: F401
...
def _apply_document_prefetches(
    ...
    if not lightweight:
        ...
        from doclatticeserver.annotations.models import DOC_TYPE_LABEL, Annotation
...
class AnnotationManager(PermissionManager.from_queryset(AnnotationQuerySet)):  # type: ignore[misc]
    ...
    def user_can(
        ...
        *,
        ...
        from doclatticeserver.shared.user_can_mixin import resolve_user_for_user_can
        from doclatticeserver.types.enums import PermissionTypes
