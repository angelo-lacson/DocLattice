    ...
    def decorator(func):
        ...
        def wrapper(self, *args, **kwargs):
            ...
            try:
                ...
                # TODO - use PlasmaPDF to accept raw spans and convert them to proper DocLatticeAnnotationPythonType
                ...
                if task_pass and analysis:
                    ...
                    for annotation_data in text_annotations:
                        ...
                        if not is_dict_instance_of_typed_dict(
                            ...
                            raise ValueError(
                                "Each annotation must be of type DocLatticeAnnotationPythonType"
                            )
