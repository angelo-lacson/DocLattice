...
class LlamaIndexDocumentAgent(CoreAgentBase):
    ...
    async def create(
        ...
        embed_model = DocLatticePipelineEmbedding(embedder_path=config.embedder_path)
...
# Backward compatibility - maintain the original DocLatticeDbAgent interface
class DocLatticeDbAgent:
    """Backward compatibility wrapper for the original DocLatticeDbAgent interface."""
