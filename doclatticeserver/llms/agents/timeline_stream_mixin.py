...
2. Collects these events via :class:`~doclatticeserver.llms.agents.timeline_utils.TimelineBuilder`.
3. Injects the finished timeline into the *last* :class:`~doclatticeserver.llms.agents.core_agents.FinalEvent`.
