...
```python
# from doclatticeserver.documents.models import Document # For Document.DoesNotExist
# from doclatticeserver.llms.agents.core_agents import UnifiedStreamResponse # For streaming error
...
2. **Implement Agent Adapters**:
   ...
   - Inside this file, define classes for your document and/or corpus agents. These classes **must** inherit from `CoreAgent` (from `doclatticeserver.llms.agents.core_agents.py`).
   ...
   from doclatticeserver.llms.agents.core_agents import CoreAgent, AgentContext, AgentConfig, UnifiedChatResponse, UnifiedStreamResponse
   from doclatticeserver.llms.conversations.core_conversations import CoreConversationManager
   # from doclatticeserver.documents.models import Document
   # from doclatticeserver.corpuses.models import Corpus
