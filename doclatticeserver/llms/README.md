...
```python
from doclatticeserver.llms.agents.core_agents import ApprovalNeededEvent
...
The framework provides both sync and async embeddings APIs via `doclatticeserver.llms.embeddings`:
...
# - Custom embedding models via DocLatticePipelineEmbedding (from doclatticeserver.llms.embedders.custom_pipeline_embedding)
# - Traditional 3-phase streaming (START, CONTENT chunks, FINISH)

from doclatticeserver.llms.agents.llama_index_agents import LlamaIndexDocumentAgent
from doclatticeserver.llms.vector_stores.llama_index_vector_stores import LlamaIndexAnnotationVectorStore
...
# The DocLatticePipelineEmbedding can be configured in AgentConfig or used directly with LlamaIndex components.
