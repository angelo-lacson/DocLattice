...
```python
from doclatticeserver.llms.tools import create_document_tools
...
2. **Implement Agent Adapters**:
   ...
   from doclatticeserver.llms.agents.core_agents import CoreAgent, UnifiedChatResponse, UnifiedStreamResponse
...
3. **Integrate into `UnifiedAgentFactory`**:
   ...
   # In agents/agent_factory.py
       ...
       from doclatticeserver.llms.agents.langchain_agents import LangChainDocumentAgent
