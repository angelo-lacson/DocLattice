...
from doclatticeserver.llms.vector_stores import DjangoAnnotationVectorStore
...
"""Factory function to construct an DocLatticeDbAgent for a given Document."""
...
async def create_document_agent(
    ...
    """
    Factory function to create an DocLatticeDbAgent for a given Document.
    ...
    This function encapsulates:
      ...
      - Returning an DocLatticeDbAgent instance tied to the Conversation
    ...
    Returns:
        DocLatticeDbAgent: An instance of DocLatticeDbAgent configured to query the given Document.
    """
    ...
    logger.debug("Wrapping with DocLatticeDbAgent...")
    agent = DocLatticeDbAgent(
        conversation=conversation,
        user_id=user_id,
        agent=underlying_llama_agent,
    )

    logger.debug("Returning configured DocLatticeDbAgent.")
    return agent
...
async def create_corpus_agent(
    ...
    """
    Factory function to create an DocLatticeDbAgent for a given Corpus.
    ...
    Returns:
        DocLatticeDbAgent:
            An instance of DocLatticeDbAgent configured to query the entire Corpus.
    """
