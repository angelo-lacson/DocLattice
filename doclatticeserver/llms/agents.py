...
class DocLatticeDbAgent:
    ...
    async def astream_chat(
        ...
        """
        if user_query in DocLatticeDbAgent._processing_queries:
            return await self._agent.astream_chat(user_query)

        DocLatticeDbAgent._processing_queries.add(user_query)
        ...
        try:
            ...
            DocLatticeDbAgent._processing_queries.remove(user_query)
...
async def create_openai_document_agent(
    ...
    # )
    embed_model = DocLatticePipelineEmbedding(
...
async def create_document_agent(
    ...
    Returns:
        DocLatticeDbAgent: Configured agent ready for document interaction.
    """
...
async def create_corpus_agent(
    ...
    Returns:
        DocLatticeDbAgent: Agent configured to handle queries across all corpus documents.
    """
