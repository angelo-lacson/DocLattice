...
:mod:`doclatticeserver.constants.context_guardrails` so operators can
...
def context_window_and_threshold(
    ...
    (``doclatticeserver.llms.history_processors.shrink_old_artifacts_processor``)
...
def messages_to_proxies(
    ...
    Handles the ``msg_type`` field conventions used by DocLattice:
...
class CompactionConfig:
    ...
    :mod:`doclatticeserver.constants.context_guardrails` on a
