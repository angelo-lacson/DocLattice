...
class DocLatticePipelineEmbedding(BaseEmbedding):
    """
    A llama_index-compatible embedding class that wraps the DocLattice pipeline function
    ...
    custom_embedder = DocLatticePipelineEmbedding(
        corpus_id=123, 
    ...
    def __init__(
        ...
        to the underlying DocLattice pipeline function that generates embeddings.
        ...
        """
        super().__init__(
            model_name="doclattice-pipeline-model",
    ...
    def _get_query_embedding(self, query: str) -> Embedding:
        """
        Embed the input query text synchronously, by calling DocLattice' 
    ...
    async def _aget_query_embedding(self, query: str) -> Embedding:
        """
        Asynchronously embed the input query text, by calling DocLattice' 
    ...
    def _get_text_embedding(self, text: str) -> Embedding:
        """
        Embed the input text synchronously, by calling DocLattice' 
        ``generate_embeddings_from_text`` function.
    ...
    async def _aget_text_embedding(self, text: str) -> Embedding:
        """
        Asynchronously embed the input text, by calling DocLattice' 
        ``generate_embeddings_from_text`` function in a background thread.
