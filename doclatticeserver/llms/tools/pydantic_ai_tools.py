...
from doclatticeserver.llms.history_processors import InRunShrinkEvent
...
class PydanticAIDependencies(BaseModel):
    ...
    # import between ``doclatticeserver.llms.tools.pydantic_ai_tools`` and
    # ``doclatticeserver.llms.vector_stores.pydantic_ai_vector_stores``.
    ...
    # ``doclatticeserver.llms.history_processors`` calls this synchronously
    ...
    # ``doclatticeserver.llms.history_processors`` reads its in-run
