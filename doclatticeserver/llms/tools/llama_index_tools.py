...
class LlamaIndexToolFactory:
    ...
    def create_tool_registry(core_tools: List[CoreTool]) -> Dict[str, FunctionTool]:
        ...
        """
        return {tool.name: LlamaIndexToolFactory.create_tool(tool) for tool in core_tools}
...
def get_llama_index_document_tools() -> List[FunctionTool]:
    ...
    from doclatticeserver.llms.tools.tool_factory import create_document_tools
...
get_notes_for_document_corpus_tool = _individual_tools['get_notes_for_document_corpus_tool']
get_note_content_token_length_tool = _individual_tools['get_note_content_token_length_tool']
