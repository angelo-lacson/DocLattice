...
(:func:`doclatticeserver.llms.model_factory.abuild_agent_model`) and the single
sanctioned ``pydantic_ai.Agent`` construction chokepoint
(:func:`doclatticeserver.llms.agents.pydantic_ai_factory.make_pydantic_ai_agent`).
"""
...
from doclatticeserver.constants.llm import DEFAULT_COMPLETION_TEMPERATURE
...
async def agenerate_text(
    ...
    *,
    ...
    # ``doclatticeserver.llms.completions.<name>`` (the test documents this).
