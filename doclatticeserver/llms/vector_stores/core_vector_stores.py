...
from doclatticeserver.constants.search import (
    FTS_CONFIG,
...
from doclatticeserver.llms.vector_stores.base_vector_store import BaseVectorStore
from doclatticeserver.pipeline.base.reranker import (
    BaseReranker,
    safe_arerank,
    safe_rerank,
)
from doclatticeserver.shared.QuerySets import AnnotationQuerySet
from doclatticeserver.types.protocols import VectorStoreProtocol
from doclatticeserver.utils.embeddings import join_block_text_parts
from doclatticeserver.utils.search import reciprocal_rank_fusion
...
class CoreAnnotationVectorStore(BaseVectorStore):
    ...
    def _get_reranker(self) -> Optional[BaseReranker]:
        ...
        from doclatticeserver.pipeline.utils import get_default_reranker_instance
