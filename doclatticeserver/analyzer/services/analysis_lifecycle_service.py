...
The Phase-3 :class:`doclatticeserver.analyzer.services.analysis_service.AnalysisService`
...
class AnalysisLifecycleService(BaseService):
    ...
    def make_public(
        ...
        *,
        ...
        return ServiceResult.success(
            "Starting an DocLattice worker to make your analysis public! "
    ...
    def delete_analysis(
        ...
        *,
        ...
        """
        from doclatticeserver.analyzer.models import Analysis
        from doclatticeserver.tasks import delete_analysis_and_annotations_task
