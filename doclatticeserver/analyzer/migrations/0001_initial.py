...
import functools
import doclatticeserver.analyzer.models
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('received_callback_file', models.FileField(blank=True, max_length=1024, null=True, upload_to=functools.partial(doclatticeserver.shared.utils.calc_oc_file_path, *(), **{'sub_folder': 'pdf_files'}))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('manifest', doclatticeserver.shared.fields.NullableJSONField(blank=True, default=doclatticeserver.shared.defaults.jsonfield_default_value, null=True)),
                ('description', models.TextField(blank=True, default='')),
                ('disabled', models.BooleanField(default=False)),
                ('is_public', models.BooleanField(default=True)),
                ('icon', models.FileField(blank=True, upload_to=doclatticeserver.analyzer.models.calculate_analyzer_icon_path)),
            ],
            options={
