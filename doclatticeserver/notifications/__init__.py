"""
Notifications app for DocLattice.

This app uses a deliberately simpler ownership model than other domain
apps: a :class:`~doclatticeserver.notifications.models.Notification`
...
default_app_config = "doclatticeserver.notifications.apps.NotificationsConfig"
