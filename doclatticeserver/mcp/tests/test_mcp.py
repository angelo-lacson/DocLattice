...
class URIParserTest(TestCase):
    ...
    def test_parse_corpus_uri(self):
        ...
        from doclatticeserver.mcp.server import URIParser
...
class MCPPermissionsTest(TestCase):
    ...
    def test_validate_slug(self):
        ...
        from doclatticeserver.mcp.permissions import validate_slug
    ...
    def test_sanitize_and_validate_slugs(self):
        ...
        from doclatticeserver.mcp.permissions import sanitize_and_validate_slugs
    ...
    def test_get_anonymous_user(self):
        ...
        from doclatticeserver.mcp.permissions import get_anonymous_user
...
class MCPResourcesTest(TestCase):
    ...
    def test_get_public_corpus_resource(self):
        ...
        from doclatticeserver.mcp.resources import get_corpus_resource
...
class MCPToolsTest(TestCase):
    ...
    def test_list_public_corpuses(self):
        ...
        from doclatticeserver.mcp.tools import list_public_corpuses
...
class MCPFormattersTest(TestCase):
    ...
    def test_format_corpus_summary(self):
        ...
        from doclatticeserver.mcp.formatters import format_corpus_summary
...
class MCPConfigTest(TestCase):
    ...
    def test_get_mcp_setting_with_default(self):
        ...
        from doclatticeserver.mcp.config import get_mcp_setting
    ...
    def test_validate_slug(self):
        ...
        from doclatticeserver.mcp.config import validate_slug
...
class MCPToolsDocumentsTest(TestCase):
    ...
    def setUpTestData(cls):
        ...
        from doclatticeserver.annotations.models import AnnotationLabel
    ...
    def test_list_documents(self):
        ...
        from doclatticeserver.mcp.tools import list_documents
    ...
    def test_get_document_text(self):
        ...
        from doclatticeserver.mcp.tools import get_document_text
    ...
    def test_get_document_text_max_chars_clamped_to_hard_cap(self):
        ...
        from doclatticeserver.constants.mcp import MCP_DOCUMENT_TEXT_MAX_CHARS
        from doclatticeserver.mcp.tools import get_document_text
    ...
    def test_get_document_resource_handles_bytes_from_cloud_storage(self):
        ...
        """
        from doclatticeserver.mcp.resources import get_document_resource
...
class MCPToolsAnnotationsTest(TestCase):
    ...
    def test_list_annotations(self):
        ...
        from doclatticeserver.mcp.tools import list_annotations
...
class MCPToolsSearchTest(TestCase):
    ...
    def test_search_corpus_text_fallback_returns_passages(self):
        ...
        from doclatticeserver.mcp.tools import search_corpus
    ...
    def test_format_search_block_shape(self):
        ...
        from doclatticeserver.llms.vector_stores.core_relationship_vector_store import (  # noqa: E501
            RelationshipVectorSearchResult,
        )
        from doclatticeserver.mcp.formatters import format_search_block
    ...
    def test_dedupe_search_hits_collapses_passages_keeps_blocks(self):
        ...
        from doclatticeserver.mcp.tools import _dedupe_search_hits
    ...
    def test_search_corpus_dedupes_repeated_annotation(self):
        ...
        with patch.object(self.corpus.__class__, "embed_text", side_effect=fake_embed):
            with patch(
                "doclatticeserver.shared.QuerySets."
...
class MCPToolsThreadsTest(TestCase):
    ...
    def test_list_threads(self):
        ...
        from doclatticeserver.mcp.tools import list_threads
    ...
    def test_get_thread_messages_hierarchical(self):
        ...
        from doclatticeserver.mcp.tools import get_thread_messages
...
class MCPResourcesAnnotationTest(TestCase):
    ...
    def test_get_annotation_resource(self):
        ...
        from doclatticeserver.mcp.resources import get_annotation_resource
...
class MCPResourcesThreadTest(TestCase):
    ...
    def test_get_thread_resource(self):
        ...
        from doclatticeserver.mcp.resources import get_thread_resource
...
class MCPFormattersExtendedTest(TestCase):
    ...
    def test_format_document_summary(self):
        ...
        from doclatticeserver.mcp.formatters import format_document_summary
    ...
    def test_format_annotation(self):
        ...
        from doclatticeserver.mcp.formatters import format_annotation
    ...
    def test_format_thread_summary(self):
        ...
        from doclatticeserver.mcp.formatters import format_thread_summary
    ...
    def test_format_message(self):
        ...
        from doclatticeserver.mcp.formatters import format_message
    ...
    def test_format_message_with_replies(self):
        ...
        from doclatticeserver.mcp.formatters import format_message_with_replies
...
class MCPServerAsyncTest(TestCase):
    ...
    def test_create_mcp_server(self):
        ...
        self.assertEqual(server.name, "doclattice")

    def test_get_session_manager(self):
        """Test session manager creation."""
        from doclatticeserver.mcp.server import get_session_manager
...
class MCPServerComponentsTest(TestCase):
    ...
    def test_mcp_lifespan_manager(self):
        ...
        from doclatticeserver.mcp.server import MCPLifespanManager
    ...
    def test_mcp_server_has_name(self):
        ...
        from doclatticeserver.mcp.server import mcp_server

        self.assertEqual(mcp_server.name, "doclattice")

    def test_mcp_asgi_app_exists(self):
        """Test ASGI app is created."""
        from doclatticeserver.mcp.server import mcp_asgi_app
...
class MCPSSETransportTest(TestCase):
    ...
    def test_sse_transport_exists(self):
        ...
        from doclatticeserver.mcp.server import sse_transport
    ...
    def test_sse_starlette_app_exists(self):
        ...
        from doclatticeserver.mcp.server import sse_starlette_app
    ...
    def test_handle_sse_connection_exists(self):
        ...
        from doclatticeserver.mcp.server import handle_sse_connection
...
class MCPASGIRoutingTest(TestCase):
    ...
    def test_asgi_app_mcp_path_error_handling(self):
        ...
        async def run_test():
            ...
            with patch(
                "doclatticeserver.mcp.server.lifespan_manager", mock_lifespan
            ), patch(
                "doclatticeserver.mcp.server.get_session_manager",
    ...
    def test_asgi_app_sse_path_error_handling(self):
        ...
        async def run_test():
            ...
            with patch("doclatticeserver.mcp.server.sse_starlette_app", mock_sse_app):
...
class MCPTelemetryTest(TestCase):
    ...
    def setUp(self):
        ...
        from doclatticeserver.mcp.telemetry import clear_request_context
    ...
    def test_hash_ip(self):
        ...
        from doclatticeserver.mcp.telemetry import _hash_ip
    ...
    def test_set_and_get_request_context(self):
        ...
        from doclatticeserver.mcp.telemetry import (
...
class MCPTelemetryIntegrationTest(TestCase):
    ...
    def test_call_tool_records_telemetry(self):
        ...
        from doclatticeserver.mcp.server import TOOL_HANDLERS, call_tool_handler
        ...
        async def run_test():
            ...
            try:
                with patch(
                    "doclatticeserver.mcp.server.arecord_mcp_tool_call"
                ) as mock_record:
    ...
    def test_read_resource_records_telemetry(self):
        ...
        async def run_test():
            ...
            with patch(
                "doclatticeserver.mcp.server.arecord_mcp_resource_read"
...
class MCPScopedToolsTest(TestCase):
    ...
    def test_get_corpus_info(self):
        ...
        from doclatticeserver.mcp.tools import get_corpus_info
    ...
    def test_create_scoped_tool_wrapper(self):
        ...
        from doclatticeserver.mcp.tools import (
    ...
    def test_get_scoped_tool_handlers(self):
        ...
        from doclatticeserver.mcp.tools import get_scoped_tool_handlers
...
class MCPScopedServerTest(TransactionTestCase):
    ...
    def test_create_scoped_mcp_server(self):
        ...
        from doclatticeserver.mcp.server import create_scoped_mcp_server

        server = create_scoped_mcp_server(self.corpus.slug)

        self.assertIsNotNone(server)
        self.assertEqual(server.name, f"doclattice-corpus-{self.corpus.slug}")

    def test_get_scoped_tool_definitions(self):
        """Test scoped tool definitions don't require corpus_slug."""
        from doclatticeserver.mcp.server import get_scoped_tool_definitions
    ...
    def test_get_scoped_resource_definitions(self):
        ...
        from doclatticeserver.mcp.server import get_scoped_resource_definitions
    ...
    def test_get_scoped_resource_template_definitions(self):
        ...
        from doclatticeserver.mcp.server import (
    ...
    def test_get_scoped_session_manager(self):
        ...
        from doclatticeserver.mcp.server import get_scoped_session_manager
    ...
    def test_get_scoped_lifespan_manager(self):
        ...
        from doclatticeserver.mcp.server import get_scoped_lifespan_manager
    ...
    def test_validate_corpus_slug_valid(self):
        ...
        from doclatticeserver.mcp.server import validate_corpus_slug
        ...
        async def run_test():
            with patch(
                "doclatticeserver.corpuses.models.Corpus.objects.visible_to_user",
...
class MCPScopedASGIRoutingTest(TransactionTestCase):
    ...
    def test_asgi_routes_scoped_corpus_path(self):
        ...
        async def run_test():
            ...
            with patch(
                "doclatticeserver.mcp.server.get_scoped_lifespan_manager",
                side_effect=mock_get_lifespan,
            ), patch(
                "doclatticeserver.mcp.server.validate_corpus_slug",
                return_value=True,
            ):
                app = create_mcp_asgi_app()
                await app(scope, mock_receive, mock_send)
    ...
    def test_asgi_routes_private_scoped_corpus_with_valid_bearer_token(self):
        ...
        async def run_test():
            ...
            with patch(
                "doclatticeserver.mcp.server.get_user_from_jwt_token",
...
class MCPTTLLRUCacheTest(TestCase):
    ...
    def test_cache_lru_eviction(self):
        ...
        from doclatticeserver.mcp.server import TTLLRUCache
    ...
    def test_cache_ttl_expiration(self):
        ...
        async def run_test():
            ...
            with patch("doclatticeserver.mcp.server.time") as mock_time:
                # Set initial time
...
class MCPCleanupCallbackErrorTest(TestCase):
    ...
    def test_cleanup_callback_error_logged(self):
        ...
        from doclatticeserver.mcp.server import _cleanup_lifespan_manager
        ...
        async def run_test():
            ...
            with patch("asyncio.get_event_loop", side_effect=RuntimeError("No loop")):
                with patch("doclatticeserver.mcp.server.logger") as mock_logger:
    ...
    def test_mcp_error_response_send_failure_logged(self):
        ...
        async def run_test():
            ...
            with patch(
                ...
                "doclatticeserver.mcp.server.logger"
            ) as mock_logger:
                app = create_mcp_asgi_app()
...
class MCPScopedLifespanManagerShutdownTest(TransactionTestCase):
    ...
    def test_lifespan_manager_shutdown_error_handling(self):
        ...
        from doclatticeserver.mcp.server import ScopedMCPLifespanManager
...
class MCPCleanupSessionManagerTest(TestCase):
    ...
    def test_cleanup_session_manager_logs(self):
        ...
        from doclatticeserver.mcp.server import _cleanup_session_manager
...
class AsyncMCPTelemetryFunctionsTest(TestCase):
    """Direct tests for async MCP telemetry functions in doclatticeserver/mcp/telemetry.py.
    ...
    def test_arecord_mcp_tool_call_success_no_context(self):
        ...
        from doclatticeserver.mcp.telemetry import arecord_mcp_tool_call

        with patch(
            "doclatticeserver.mcp.telemetry.arecord_event",
    ...
    def test_arecord_mcp_resource_read_success_no_context(self):
        ...
        from doclatticeserver.mcp.telemetry import arecord_mcp_resource_read
    ...
    def test_arecord_mcp_request_success_no_context(self):
        ...
        from doclatticeserver.mcp.telemetry import arecord_mcp_request
...
class MCPSafeToolArgumentsTest(TestCase):
    ...
    def test_drops_user_argument(self):
        from doclatticeserver.mcp.server import _safe_tool_arguments
        from doclatticeserver.mcp.tools import list_documents
    ...
    def test_scoped_asgi_success_records_request_telemetry(self):
        ...
        async def run_test():
            ...
            with patch(
                ...
                "doclatticeserver.mcp.server.arecord_mcp_request",
                new_callable=AsyncMock,
                return_value=True,
            ) as mock_record:
                app = create_mcp_asgi_app()
...
class MCPAuthenticatedToolsTest(TestCase):
    ...
    def test_create_thread_message_requires_authentication(self):
        ...
        from doclatticeserver.mcp.tools import create_thread_message
    ...
    def test_create_thread_message_rejects_oversized_content(self):
        ...
        from doclatticeserver.constants.mcp import MAX_THREAD_MESSAGE_LENGTH
        from doclatticeserver.mcp.tools import create_thread_message
...
class MCPCallToolHandlerAuthTest(_MCPAsyncRunMixin, TransactionTestCase):
    ...
    def test_handler_passes_user_to_tool(self):
        ...
        from doclatticeserver.mcp.server import _mcp_user, call_tool_handler
...
class MCPAsgiAppAuthTest(_MCPAsyncRunMixin, TestCase):
    ...
    def test_invalid_bearer_token_401_includes_www_authenticate_header(self):
        ...
        plain ``Bearer realm="doclattice"`` value — no resource_metadata
    ...
    def test_invalid_bearer_token_401_advertises_resource_metadata_under_auth0(
        ...
        headers = dict(starts[0]["headers"])
        www_auth = headers[b"www-authenticate"].decode("ascii")
        self.assertIn('Bearer realm="doclattice"', www_auth)
        self.assertIn(
            'resource_metadata="https://doclattice.test/.well-known/oauth-protected-resource"',
            www_auth,
        )
    ...
    def test_www_authenticate_rejects_malformed_forwarded_proto(self):
        ...
        from doclatticeserver.mcp.server import _build_www_authenticate_header
        ...
        self.assertIn(
            'resource_metadata="http://doclattice.test/.well-known/oauth-protected-resource"',
            header,
        )
    ...
    def test_invalid_bearer_token_still_uses_global_rate_limit(self):
        ...
        with patch(
            "doclatticeserver.mcp.server.check_mcp_rate_limit",
            new=AsyncMock(return_value=(True, "rate limited", 9)),
        ), patch("doclatticeserver.mcp.server.get_user_from_jwt_token") as verifier:
            messages = self._run_app(scope)
    ...
    def test_authed_endpoint_401_advertises_path_based_metadata_under_auth0(self):
        ...
        self.assertIn(
            'resource_metadata="https://doclattice.test'
    ...
    def test_malformed_configured_base_url_degrades_to_realm_only(self):
        ...
        for bad_value in (
            ...
            with self.subTest(bad_value=bad_value):
                ...
                self.assertEqual(www_auth, 'Bearer realm="doclattice"')
                self.assertNotIn("attacker.example", www_auth)
...
class MCPResourceAuthTest(_MCPAsyncRunMixin, TransactionTestCase):
    ...
    def test_read_resource_handler_uses_authenticated_user(self):
        from doclatticeserver.mcp.server import _mcp_user, read_resource_handler
...
class MCPNonScopedListToolsTest(_MCPAsyncRunMixin, TestCase):
    ...
    def test_create_thread_message_advertised_in_list_tools(self):
        ...
        from doclatticeserver.mcp.server import TOOL_HANDLERS, mcp_server
...
class MCPExtractBearerTokenTest(TestCase):
    ...
    def test_returns_none_for_non_http_scope(self):
        from doclatticeserver.mcp.server import _extract_bearer_token
...
class MCPToolsRelationshipsTest(TestCase):
    ...
    def test_list_relationships_document_scoped(self):
        from doclatticeserver.mcp.tools import list_relationships
...
class MCPSearchCorpusStructuralSlugTest(TestCase):
    ...
    def test_structural_passage_without_lookup_returns_none_slug(self):
        ...
        from doclatticeserver.mcp.formatters import format_search_passage
...
class MCPErrorFormattingTest(TestCase):
    ...
    def test_document_does_not_exist_message(self):
        from doclatticeserver.documents.models import Document
        from doclatticeserver.mcp.server import _format_tool_error_text
