...
from doclatticeserver.pipeline.embedders.modern_bert_embedder import ModernBERTEmbedder, ModernBERTEmbedder768
...
class TestModernBERTEmbedder(unittest.TestCase):
    ...
    @patch('doclatticeserver.pipeline.embedders.modern_bert_embedder.SentenceTransformer')
