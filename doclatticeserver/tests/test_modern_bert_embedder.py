...
from doclatticeserver.pipeline.embedders.modern_bert_embedder import (
    ModernBERTEmbedder,
    ModernBERTEmbedder768,
)
...
class TestModernBERTEmbedder(unittest.TestCase):
    ...
    @patch(
        "doclatticeserver.pipeline.embedders.modern_bert_embedder.SentenceTransformer"
    )
    def test_initialization(self, mock_transformer):
        ...
        self.assertEqual(
            embedder.model_path, "/models/sentence-transformers/ModernBERT-base"
        )
    ...
    @patch("doclatticeserver.pipeline.embedders.modern_bert_embedder.os.path.exists")
    @patch(
        "doclatticeserver.pipeline.embedders.modern_bert_embedder.SentenceTransformer"
    )
