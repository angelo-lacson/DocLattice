...
from doclatticeserver.analyzer.models import Analyzer, GremlinEngine, Analysis
from doclatticeserver.extracts.models import Fieldset, Column, Datacell, Extract
from doclatticeserver.corpuses.signals import handle_document_added_to_corpus
...
class TestCorpusDocumentActions(TestCase):
    ...
    def test_signal_triggered_on_document_add(self):
        with patch('doclatticeserver.corpuses.signals.process_corpus_action') as mock_task:
    ...
    @patch('doclatticeserver.tasks.corpus_tasks.process_corpus_action.apply_async')
