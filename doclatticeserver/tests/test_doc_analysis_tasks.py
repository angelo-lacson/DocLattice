...
from doclatticeserver.tasks.doc_analysis_tasks import build_contract_knowledge_base
from doclatticeserver.tasks.doc_analysis_tasks import build_case_law_knowledge_base
