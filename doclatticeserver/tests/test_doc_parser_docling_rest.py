...
from doclatticeserver.pipeline.parsers.docling_parser_rest import DoclingParserRest
...
class TestDoclingParserRest(TestCase):
    """Tests for the DoclingParserRest class."""
    ...
    def setUp(self):
        ...
        # Create an instance of DoclingParserRest
        self.parser = DoclingParserRest()
    ...
    @patch("doclatticeserver.pipeline.parsers.docling_parser_rest.default_storage.open")
    def test_parse_document_success(self, mock_open, mock_post):
        ...
        payload = call_kwargs["json"]  # In requests.post, the json parameter is already a dict
    ...
    def test_parse_document_service_error(self, mock_open, mock_post):
        ...
        mock_post.return_value.raise_for_status = MagicMock(side_effect=Exception("500 Server Error"))
