...
from doclatticeserver.types.enums import ExportType, AnnotationFilterMode
...
class TestExportMutations(BaseFixtureTestCase):
    ...
    4. Both DOCLATTICE and FUNSD export formats work
    """
    ...
    def test_basic_export_without_parameters(self):
        ...
        variables = {
            ...
            "exportFormat": ExportType.DOCLATTICE.value,
        }
