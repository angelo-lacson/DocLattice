...
from doclatticeserver.tasks.research_tasks import _audited, _terminal_reason
...
class DefaultToolsetAuditTests(TestCase):
    ...
    def test_an_async_default_tool_is_wrapped_and_logs_its_calls(self):
        from doclatticeserver.tasks.research_tasks import _audit_default_toolset
    ...
    def test_a_closure_this_module_already_wrapped_is_not_wrapped_again(self):
        ...
        from doclatticeserver.tasks.research_tasks import (
            _audit_default_toolset,
            _audited,
        )
...
class SalvagePathIntegrationTests(TransactionTestCase):
    ...
    def _run(self, agent: _FakeAgent) -> dict:
        from doclatticeserver.tasks import research_tasks
        ...
        with patch(
            "doclatticeserver.llms.api.AgentAPI.for_corpus", new=_for_corpus
        ), patch.object(
            research_tasks,
