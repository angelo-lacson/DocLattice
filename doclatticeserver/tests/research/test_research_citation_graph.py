...
from doclatticeserver.llms import api as llms_api
from doclatticeserver.research.models import ResearchReport
from doclatticeserver.tasks.research_tasks import _run_deep_research_async
...
class CitationGraphContractTestCase(TransactionTestCase):
    ...
    def _drive(self, script) -> dict:
        ...
        # does ``from doclatticeserver.llms import agents``, and
