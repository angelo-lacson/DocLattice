...
class ResearchReportServiceTestCase(TestCase):
    ...
    def test_start_creates_queued_row_and_enqueues_task(self):
        ...
        with patch(
            "doclatticeserver.tasks.research_tasks.run_deep_research.delay"
    ...
    def test_start_uses_supplied_title(self):
        with patch("doclatticeserver.tasks.research_tasks.run_deep_research.delay"):
            report = ResearchReportService.start(
                user=self.user,
                corpus=self.corpus,
                prompt="x",
    ...
    def test_workspace_save_failure_never_fails_a_completed_report(self):
        ...
        with patch(
            "doclatticeserver.corpuses.services.WorkspaceService.save_markdown",
