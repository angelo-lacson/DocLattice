...
from ``doclatticeserver/tests/fixtures/authority_sources/`` and is a
...
from doclatticeserver.pipeline.authority_discovery_providers.listing_index_provider import (
...
class TestSSRFRejection(SimpleTestCase):
    ...
    resolution or socket connect (see doclatticeserver/utils/safe_http.py::
