...
from doclatticeserver.pipeline.base.exceptions import FileConversionError
from doclatticeserver.pipeline.base.file_converter import (
    BaseFileConverter,
    extension_for_filename,
    normalize_extension,
)
from doclatticeserver.pipeline.base.file_types import NATIVE_PIPELINE_EXTENSIONS
from doclatticeserver.pipeline.file_converters.gotenberg_converter import (
...
GOTENBERG_REQUESTS_POST = (
    "doclatticeserver.pipeline.file_converters.gotenberg_converter.requests.post"
)
...
class ValidateFileTypeConverterTestCase(TestCase):
    ...
    def test_unknown_binary_rejected_without_converter(self):
        from doclatticeserver.documents.document_service import DocumentService
...
class ConvertDocumentToPdfTaskTestCase(TestCase):
    ...
    def test_skipped_when_no_converter_configured(self):
        from doclatticeserver.tasks.doc_tasks import convert_document_to_pdf
