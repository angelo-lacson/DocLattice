...
from doclatticeserver.enrichment.services import authority_source_hosts as ash
...
from doclatticeserver.pipeline.authority_source_providers.us_code_provider import (
...
from doclatticeserver.utils.safe_http import host_on_allowlist

# A minimal concrete provider shipped "inside a pack" — imported by file path
# under a synthetic module name, so its real DocLattice imports must resolve.
...
_MODULE = "doclatticeserver.enrichment.services.authority_source_hosts"
