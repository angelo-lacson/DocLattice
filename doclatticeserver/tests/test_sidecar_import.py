...
including a co-located .json sidecar (DocLatticeDocExport format)
...
def _build_sidecar_json(
    ...
    """
    Build a realistic DocLatticeDocExport dict using real fixture data.
    """
...
def _make_annotation(
    ...
    """Build a realistic DocLatticeAnnotationPythonType dict."""
    return {
        "id": annot_id,
...
class TestSidecarImportTask(TestCase):
    ...
    def test_oversized_sidecar_pre_read_rejected(self):
        ...
        with patch(
            "doclatticeserver.tasks.import_tasks.ZIP_MAX_SIDECAR_SIZE_BYTES",
            10,
        ):
            result = import_zip_with_folder_structure.apply(
                kwargs={
    ...
    def test_oversized_sidecar_post_read_rejected(self):
        ...
        from doclatticeserver.tasks.import_tasks import _read_sidecar
...
class TestSidecarSchemaValidation(TestCase):
    ...
    def test_valid_sidecar_passes(self):
        ...
        from doclatticeserver.tasks.import_tasks import _validate_sidecar_schema
    ...
    def test_none_fields_pass(self):
        """Absent fields (None) are valid — they're simply not present."""
        from doclatticeserver.tasks.import_tasks import _validate_sidecar_schema
