...
from doclatticeserver.pipeline.embedders.minn_modern_bert_embedder import (
...
class TestMinnModernBERTEmbedder(TestCase):
    ...
    @patch(
        "doclatticeserver.pipeline.embedders.minn_modern_bert_embedder.SentenceTransformer"
    )
    ...
    @patch(
        "doclatticeserver.pipeline.embedders.minn_modern_bert_embedder.os.path.exists"
    )
    @patch(
        "doclatticeserver.pipeline.embedders.minn_modern_bert_embedder.SentenceTransformer"
    )
...
@patch(
    "doclatticeserver.pipeline.embedders.minn_modern_bert_embedder.logger"
)  # Patch logger
