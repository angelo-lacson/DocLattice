"""
Tests for the core DocLattice Agent API surface.
(agents, tools, vector_stores as imported from doclatticeserver.llms)
"""
...
from doclatticeserver.llms import agents, tools, vector_stores # The API under test
...
class TestToolAPIHypermodern(TestAPISetup):
    ...
    def test_get_standard_document_tools(self):
        ...
        with patch('doclatticeserver.llms.api.create_document_tools') as mock_api_create_doc_tools:
