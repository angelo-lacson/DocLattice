...
from doclatticeserver.constants.embeddings import (
...
from doclatticeserver.pipeline.embedders.openai_embedder import OpenAIEmbedder
...
class TestOpenAIEmbedderEmbedText(TestCase):
    ...
    @patch("doclatticeserver.pipeline.embedders.openai_embedder.openai.OpenAI")
...
class TestOpenAIEmbedderDiscovery(TestCase):
    ...
    def test_embedder_discoverable(self):
        from doclatticeserver.pipeline.registry import get_all_embedders_cached
    ...
    def test_embedder_definition_metadata(self):
        from doclatticeserver.pipeline.registry import get_component_by_name_cached
