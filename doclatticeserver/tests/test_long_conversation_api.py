...
class TestLongConversationAPI(TestCase):
    ...
    async def test_anonymous_conversation_creation(self):
        ...
        with patch(
            "doclatticeserver.llms.agents.llama_index_agents.OpenAIAgent"
        ) as MockOpenAIAgent:
            ...
            with patch(
                "doclatticeserver.llms.agents.llama_index_agents.Settings"
            ), patch(
                "doclatticeserver.llms.agents.llama_index_agents.VectorStoreIndex"
            ), patch(
    ...
    async def test_corpus_agent_anonymous_conversation(self):
        ...
        with patch(
            ...
            with patch(
                ...
                "doclatticeserver.llms.agents.llama_index_agents.ObjectIndex"
            ), patch(
                "doclatticeserver.llms.agents.llama_index_agents.VectorStoreIndex"
            ):
