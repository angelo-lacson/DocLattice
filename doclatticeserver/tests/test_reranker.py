...
from doclatticeserver.pipeline.base.reranker import (
    BaseReranker,
...
from doclatticeserver.pipeline.rerankers.cohere_reranker import CohereReranker
from doclatticeserver.pipeline.rerankers.microservice_reranker import (
    MicroserviceReranker,
)
from doclatticeserver.pipeline.rerankers.noop_reranker import NoopReranker
...
class CrossEncoderRerankerTest(TestCase):
    def setUp(self) -> None:
        from doclatticeserver.pipeline.rerankers import cross_encoder_reranker
    ...
    def _reranker(self):
        from doclatticeserver.pipeline.rerankers.cross_encoder_reranker import (
    ...
    def test_successful_rerank_returns_scores(self) -> None:
        ...
        with patch(
            "doclatticeserver.pipeline.rerankers.cross_encoder_reranker."
            "_load_cross_encoder",
            return_value=stub,
        ):
...
class PipelineUtilityTest(TransactionTestCase):
    ...
    def setUp(self) -> None:
        ...
        from doclatticeserver.pipeline.utils import invalidate_reranker_cache
    ...
    def test_configured_reranker_is_instantiated_and_cached(self) -> None:
        ...
        instance = self.PipelineSettings.get_instance()
        instance.default_reranker = (
            "doclatticeserver.pipeline.rerankers.noop_reranker.NoopReranker"
        )
        instance.save()
...
class CoreVectorStoreRerankerIntegrationTest(TestCase):
    ...
    def test_first_stage_top_k_capped_by_max_candidates(self) -> None:
        ...
        from doclatticeserver.constants.search import RERANK_MAX_CANDIDATES
