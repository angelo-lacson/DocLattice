...
from doclatticeserver.pipeline.parsers.docxodus_parser import DocxodusServiceParser
...
class TestDocxodusServiceParser(TestCase):
    ...
    @patch("doclatticeserver.pipeline.parsers.docxodus_parser.requests.post")
    ...
    def test_normalize_response_camel_to_snake(self):
        ...
        # annotationLabel and rawText stay camelCase (DocLatticeDocExport format)
...
class TestDocxThumbnailGenerator(TestCase):
    ...
    def test_extract_text_preview(self):
        ...
        from doclatticeserver.pipeline.thumbnailers.docx_thumbnailer import (
