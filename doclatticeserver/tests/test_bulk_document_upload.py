...
class BulkDocumentUploadTests(TestCase):
    ...
    @patch("doclatticeserver.tasks.import_tasks.process_documents_zip")
    ...
    def test_file_processing_error(self):
        ...
        with patch(
            "doclatticeserver.documents.versioning.ContentFile",
    ...
    def test_job_level_exception(self):
        ...
        with patch(
            "doclatticeserver.corpuses.models.TemporaryFileHandle.objects.get",
