...
class MockParser(BaseParser):
    ...
    def parse_document(self, user_id: int, doc_id: int, **kwargs) -> Optional[DocLatticeDocExport]:
...
"""
    ...
    def test_parser_kwargs_passing_via_ephemeral_parser(self):
        ...
        with self.settings(
            ...
            with patch(
                "doclatticeserver.pipeline.parsers.mock_parser.MockParser.parse_document",
                return_value=None,
            ) as mock_parse:
