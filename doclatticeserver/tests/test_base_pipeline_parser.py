...
class TestBasePipelineParser(TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        # We define ephemeral code for a "MockParser" in doclatticeserver/pipeline/parsers.
...
class MockParser(BaseParser):
    ...
    def _parse_document_impl(self, user_id: int, doc_id: int, **kwargs) -> Optional[DocLatticeDocExport]:
        logger.info(f"MockParser.parse_document called with kwargs: {kwargs}")
        return None
"""

        # Write ephemeral code to a file in doclatticeserver/pipeline/parsers.
        ...
        # Reload the entire doclatticeserver.pipeline.parsers subpackage.
        import doclatticeserver.pipeline.parsers

        importlib.reload(doclatticeserver.pipeline.parsers)
    ...
    def test_parser_kwargs_passing_via_ephemeral_parser(self):
        ...
        mock_parsed_data: DocLatticeDocExport = {
            "title": "Test",
        ...
        pipeline_settings.preferred_parsers = {
            **pipeline_settings.preferred_parsers,
            "application/mock": "doclatticeserver.pipeline.parsers.mock_parser.MockParser",
        }
        pipeline_settings.parser_kwargs = {
            **pipeline_settings.parser_kwargs,
            "doclatticeserver.pipeline.parsers.mock_parser.MockParser": {
                "test_key": "test_value"
            },
        }
        ...
        with patch(
            "doclatticeserver.pipeline.parsers.mock_parser.MockParser._parse_document_impl",
    ...
    def test_mock_parser_relationship_import(self):
        ...
        self.assertIsNotNone(
            parsed_data, "Parser should return a valid DocLatticeDocExport."
        )
