...
from doclatticeserver.llms import agents, embeddings, tools
from doclatticeserver.llms.agents.core_agents import AgentFramework, CoreAgent
...
class TestEmbeddingAPI:
    ...
    def test_simple_embedding_generation(self):
        ...
        with patch('doclatticeserver.utils.embeddings.generate_embeddings_from_text') as mock_generate:
...
class TestToolAPI:
    ...
    def test_document_tools(self):
        ...
        with patch('doclatticeserver.llms.tools.tool_factory.create_document_tools') as mock_create:
