"""
Tests for the beautiful DocLattice LLM API.
...
from doclatticeserver.llms import agents, embeddings, tools, vector_stores
from doclatticeserver.llms.types import AgentFramework
from doclatticeserver.llms.agents.core_agents import CoreAgent
...
class TestAgentAPI(TestCase):
    ...
    def test_simple_document_agent_creation(self):
        ...
        with patch('doclatticeserver.llms.agents.agent_factory.UnifiedAgentFactory.create_document_agent') as mock_create:
    ...
    def test_corpus_agent_creation(self):
        ...
        with patch('doclatticeserver.llms.agents.agent_factory.UnifiedAgentFactory.create_corpus_agent') as mock_create:
            mock_agent = AsyncMock(spec=CoreAgent)
            mock_create.return_value = mock_agent
...
class TestToolAPI(TestCase):
    ...
    def test_from_function(self):
        ...
        with patch('doclatticeserver.llms.tools.tool_factory.CoreTool.from_function') as mock_from_function:
...
class TestVectorStoreAPI(TestCase):
    ...
    def test_simple_vector_store_creation(self):
        ...
        with patch('doclatticeserver.llms.vector_stores.vector_store_factory.UnifiedVectorStoreFactory.create_vector_store') as mock_create:
...
class TestToolResolution(TestCase):
    ...
    def test_unknown_builtin_tool(self):
        ...
        with patch('doclatticeserver.llms.api.logger') as mock_logger:
...
class TestAPIIntegration(TestCase):
    ...
    def test_vector_store_integration(self):
        ...
        with patch('doclatticeserver.llms.vector_stores.vector_store_factory.UnifiedVectorStoreFactory.create_vector_store') as mock_vs_create, \
             patch('doclatticeserver.llms.agents.agent_factory.UnifiedAgentFactory.create_document_agent') as mock_agent_create:
...
class TestAPIPerformance(TestCase):
    ...
    def test_lazy_loading(self):
        ...
        from doclatticeserver.llms import api
    ...
    def test_api_singleton_instances(self):
        ...
        from doclatticeserver.llms.api import AgentAPI, EmbeddingAPI, ToolAPI, VectorStoreAPI
        from doclatticeserver.llms import api
        ...
        from doclatticeserver.llms import agents as agents_import
        from doclatticeserver.llms import embeddings as embeddings_import
        from doclatticeserver.llms import tools as tools_import
        from doclatticeserver.llms import vector_stores as vector_stores_import
