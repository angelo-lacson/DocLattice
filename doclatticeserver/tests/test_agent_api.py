...
from doclatticeserver.llms.api import ToolType
...
class TestAgentAPI(TestCase):
    ...
    def test_simple_document_agent_creation(self):
        ...
        with patch(
            "doclatticeserver.llms.agents.agent_factory.UnifiedAgentFactory.create_document_agent"
        ) as mock_create:
    ...
    def test_corpus_agent_creation(self):
        ...
        with patch(
            "doclatticeserver.llms.agents.agent_factory.UnifiedAgentFactory.create_corpus_agent"
        ) as mock_create:
            mock_agent = AsyncMock(spec=CoreAgent)
            mock_create.return_value = mock_agent
...
class TestToolAPI(TestCase):
    ...
    def test_from_function(self):
        ...
        with patch(
            "doclatticeserver.llms.tools.tool_factory.CoreTool.from_function"
...
class TestVectorStoreAPI(TestCase):
    ...
    def test_simple_vector_store_creation(self):
        ...
        with patch(
            "doclatticeserver.llms.vector_stores.vector_store_factory.UnifiedVectorStoreFactory.create_vector_store"
        ) as mock_create:
...
class TestAPIPerformance(TestCase):
    ...
    def test_api_singleton_instances(self):
        ...
        from doclatticeserver.llms import api
        from doclatticeserver.llms.api import (
            AgentAPI,
            EmbeddingAPI,
            ToolAPI,
            VectorStoreAPI,
...
class TestToolFunctionRegistry(TestCase):
    ...
    def test_all_registered_tools_are_async(self):
        ...
        from doclatticeserver.llms.tools.tool_registry import ToolFunctionRegistry
        from doclatticeserver.llms.tools.web_search_tools import WebSearchTool
