...
from doclatticeserver.llms.api import _resolve_framework
...
# lives at ``doclatticeserver/tests/test_llms_typing_behavior_guards.py``
...
class TestPermissionGuardsOnAnnotationTools(TestCase):
    ...
    def test_aadd_document_note_is_importable(self) -> None:
        ...
        from doclatticeserver.llms.agents import pydantic_ai_agents as paa
...
class TestSyncToAsyncListEvaluation(TestCase):
    ...
    def test_no_naked_sync_to_async_list_callsites(self) -> None:
        ...
        modules = [
            ...
            _PROJECT_ROOT
            / "doclatticeserver/llms/vector_stores/pydantic_ai_vector_stores.py",
        ]
        offenders = []
...
class TestVectorStoreTypingChanges(TestCase):
    ...
    def test_corpus_agent_context_documents_default_is_empty_list(self) -> None:
        from doclatticeserver.llms.agents.core_agents import CorpusAgentContext
