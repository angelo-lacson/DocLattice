...
from doclatticeserver.analyzer.utils import auto_create_doc_analyzers
...
PII_TASK_NAME = "doclatticeserver.tasks.doc_analysis_tasks.pii_scanner_privacy_filter"
...
class _BasePiiScannerAnalyzerTestCase(TransactionTestCase):
    ...
    def _run_task(self, *, doc_id: int, analysis_id: int, **kwargs: Any) -> Any:
        from doclatticeserver.tasks.doc_analysis_tasks import (
...
class PiiScannerTextDocTests(_BasePiiScannerAnalyzerTestCase):
    ...
    def test_text_doc_creates_span_label_annotations(self) -> None:
        ...
        with patch(
            "doclatticeserver.llms.tools.core_tools._privacy_filter_client.adetect_pii",
