"""
Tests for agent task functions in doclatticeserver/tasks/agent_tasks.py.
...
class TestBroadcastToThread(TestCase):
    ...
    @patch("doclatticeserver.tasks.agent_tasks.get_channel_layer")
    ...
    @patch("doclatticeserver.tasks.agent_tasks.get_channel_layer")
    @patch("doclatticeserver.tasks.agent_tasks.async_to_sync")
...
class TestTriggerAgentResponsesForMessage(TestCase):
    ...
    @patch("doclatticeserver.tasks.agent_tasks.generate_agent_response.delay")
