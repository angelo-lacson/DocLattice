...
- Shared services in doclatticeserver.document_imports.services
...
class ImportServicesTests(TestCase):
    ...
    def test_import_document_for_user_creates_document(self):
        from doclatticeserver.document_imports.services import (
...
class ServiceHelperUnitTests(TestCase):
    ...
    def test_resolve_pk_none_returns_none(self):
        from doclatticeserver.document_imports.services import _resolve_pk
    ...
    def test_detect_mime_type_markdown_extension_for_plaintext(self):
        from doclatticeserver.document_imports.services import detect_mime_type
    ...
    def test_peek_zip_magic_logs_warning_when_seek_fails(self):
        ...
        from doclatticeserver.document_imports.services import _peek_zip_magic
        ...
        with self.assertLogs(
            "doclatticeserver.document_imports.services", level=logging.WARNING
        ) as cm:
    ...
    def test_normalise_optional_blank_string_becomes_none(self):
        from doclatticeserver.document_imports.services import normalise_optional
    ...
    def test_resolve_pk_swallows_decode_errors(self):
        ...
        with patch(
            "doclatticeserver.document_imports.services.from_global_id",
    ...
    def test_import_document_for_user_wraps_storage_failure(self):
        ...
        with patch(
            "doclatticeserver.corpuses.models.Corpus.import_content",
    ...
    def test_import_documents_zip_for_user_wraps_staging_failure(self):
        ...
        zip_bytes = _make_zip({"a.pdf": PDF_BYTES})
        with patch(
            "doclatticeserver.document_imports.services."
...
class CorpusExportImportViewTests(TestCase):
    """
    Multipart DocLattice corpus-export upload
...
class CorpusExportImportServiceTests(TestCase):
    ...
    def test_existing_destination_is_passed_to_existing_import_task(self):
        ...
        from doclatticeserver.document_imports import services
