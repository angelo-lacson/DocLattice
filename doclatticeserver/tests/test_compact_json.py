...
from doclatticeserver.tests.factories import AnnotationFactory
...
class TestAnnotationSaveAutoCompact(TestCase):
    ...
    @patch(
        "doclatticeserver.annotations.models.compact_annotation_json",
...
class TestDecodeEdgePaths(TestCase):
    ...
    @patch("doclatticeserver.annotations.compact_json.logger")
