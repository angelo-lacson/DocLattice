...
from doclatticeserver.document_imports.services import ImportResult
from doclatticeserver.documents.models import Document
from doclatticeserver.shared.services.conventions import ServiceResult

User = get_user_model()

_IMPORT_TARGET = "doclatticeserver.document_imports.services.import_document_for_user"
_SETUP_TARGET = (
    "doclatticeserver.corpuses.services.intelligence_setup."
    "CorpusIntelligenceSetupService.setup"
)
_CONVERTIBLE_TARGET = "doclatticeserver.pipeline.utils.get_convertible_extensions"
...
class IngestCorpusCommandTests(TestCase):
    ...
    def test_wait_for_processing_settles_on_failed_and_missing_docs(self):
        ...
        """
        from doclatticeserver.corpuses.management.commands.ingest_corpus import (
            Command,
        )
