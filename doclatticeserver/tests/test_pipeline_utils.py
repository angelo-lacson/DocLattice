...
'''
        ...
        importlib.reload(importlib.import_module('doclatticeserver.pipeline.thumbnailers'))
    ...
    def test_get_all_subclasses(self):
        ...
        # Test embedders
        embedders = get_all_subclasses('doclatticeserver.pipeline.embedders', BaseEmbedder)
        embedder_titles = [embedder.title for embedder in embedders]
        self.assertIn("Test Embedder", embedder_titles)

        # Test thumbnailers
        thumbnailers = get_all_subclasses('doclatticeserver.pipeline.thumbnailers', BaseThumbnailGenerator)
    ...
    def test_get_component_by_name(self):
        ...
        from doclatticeserver.pipeline.thumbnailers.test_thumbnailer import TestThumbnailer
