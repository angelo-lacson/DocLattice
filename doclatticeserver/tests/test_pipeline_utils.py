...
'''
    ...
    def test_get_all_subclasses(self):
        ...
        parsers = cast(
            ...
            get_all_subclasses("doclatticeserver.pipeline.parsers", BaseParser),
        )
        ...
        embedders = cast(
            ...
            get_all_subclasses("doclatticeserver.pipeline.embedders", BaseEmbedder),
        )
        embedder_titles = [embedder.title for embedder in embedders]
    ...
    def test_get_metadata_for_component(self):
        ...
        """
        from doclatticeserver.pipeline.parsers.test_parser import TestParser
    ...
    def test_get_component_by_name(self):
        ...
        from doclatticeserver.pipeline.embedders.temp_embedder import TestEmbedder

        self.assertEqual(component, TestEmbedder)

        # Test thumbnailer component
        component = get_component_by_name("test_thumbnailer")
        from doclatticeserver.pipeline.thumbnailers.test_thumbnailer import (
            TestThumbnailer,
        )
        ...
        from doclatticeserver.pipeline.post_processors.test_post_processor import (
            TestPostProcessor,
        )
    ...
    def test_run_post_processors(self):
        ...
        modified_zip_bytes, modified_export_data = run_post_processors(
            processor_paths,
            test_zip_bytes,
            cast(DocLatticeExportDataJsonPythonType, test_export_data),
        )
