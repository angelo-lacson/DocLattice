...
'''
    ...
    def test_get_dimension_from_embedder(self):
        ...
        self.assertEqual(
            get_dimension_from_embedder(
                "doclatticeserver.pipeline.embedders.test_embedder.TestEmbedder384"
            ),
            384,
        )
    ...
    @override_settings(
        DEFAULT_EMBEDDERS_BY_FILETYPE={
            "application/pdf": "doclatticeserver.pipeline.embedders.test_embedder.TestEmbedder384",
            "text/plain": "doclatticeserver.pipeline.embedders.test_embedder.TestEmbedder768",
        }
    )
