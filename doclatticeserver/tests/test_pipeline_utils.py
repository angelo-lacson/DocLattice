...
'''
    ...
    def test_get_dimension_from_embedder(self):
        ...
        # Test with path
        with patch('doclatticeserver.pipeline.utils.get_component_by_name') as mock_get_component:
    ...
    def test_get_default_embedder_for_filetype_and_dimension(self, mock_settings):
        ...
        mock_settings.DEFAULT_EMBEDDERS_BY_FILETYPE_AND_DIMENSION = {
            "application/pdf": {
                384: "doclatticeserver.tests.test_pipeline_utils.TestEmbedder384",
                768: "doclatticeserver.tests.test_pipeline_utils.TestEmbedder768",
            },
            "text/plain": {
                384: "doclatticeserver.tests.test_pipeline_utils.TestEmbedder384",
                768: "doclatticeserver.tests.test_pipeline_utils.TestEmbedder768",
    ...
    @patch('doclatticeserver.pipeline.utils.get_default_embedder_for_filetype_and_dimension')
