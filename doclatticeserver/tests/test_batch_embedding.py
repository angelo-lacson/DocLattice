...
TEST_EMBEDDER_PATH = "doclatticeserver.pipeline.embedders.test_embedder.TestEmbedder"
...
class TestBatchTaskIntegration(TestCase):
    ...
    def test_batch_task_partitions_multimodal(self):
        ...
        multimodal_path = (
            "doclatticeserver.pipeline.embedders.test_embedder.TestMultimodalEmbedder"
        )
