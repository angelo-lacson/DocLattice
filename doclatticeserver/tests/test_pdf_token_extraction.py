...
class TestExtractImagesFromPdf(TestCase):
    ...
    def test_extract_images_returns_dict_by_page(self, mock_pdfplumber_open):
        ...
        with patch(
            "doclatticeserver.utils.pdf_token_extraction._render_pdf_page"
        ) as mock_render, patch(
            "doclatticeserver.utils.pdf_token_extraction"
...
class TestCropImageFromPdf(TestCase):
    ...
    @patch("doclatticeserver.utils.pdf_token_extraction._crop_pdf_region")
    ...
    @patch("doclatticeserver.utils.pdf_token_extraction._save_image_to_storage")
    @patch("doclatticeserver.utils.pdf_token_extraction._crop_pdf_region")
...
class TestImageHelperFunctions(TestCase):
    ...
    @patch("doclatticeserver.utils.pdf_token_extraction._load_image_from_storage")
...
class TestExtractImagesMemoryBound(TestCase):
    ...
    @patch("doclatticeserver.utils.pdf_token_extraction._render_pdf_page")
    @patch("pdfplumber.open")
    ...
    @patch("doclatticeserver.utils.pdf_token_extraction.gc.collect")
    @patch("doclatticeserver.utils.pdf_token_extraction._render_pdf_page")
    @patch("pdfplumber.open")
    ...
    def test_size_limit_stops_extraction_and_sets_flag(
        ...
        patch_target = (
            "doclatticeserver.utils.pdf_token_extraction.MAX_TOTAL_IMAGES_SIZE_BYTES"
        )
...
class TestCloseQuietly(TestCase):
    ...
    def test_close_quietly_calls_close(self):
        ...
        from doclatticeserver.utils.pdf_token_extraction import _close_quietly
