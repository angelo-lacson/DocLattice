...
class TestExtractImagesFromPdf(TestCase):
    ...
    @patch("doclatticeserver.utils.pdf_token_extraction.Image")
    @patch("pdfplumber.open")
    def test_extract_images_returns_dict_by_page(
        ...
        with patch(
            "doclatticeserver.utils.pdf_token_extraction._crop_pdf_region"
        ) as mock_crop:
...
class TestCropImageFromPdf(TestCase):
    ...
    @patch(
        "doclatticeserver.utils.pdf_token_extraction._save_image_to_storage"
    )
    @patch("doclatticeserver.utils.pdf_token_extraction._crop_pdf_region")
...
class TestImageHelperFunctions(TestCase):
    ...
    @patch(
        "doclatticeserver.utils.pdf_token_extraction._load_image_from_storage"
    )
