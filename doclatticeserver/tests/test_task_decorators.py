...
from doclatticeserver.annotations.models import AnnotationLabel, Annotation
...
class DocAnalyzerTaskTestCase(TestCase):
    def setUp(self):
        ...
        self.task_name_analyzer = Analyzer(
            ...
            task_name="doclatticeserver.tasks.data_extract_tasks.oc_llama_index_doc_query",
            creator=self.user,
            manifest={},
        )
