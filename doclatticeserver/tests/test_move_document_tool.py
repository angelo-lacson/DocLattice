...
from doclatticeserver.llms.tools.core_tools import amove_document, move_document
...
class TestMoveDocument(TestCase):
    ...
    def setUp(self):
        ...
        # move_document delegates to FolderDocumentService.move_document_to_folder,
    ...
    def test_move_no_write_permission_raises(self):
        ...
        FolderDocumentService.move_document_to_folder rejects the move because
