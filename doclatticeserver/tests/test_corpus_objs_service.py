...
class TestBulkSoftDeletePrimitive(_CorpusObjsServiceFolderTestBase):
    ...
    @patch("doclatticeserver.corpuses.services.paths.post_save")
    ...
    @patch(
        "doclatticeserver.corpuses.services.lifecycle.BULK_SOFT_DELETE_CHUNK_SIZE", 3
    )
...
class TestDocumentPathHistory_FullLifecycleIntegration(_DocumentPathHistoryTestBase):
    ...
    def test_move_then_soft_delete_then_restore_history(self):
        ...
        from doclatticeserver.documents.versioning import get_path_history
