...
# Function to test
from doclatticeserver.shared.resolvers import (
...
class ResolverCoverageTests(TestCase):
    ...
    @patch("doclatticeserver.shared.resolvers.User.objects.get")
    ...
    @patch("doclatticeserver.shared.resolvers.isinstance")
    ...
    @patch("doclatticeserver.shared.resolvers.from_global_id")
