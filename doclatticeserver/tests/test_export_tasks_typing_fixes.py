"""
Tests for fixes introduced during typing graduation of doclatticeserver.tasks.*.
...
from doclatticeserver.types.dicts import FunsdAnnotationType
...
class PackageCorpusExportV2ErrorsFieldTestCase(TestCase):
    ...
    def test_runtime_error_when_corpus_packager_returns_none(self):
        ...
        # ``export_tasks_v2``.
        with patch(
            "doclatticeserver.tasks.export_tasks_v2.package_corpus_for_export",
            return_value=None,
