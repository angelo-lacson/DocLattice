...
from doclatticeserver.tests.fixtures import SAMPLE_PDF_FILE_ONE_PATH
...
# the test module — NOT under ``doclatticeserver/pipeline/parsers/`` — and
...
_DUMB_ANCHOR_PDF_PARSER_PATH = (
    "doclatticeserver.tests.test_zip_import_integration._DumbAnchorPdfParser"
)
_DUMB_ANCHOR_TEXT_PARSER_PATH = (
    "doclatticeserver.tests.test_zip_import_integration._DumbAnchorTextParser"
)
...
class TestZipValidationFailures(TestCase):
    ...
    def test_too_many_files_rejected(self):
        ...
        from doclatticeserver.utils import zip_security
...
class TestBackendLockBehavior(TestCase):
    ...
    def test_process_documents_zip_sets_backend_lock_true(self):
        ...
        """
        from doclatticeserver.tasks.import_tasks import process_documents_zip
...
class TestDumbAnchorRemapThroughChain(TransactionTestCase):
    ...
    *without* executing it and only asserts the PENDING row), these tests let
    ...
    def test_dumb_anchor_pdf_remaps_via_chain(self):
        ...
        from doclatticeserver.documents.models import PendingDocumentAnnotations
        from doclatticeserver.tasks.import_tasks import (
            import_zip_with_folder_structure,
        )
        ...
        from doclatticeserver.annotations.compact_json import decode_token_ranges
