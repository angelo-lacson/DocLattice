...
from doclatticeserver.pipeline.registry import reset_registry
...
class TestParser(BaseParser):
    ...
    def _parse_document_impl(self, user_id: int, doc_id: int, **all_kwargs) -> Optional[DocLatticeDocExport]:
        return None
'''
...
'''
    ...
    TEST_PARSER = "doclatticeserver.pipeline.parsers.test_parser.TestParser"
    TEST_EMBEDDER = "doclatticeserver.pipeline.embedders.test_embedder.TestEmbedder"
    TEST_THUMBNAILER = (
        "doclatticeserver.pipeline.thumbnailers.test_thumbnailer.TestThumbnailer"
    )
    TEST_POST_PROCESSOR = "doclatticeserver.pipeline.post_processors.test_post_processor.TestPostProcessor"
    ...
    def test_enabled_field_reflects_enabled_list(self):
        ...
        enabled_path = "doclatticeserver.pipeline.parsers.test_parser.TestParser"
