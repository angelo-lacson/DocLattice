...
'''
    ...
    def setUp(self):
        ...
        settings_instance.preferred_parsers = {
            "application/pdf": "doclatticeserver.pipeline.parsers.test_parser.TestParser"
        }
        ...
        settings_instance.preferred_thumbnailers = {
            "application/pdf": "doclatticeserver.pipeline.thumbnailers.test_thumbnailer.TestThumbnailer"
        }
