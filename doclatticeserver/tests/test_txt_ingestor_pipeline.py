...
from doclatticeserver.pipeline.parsers.text_chunkers import (
    PARAGRAPH_CHUNK_LABEL,
    SLIDING_WINDOW_CHUNK_LABEL,
)
from doclatticeserver.tasks.doc_tasks import ingest_doc
from doclatticeserver.tests.fixtures import SAMPLE_TXT_FILE_ONE_PATH
...
class TxtIngestorTestCase(TestCase):
    ...
    def test_resolve_chunkers_falls_back_on_empty_override(self):
        ...
        from doclatticeserver.pipeline.parsers.oc_text_parser import (
            DEFAULT_CHUNKERS,
        )
        from doclatticeserver.pipeline.parsers.text_chunkers import SentenceChunker
