...
from doclatticeserver.agents.services import (
    AgentActionResultService,
    AgentConfigurationService,
)
from doclatticeserver.analyzer.models import Analysis, Analyzer
from doclatticeserver.analyzer.services import AnalysisLifecycleService
...
from doclatticeserver.notifications.services import NotificationService
...
from doclatticeserver.worker_uploads.services import (
...
class TestAnalysisLifecycleServiceBehavioral(TestCase):
    ...
    @patch("doclatticeserver.tasks.permissioning_tasks.make_analysis_public_task.si")
    ...
    @patch("doclatticeserver.tasks.corpus_tasks.process_analyzer")
    ...
    @patch(
        "doclatticeserver.tasks.delete_analysis_and_annotations_task.si",
    )
    ...
    def test_delete_analysis_threads_request_into_initial_lookup(self, mock_si):
        ...
        from doclatticeserver.shared.services import base as base_module
