...
``doclatticeserver.llms.tools.core_tools.extracts_and_analyzers``:
...
from doclatticeserver.llms.tools.core_tools.extracts_and_analyzers import (
    _clamp_limit,
    alist_analyzers,
    alist_fieldsets,
...
class TestStartAnalysis(BaseFixtureTestCase):
    ...
    def _patch_process_analyzer(self):
        ...
        (``doclatticeserver.llms.tools.core_tools.extracts_and_analyzers.process_analyzer``)
