...
from doclatticeserver.annotations.models import Annotation, AnnotationLabel, Embedding
...
TEST_EMBEDDER_PATH = "doclatticeserver.pipeline.embedders.sent_transformer_microservice.MicroserviceEmbedder"
