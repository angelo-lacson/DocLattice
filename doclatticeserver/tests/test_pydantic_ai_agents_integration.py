...
# - doclatticeserver/tests/test_pydantic_ai_integration_testmodel.py
# - doclatticeserver/tests/TESTING_PATTERNS.md
...
class TestPydanticAIAgentsIntegration(TransactionTestCase):
    ...
    #
    # See: doclatticeserver/tests/test_pydantic_ai_integration_testmodel.py
    ...
    #
    # For testing patterns, see: doclatticeserver/tests/TESTING_PATTERNS.md
