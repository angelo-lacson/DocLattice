...
The dataset bundled at ``doclatticeserver/utils/geocoding/data/`` is the
...
from doclatticeserver.utils.geocoding import ResolvedPlace, resolve_place
from doclatticeserver.utils.geocoding.service import LabelTypeLiteral
