...
class StorageBackendConfigTest(TestCase):
    ...
    def test_aws_storage_configuration(self):
        ...
        self.assertEqual(
            ...
            "doclatticeserver.utils.storages.MediaRootS3Boto3Storage",
        )
        self.assertEqual(
            settings.STATICFILES_STORAGE,
            "doclatticeserver.utils.storages.StaticRootS3Boto3Storage",
        )

    def test_aws_storage_classes_importable(self):
        """Always ensure AWS storage classes are importable."""
        from doclatticeserver.utils.storages import (
    ...
    @override_settings(
        ...
        DEFAULT_FILE_STORAGE="doclatticeserver.utils.storages.MediaRootGoogleCloudStorage",
        STATICFILES_STORAGE="doclatticeserver.utils.storages.StaticRootGoogleCloudStorage",
    )
...
class StorageBackendFunctionalityTest(TestCase):
    ...
    def test_aws_storage_operations(self, mock_boto_client):
        ...
        from doclatticeserver.utils.storages import MediaRootS3Boto3Storage
    ...
    def test_gcp_storage_operations(self, mock_gcs_client):
        ...
        from doclatticeserver.utils.storages import MediaRootGoogleCloudStorage
...
class StorageUtilsTest(TestCase):
    ...
    def test_analyzer_utils_local_storage(self):
        ...
        from doclatticeserver.utils.analyzer import get_django_file_field_url
