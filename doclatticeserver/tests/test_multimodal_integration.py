...
Run these tests:
    docker compose -f test.yml run django pytest doclatticeserver/tests/test_multimodal_integration.py -v
...
from doclatticeserver.tests.fixtures.pdf_generator import (
