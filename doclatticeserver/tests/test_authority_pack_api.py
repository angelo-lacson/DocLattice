...
from doclatticeserver.enrichment.services.authority_permissions import DENIED
...
class AuthorityPackAPITests(TestCase):
    ...
    def _configured_catalog(self):
        return mock.patch(
            "doclatticeserver.enrichment.services.authority_pack_service."
            "authority_pack_dirs",
    ...
    def test_post_commit_relink_failure_is_a_warning_not_an_install_failure(self):
        ...
        with self._configured_catalog():
            preflight = AuthorityPackService.preflight(self.admin, "portable_test_pack")
            with mock.patch(
                "doclatticeserver.enrichment.services.EnrichmentService."
