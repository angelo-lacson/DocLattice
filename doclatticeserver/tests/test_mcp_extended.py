...
from doclatticeserver.mcp.config import (
    CACHE_TTL,
    DEFAULT_PAGE_SIZE,
...
from doclatticeserver.mcp.formatters import (
    format_annotation,
...
from doclatticeserver.mcp.permissions import (
    get_anonymous_user,
    sanitize_and_validate_slugs,
)
from doclatticeserver.mcp.permissions import validate_slug as perm_validate_slug
from doclatticeserver.mcp.server import TTLLRUCache, URIParser
...
class TestTelemetryRecording(TestCase):
    ...
    @patch("doclatticeserver.mcp.telemetry.record_event")
...
class TestAsyncTelemetryRecording(TestCase):
    ...
    @patch("doclatticeserver.mcp.telemetry.arecord_event")
