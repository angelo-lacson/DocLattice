...
class Phase3ServiceRelocationTests(SimpleTestCase):
    ...
    ``services`` package — ``from doclatticeserver.<app>.services import
    ...
    def test_former_query_optimizer_modules_are_gone(self):
        ...
        """
        for dotted in (
            "doclatticeserver.annotations.query_optimizer",
            "doclatticeserver.extracts.query_optimizer",
        ):
    ...
    def test_relationship_service_public_surface(self):
        from doclatticeserver.annotations.services import RelationshipService
    ...
    def test_extract_service_public_surface(self):
        from doclatticeserver.extracts.services import ExtractService
    ...
    def test_metadata_service_public_surface(self):
        from doclatticeserver.extracts.services import MetadataService
    ...
    def test_package_init_and_submodule_resolve_to_same_class(self):
        ...
        from doclatticeserver.extracts.services import MetadataService as PkgMetadata
        from doclatticeserver.extracts.services.metadata import (
