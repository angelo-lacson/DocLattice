...
from doclatticeserver.worker_uploads.auth import WORKER_AUTH_PREFIX
...
from doclatticeserver.worker_uploads.serializers import (
...
class TestWorkerTokenAuthentication(TestCase):
    ...
    def test_authenticate_header_includes_realm(self):
        ...
        from doclatticeserver.worker_uploads.auth import WorkerTokenAuthentication
...
class TestBatchProcessor(TestCase):
    ...
    def test_processes_pending_upload(self):
        ...
        from doclatticeserver.worker_uploads.tasks import process_pending_uploads
    ...
    def test_null_corpus_creator_raises(self):
        ...
        with patch(
            "doclatticeserver.worker_uploads.tasks.WorkerDocumentUpload"
    ...
    def test_embeddings_with_empty_embedder_path_skipped(self):
        ...
        from doclatticeserver.worker_uploads.tasks import _store_embeddings
    ...
    def test_staging_file_cleanup_failure_does_not_break(self):
        ...
        with patch(
            "doclatticeserver.worker_uploads.tasks.WorkerDocumentUpload.file"
    ...
    def test_fail_upload_nonexistent_id(self):
        ...
        from doclatticeserver.worker_uploads.tasks import _fail_upload
...
class TestStalledUploadRecovery(TestCase):
    ...
    def test_recover_stalled_uploads_resets_old_processing(self):
        ...
        from doclatticeserver.worker_uploads.tasks import recover_stalled_uploads
...
def _structural_metadata(with_embeddings: bool = False, **overrides):
    ...
    if with_embeddings:
        meta["embeddings"] = {
            "embedder_path": "doclatticeserver.pipeline.embedders."
...
class TestWorkerUploadFidelity(TestCase):
    ...
    def _process(self, upload):
        ...
        with patch(
            "doclatticeserver.tasks.doc_tasks.extract_thumbnail.apply_async"
        ) as mock_thumb:
            process_pending_uploads.apply().get()
        upload.refresh_from_db()
