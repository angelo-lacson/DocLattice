...
class NoEmbeddingsMixin:
    ...
    def setUp(self):
        ...
        self.embedding_patches = [
            patch('doclatticeserver.tasks.embeddings_task.calculate_embedding_for_annotation_text.delay'),
            patch('doclatticeserver.tasks.embeddings_task.calculate_embedding_for_annotation_text.si'),
            patch('doclatticeserver.tasks.embeddings_task.calculate_embedding_for_note_text.delay'),
            patch('doclatticeserver.tasks.embeddings_task.calculate_embedding_for_note_text.si'),
            patch('doclatticeserver.annotations.signals.process_structural_annotation_for_corpuses'),
        ]
