...
class TestDjangoAnnotationVectorStore(TestCase):
    ...
    @override_settings(
        DEFAULT_EMBEDDING_PATH="doclatticeserver.pipeline.embedders.sent_transformer_microservice.MicroserviceEmbedder"  # noqa: E501
    )
    ...
    @patch("doclatticeserver.utils.embeddings.generate_embeddings_from_text")
