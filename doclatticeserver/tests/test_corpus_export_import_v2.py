...
from doclatticeserver.tests._corpus_fixture import build_rich_test_corpus
from doclatticeserver.tests._corpus_snapshot import snapshot_corpus
...
class TestV2ImportUtilities(TestCase):
    ...
    def test_import_relationships(self):
        ...
        _import_v2_relationships(
            cast(list[DocLatticeRelationshipPythonType], relationships_data),
            self.corpus,
            annot_id_map,
            label_lookup,
            self.user,
...
class TestV2ImportExceptionHandling(TestCase):
    ...
    @mock.patch(
        "doclatticeserver.utils.import_v2.StructuralAnnotationSet.objects.create"
    )
    def test_import_structural_set_exception(self, mock_create):
        ...
        from doclatticeserver.utils.import_v2 import import_structural_annotation_set
    ...
    @mock.patch("doclatticeserver.utils.import_v2.CorpusFolder.objects.create")
    def test_import_corpus_folders_exception(self, mock_create):
        """Test import_corpus_folders exception handler (lines 239-240)."""
        from doclatticeserver.utils.import_v2 import import_corpus_folders
    ...
    @mock.patch("doclatticeserver.tasks.import_tasks_v2.Relationship.objects.create")
    ...
    @mock.patch("doclatticeserver.corpuses.models.Corpus.save")
    def test_import_agent_config_exception(self, mock_save):
        """Test import_agent_config exception handler (lines 422-423)."""
        from doclatticeserver.utils.import_v2 import import_agent_config
    ...
    @mock.patch(
        "doclatticeserver.tasks.import_tasks_v2._setup_corpus_and_labels",
        side_effect=Exception("Setup failed"),
    )
    def test_import_corpus_exception_handler(self, mock_setup):
        """Test _import_corpus catches exceptions and returns None."""
        from doclatticeserver.tasks.import_tasks_v2 import _import_corpus

        result = _import_corpus(
            data_json=cast(DocLatticeExportDataJsonV2Type, {"annotated_docs": {}}),
    ...
    @mock.patch(
        "doclatticeserver.tasks.import_tasks_v2.create_document_from_export_data",
    ...
    @mock.patch(
        "doclatticeserver.tasks.export_tasks.Notification.objects.create",
    ...
    def test_create_export_notification_exception(self, mock_create):
        ...
        from doclatticeserver.tasks.export_tasks import _create_export_notification
...
class TestV2EdgeCases(TestCase):
    ...
    def test_build_zip_disk_rollover_produces_valid_archive(self):
        ...
        """
        from doclatticeserver.tasks.export_tasks_v2 import build_corpus_v2_zip
        from doclatticeserver.tasks.import_tasks_v2 import (
    ...
    @mock.patch(
        "doclatticeserver.tasks.import_tasks_v2._import_corpus",
...
class TestReconstructDocumentPaths(TestCase):
    ...
    def test_updates_path_version_and_folder(self):
        ...
        from doclatticeserver.tasks.import_tasks_v2 import _reconstruct_document_paths
