...
``doclatticeserver/enrichment/grammars.py`` (regex shapes ported from
...
from doclatticeserver.enrichment.grammars import (
    _CONF_HTS_ANCHORED,
...
from doclatticeserver.enrichment.resolver import ReferenceResolver
