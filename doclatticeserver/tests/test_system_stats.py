...
from doclatticeserver.users.models import SystemStats, User
...
class TestSystemStats(TestCase):
    ...
    def test_telemetry_shares_compute_values(self):
        ...
        from doclatticeserver.tasks import telemetry_tasks
    ...
    def test_refresh_system_stats_task(self):
        from doclatticeserver.tasks.stats_tasks import refresh_system_stats
