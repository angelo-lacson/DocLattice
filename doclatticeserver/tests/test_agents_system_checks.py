...
Pins the behaviour of :func:`doclatticeserver.agents.checks.check_privacy_filter_api_key`
...
from doclatticeserver.agents.checks import check_privacy_filter_api_key
