...
class TestDocLatticeEnum(TestCase):
    """Tests for DocLatticeEnum base class."""
...
class TestExportType(TestCase):
    ...
    def test_values(self):
        ...
        self.assertEqual(ExportType.DOCLATTICE.value, "DOCLATTICE")
        self.assertEqual(ExportType.DOCLATTICE_V2.value, "DOCLATTICE_V2")
...
class TestTypedDictStructures(TestCase):
    ...
    def test_annotation_label_type(self):
        from doclatticeserver.types.dicts import AnnotationLabelPythonType
    ...
    def test_token_id_type(self):
        from doclatticeserver.types.dicts import TokenIdPythonType
    ...
    def test_text_span_data(self):
        from doclatticeserver.types.dicts import TextSpanData
    ...
    def test_pawls_page_boundary_type(self):
        from doclatticeserver.types.dicts import PawlsPageBoundaryPythonType
    ...
    def test_doclattice_corpus_type(self):
        from doclatticeserver.types.dicts import DocLatticeCorpusType
