...
class EnrichmentWriterTests(TestCase):
    ...
    def test_link_pass_repairs_stale_exhibit_link_urls(self):
        ...
        from doclatticeserver.annotations.models import CorpusReference as CR
...
class PdfTokenMentionTests(TestCase):
    ...
    def setUp(self):
        ...
        from doclatticeserver.tests.test_extraction_grounding import (
    ...
    def test_pdf_mentions_are_token_annotations_with_real_pages(self):
        ...
        from doclatticeserver.annotations.models import TOKEN_LABEL as _TL
