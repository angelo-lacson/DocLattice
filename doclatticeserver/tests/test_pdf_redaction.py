...
from doclatticeserver.tests.fixtures import SAMPLE_PAWLS_FILE_ONE_PATH, SAMPLE_PDF_FILE_ONE_PATH
from doclatticeserver.types.dicts import DocLatticeExportDataJsonPythonType, DocLatticeSinglePageAnnotationType, PawlsPagePythonType
...
def _generate_test_annotations_from_strings(
...
) -> List[DocLatticeSinglePageAnnotationType]:
    """
    ...
    test_annotations: List[DocLatticeSinglePageAnnotationType] = [
        {
            "bounds": match["bounds"],
...
class TestPDFRedaction(TestCase):
    ...
    def test_pdf_redactor_with_sample_files(self):
        ...
        try:
            # Run the PDFRedactor
            processor_paths = ["doclatticeserver.pipeline.post_processors.pdf_redactor.PDFRedactor"]
...
#         from doclatticeserver.tests.test_pdf_redaction import TestPDFRedaction
