...
class TestDocLatticePipelineEmbedding(TestCase):
    """
    TestCase for DocLatticePipelineEmbedding functionality.
    """
    ...
    def setUp(self) -> None:
        ...
        self.embedding_model = DocLatticePipelineEmbedding(
    ...
    @patch(
        "doclatticeserver.llms.embedders.custom_pipeline_embedding.generate_embeddings_from_text"
    )
    ...
    @patch(
        "doclatticeserver.llms.embedders.custom_pipeline_embedding.agenerate_embeddings_from_text"
    )
