...
from doclatticeserver.pipeline.authority_source_providers.agentic_web_locator_provider import (
...
class ToolFetchAllowlistedTests(TestCase):
    ...
    def test_ssrf_error_returns_blocked_string(self):
        from doclatticeserver.utils.safe_http import SSRFValidationError
        ...
        async def _direct():
            ...
            with patch(
                "doclatticeserver.utils.safe_http.safe_fetch_text",
...
class ToolWebSearchTests(TestCase):
    ...
    def test_delegates_to_aweb_search_and_forwards_query(self):
        ...
        async def _run():
            ...
            with patch(
                "doclatticeserver.llms.tools.web_search_tools.aweb_search",
...
class RunAgentSanitizationTests(TestCase):
    ...
    def test_run_agent_sanitizes_citation_in_place(self):
        ...
        async def _inner():
            ...
            with patch(
                "doclatticeserver.pipeline.utils.get_default_llm_spec",
                return_value="",
            ), patch(
                ...
                "doclatticeserver.llms.agents.pydantic_ai_factory.make_pydantic_ai_agent",
