"""Tests for the benchmark harness (``doclatticeserver.benchmarks``).
...
from doclatticeserver.benchmarks.adapters.base import BenchmarkTask
from doclatticeserver.benchmarks.adapters.legalbench_rag import (
    LEGALBENCH_RAG_SUBSETS,
    LegalBenchRAGAdapter,
)
from doclatticeserver.benchmarks.loader import load_benchmark_into_corpus
from doclatticeserver.benchmarks.metrics import (
    char_f1,
    char_iou,
    char_precision,
...
from doclatticeserver.benchmarks.report import (
    BenchmarkReport,
    TaskResult,
    extract_usage_from_llm_log,
)
from doclatticeserver.benchmarks.runner import run_benchmark
from doclatticeserver.documents.models import Document
from doclatticeserver.extracts.models import Datacell
from doclatticeserver.llms.api import AgentAPI
...
class PerSubsetAggregateTestCase(PyUnitTestCase):
    ...
    def test_macro_avg_equal_weights_even_when_subset_counts_differ(self):
        ...
        from doclatticeserver.benchmarks.report import BenchmarkReport
...
class ForceCeleryEagerSafetyGuardsTestCase(PyUnitTestCase):
    ...
    def test_refuses_outside_test_mode_without_cli_env(self):
        ...
        from doclatticeserver.benchmarks.loader import force_celery_eager
...
class TestUpstreamEquivalence(PyUnitTestCase):
    ...
    def test_recall_matches_upstream_on_random_inputs(self):
        ...
        from doclatticeserver.benchmarks.metrics import char_recall_paper
    ...
    def test_precision_matches_upstream_on_random_inputs(self):
        ...
        from doclatticeserver.benchmarks.metrics import char_precision_paper
