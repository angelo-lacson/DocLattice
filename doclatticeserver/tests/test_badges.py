"""
Tests for badge system in DocLattice.
...
from doclatticeserver.tasks.badge_tasks import BadgeCriteriaType, check_auto_badges
...
class TestBadgeAutoAwardTasks(TestCase):
    ...
    def test_check_badges_for_all_users(self):
        ...
        from doclatticeserver.tasks.badge_tasks import check_badges_for_all_users
    ...
    def test_revoke_badges_by_criteria(self):
        ...
        from doclatticeserver.tasks.badge_tasks import revoke_badges_by_criteria
    ...
    def test_message_upvotes_criteria_global(self):
        ...
        from doclatticeserver.conversations.models import MessageVote, VoteType
