...
from doclatticeserver.tasks.import_tasks_v2 import _import_ingestion_sources
...
class TestUploadDocumentWithIngestionSource(TestCase):
    ...
    def test_upload_with_valid_source(self):
        ...
        with patch(
            ...
            "doclatticeserver.document_imports.services.set_permissions_for_obj_to_user"
        ):
