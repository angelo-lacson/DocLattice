...
from doclatticeserver.conversations.models import ChatMessage, Conversation  # noqa
from doclatticeserver.llms.agents import for_document
from doclatticeserver.llms.agents.timeline_schema import TIMELINE_ENTRY_SCHEMA
...
class ConversationSourceLoggingTestCase(DocumentConversationWebsocketTestCase):
    ...
    async def _test_sources_for_framework(
        ...
        async def run_test():
            ...
            with patch(
                "doclatticeserver.pipeline.embedders.sent_transformer_microservice.MicroserviceEmbedder._embed_text_impl",
