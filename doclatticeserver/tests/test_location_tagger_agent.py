...
from doclatticeserver.annotations.models import SPAN_LABEL, Annotation
...
from doclatticeserver.llms.tools.core_tools import add_annotations_from_exact_strings

User = get_user_model()

# The migration module name starts with a digit, so import it via importlib.
_MIGRATION = importlib.import_module(
    "doclatticeserver.agents.migrations.0015_create_location_tagger_agent"
)
...
class LocationTaggerGeocodingTests(_GeoToolFixture):
    ...
    def test_geocoding_resolved_once_and_reused_for_each_occurrence(self):
        ...
        *occurrence* (the resolve-before-transaction optimisation; review #2)."""
        ...
        import doclatticeserver.annotations.services.geographic_service as geo_svc
