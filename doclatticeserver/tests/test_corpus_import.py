...
from doclatticeserver.types.dicts import DocLatticeRelationshipPythonType
from doclatticeserver.types.enums import PermissionTypes
from doclatticeserver.utils.importing import import_relationships
...
class TestCorpusImport(TestCase):
    ...
    def test_relationship_import(self):
        ...
        with self.subTest("multiple_sources_and_targets"):
            ...
            relationships_data_multi: list[DocLatticeRelationshipPythonType] = [
                {
                    "id": "rel_multi",
        ...
        with self.subTest("structural_flag"):
            ...
            relationships_data_struct: list[DocLatticeRelationshipPythonType] = [
                {
                    "id": "rel_struct",
