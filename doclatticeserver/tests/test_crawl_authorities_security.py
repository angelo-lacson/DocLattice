...
from doclatticeserver.llms.tools.core_tools.corpus_references import crawl_authorities
from doclatticeserver.tests.test_crawl_authorities import _make_user
...
class CrawlAuthoritiesSecurityTests(TransactionTestCase):
    ...
    def test_corpus_crawl_does_not_claim_unseeded_global_frontier(self):
        ...
        original_seed = (
            "doclatticeserver.enrichment.services.crawl_authorities_service"
    ...
    def test_tool_wrapper_extreme_bounds_are_sanitized_by_the_service(self):
        ...
        _module = "doclatticeserver.enrichment.services.crawl_authorities_service"
        with patch(
