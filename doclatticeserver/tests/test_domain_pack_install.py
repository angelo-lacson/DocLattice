...
from doclatticeserver.corpuses.management.commands.install_domain_pack import (
...
class DomainPackInstallTests(TestCase):
    ...
    def test_group_over_platform_cap_is_an_error_not_a_truncation(self):
        ...
        """
        from doclatticeserver.constants.tools import MULTI_CORPUS_SEARCH_MAX_CORPORA
    ...
    def test_materialise_pack_refuses_a_traversing_name_itself(self):
        ...
        """
        from doclatticeserver.corpuses.management.commands.install_authority_pack import (  # noqa: E501
            materialise_pack,
        )
    ...
    def test_stage_fetches_from_the_registry_url_when_no_tarball_is_given(self):
        ...
        with mock.patch(
            "doclatticeserver.corpuses.management.commands.install_domain_pack."
            "_download_tarball",
    ...
    def test_writer_rejection_after_preflight_passed_is_reported_not_swallowed(self):
        ...
        tarball = self._standard_registry()
        with mock.patch(
            "doclatticeserver.enrichment.services.authority_equivalence_ingest."
            "upsert_equivalence",
