...
class TestUnifiedToolFactory(SimpleTestCase):
    ...
    @patch(
        "doclatticeserver.llms.tools.llama_index_tools.LlamaIndexToolFactory.create_tool"
    )
    ...
    @patch(
        "doclatticeserver.llms.tools.pydantic_ai_tools.PydanticAIToolFactory.create_tool"
    )
    ...
    @patch(
        "doclatticeserver.llms.tools.llama_index_tools.LlamaIndexToolFactory.create_tools"
    )
    ...
    @patch(
        "doclatticeserver.llms.tools.llama_index_tools.LlamaIndexToolFactory.from_function"
    )
