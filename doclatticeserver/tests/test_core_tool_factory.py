...
class TestUnifiedToolFactory(SimpleTestCase):
    ...
    @patch(
        "doclatticeserver.llms.tools.pydantic_ai_tools.PydanticAIToolFactory.create_tools"
    )
    ...
    @patch(
        "doclatticeserver.llms.tools.pydantic_ai_tools.PydanticAIToolFactory.from_function"
    )
