...
* :func:`doclatticeserver.llms.model_factory.build_agent_model` resolves a
...
from doclatticeserver.pipeline.llm_providers.anthropic_provider import (
    AnthropicProvider,
)
from doclatticeserver.pipeline.llm_providers.google_provider import GoogleProvider
from doclatticeserver.pipeline.llm_providers.ollama_provider import OllamaProvider
from doclatticeserver.pipeline.llm_providers.openai_provider import OpenAIProvider
...
class TestBuildAgentModelDbWins(TestCase):
    ...
    def test_db_creds_route_through_construct_model(self):
        ...
        sentinel = object()
        with mock.patch(
            "doclatticeserver.llms.model_factory._construct_model",
