...
class TestPydanticAIAgents(TestCase):
    ...
    @patch('doclatticeserver.llms.agents.pydantic_ai_agents.PydanticAIAgent')
    ...
    def test_pydantic_ai_tool_wrapper_creation(self) -> None:
        ...
        from doclatticeserver.llms.tools.core_tools import get_md_summary_token_length # Assuming this function exists
