...
class TestPydanticAIAgents(TestCase):
    ...
    @patch('doclatticeserver.llms.agents.pydantic_ai_agents.Agent')
    def test_pydantic_ai_document_agent_creation(self, mock_agent_class: MagicMock) -> None:
        ...
        from doclatticeserver.llms.agents.core_agents import DocumentAgentContext, CoreConversationManager, AgentConfig
    ...
    def test_pydantic_ai_tool_function_signature(self) -> None:
        ...
        from doclatticeserver.llms.tools.core_tools import load_document_md_summary
    ...
    @patch('doclatticeserver.llms.tools.core_tools.Document.objects.get')
    ...
    async def test_pydantic_ai_vector_search_tool_creation(self) -> None:
        ...
        from doclatticeserver.llms.vector_stores.pydantic_ai_vector_stores import create_vector_search_tool
    ...
    @patch('doclatticeserver.llms.vector_stores.core_vector_stores.generate_embeddings_from_text')
    ...
    def test_pydantic_ai_tool_metadata_extraction(self) -> None:
        ...
        from doclatticeserver.llms.tools.core_tools import get_md_summary_token_length
