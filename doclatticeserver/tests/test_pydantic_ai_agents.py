...
class TestPydanticAIAgents(TransactionTestCase):
    ...
    def test_pydantic_ai_tool_wrapper_creation(self) -> None:
        ...
        from doclatticeserver.llms.tools.core_tools import (  # Assuming this function exists
    ...
    @patch(
        "doclatticeserver.llms.vector_stores.core_vector_stores.generate_embeddings_from_text"
    )
...
class TestPydanticAIAgentsCoverage(TransactionTestCase):
    ...
    def test_to_source_node_with_source_node_input(self) -> None:
        ...
        from doclatticeserver.llms.agents.pydantic_ai_agents import _to_source_node
