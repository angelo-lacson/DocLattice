...
class TestPydanticAIAgents(TransactionTestCase):
    ...
    @patch("doclatticeserver.llms.agents.pydantic_ai_factory.PydanticAIAgent")
    ...
    @patch(
        "doclatticeserver.llms.vector_stores.base_vector_store.generate_embeddings_from_text"
    )
    ...
    async def test_chat_metadata_includes_tool_call_timeline(self) -> None:
        ...
        ``doclatticeserver.benchmarks.traversal_benchmark.run_one``, which
