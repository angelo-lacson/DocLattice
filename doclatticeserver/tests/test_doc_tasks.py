...
class DocumentPipelineRoutingTestCase(SimpleTestCase):
    ...
    def test_conversion_stays_on_default_queue(self):
        ...
        self.assertNotIn(
            "doclatticeserver.tasks.doc_tasks.convert_document_to_pdf",
...
class MarkDocumentFailedTestCase(TestCase):
    ...
    def test_mark_document_failed_truncates_long_error(self):
        ...
        from doclatticeserver.constants import MAX_PROCESSING_ERROR_LENGTH
    ...
    @patch("doclatticeserver.tasks.doc_tasks.Notification.objects.create")
    ...
    def test_create_failed_notification_no_creator(self):
        ...
        with patch(
            "doclatticeserver.tasks.doc_tasks.Notification.objects.create"
        ) as mock_create:
...
class SetDocLockStateTestCase(TestCase):
    ...
    @patch("doclatticeserver.tasks.corpus_tasks.ensure_embeddings_for_corpus.delay")
    @patch(
...
class ExtractThumbnailTestCase(TestCase):
    ...
    @patch("doclatticeserver.tasks.doc_tasks.get_components_by_mimetype")
...
class RetryDocumentProcessingTestCase(TestCase):
    ...
    @patch("doclatticeserver.tasks.doc_tasks.chain")
    def test_retry_failed_document_success(self, mock_chain):
        ...
        self.assertEqual(
            ...
            [
                "doclatticeserver.tasks.doc_tasks.convert_document_to_pdf",
                "doclatticeserver.tasks.doc_tasks.extract_thumbnail",
                "doclatticeserver.tasks.doc_tasks.ingest_doc",
                "doclatticeserver.tasks.doc_tasks.remap_pending_annotations",
                "doclatticeserver.tasks.doc_tasks.set_doc_lock_state",
            ],
        )
