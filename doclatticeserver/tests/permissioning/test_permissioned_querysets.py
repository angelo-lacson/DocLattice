...
from doclatticeserver.annotations.models import Annotation, AnnotationLabel, Note
...
class UserCanPrefetchFastPathTest(TestCase):
    ...
    def test_partial_prefetch_falls_back_for_group_perms_only(self):
        ...
        """
        from doclatticeserver.shared.prefetch_attrs import user_group_perm_attr
        from doclatticeserver.utils.permissioning import (
            get_users_permissions_for_obj,
        )
