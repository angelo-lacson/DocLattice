...
class RelationshipAuthorizationInvariantsTestCase(_UserCanInvariantsMixin, TestCase):
    ...
    def setUp(self):
        ...
        self.analyzer = Analyzer.objects.create(
            ...
            description="x",
            creator=self.creator,
            task_name="doclatticeserver.tasks.noop",
        )
...
class CorpusGroupAuthorizationInvariantsTestCase(_UserCanInvariantsMixin, TestCase):
    ...
    in ``doclatticeserver/tests/test_corpus_groups.py``; this class pins
    only the group row's own visibility invariants.
    """

    def setUp(self):
        from doclatticeserver.corpuses.models import CorpusGroup
