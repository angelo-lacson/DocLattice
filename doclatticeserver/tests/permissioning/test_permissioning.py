...
class PermissioningTestCase(TestCase):
    ...
    def __test_make_analysis_public_mutation(self):
        ...
        self.assertEqual(
            ...
            "Starting an DocLattice worker to make your analysis public! Underlying corpus must be made public too!",
        )
...
class SetPermissionsIsNewTests(TestCase):
    ...
    def test_is_new_skips_remove_perm_calls(self):
        ...
        with patch("doclatticeserver.utils.permissioning.remove_perm") as mock_remove:
            set_permissions_for_obj_to_user(
