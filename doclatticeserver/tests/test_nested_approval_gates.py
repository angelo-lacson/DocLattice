...
#     from doclatticeserver.llms import agents as _agents_api
# This resolves to the AgentAPI singleton at doclatticeserver.llms.api.agents.
...
_AGENTS_API_FOR_DOC_PATCH = "doclatticeserver.llms.api.AgentAPI.for_document"
