...
from doclatticeserver import enrichment
from doclatticeserver.annotations.models import AuthorityNamespace
from doclatticeserver.corpuses.management.commands.load_authority_pack import (
...
class LoadAuthorityPackEdgeCaseTests(TestCase):
    ...
    def test_model_override_applied(self):
                ...
                "corpora": [
                    {
                        "title": "Area A",
                        "spec": "a.json",
                        "preferred_embedder": "doclatticeserver.pipeline.x.Custom",
                    }
                ],
            },
            specs={"a.json": self._one_section_spec()},
        ...
        corpus = Corpus.objects.get(title="Area A")
        self.assertEqual(
            corpus.preferred_embedder, "doclatticeserver.pipeline.x.Custom"
        )
