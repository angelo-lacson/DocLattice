...
from doclatticeserver.corpuses.services import CorpusIntelligenceSetupService
from doclatticeserver.corpuses.services.data_story import PROFILE_ACTION_NAME
...
_START_ANALYSIS = (
    "doclatticeserver.analyzer.services.analysis_lifecycle_service."
...
class IntelligenceSetupServiceTestCase(TestCase):
    ...
    def test_setup_queues_partial_batch_over_cap(self, mock_start):
        ...
        with patch(
            "doclatticeserver.corpuses.services.corpus_actions.BATCH_RUN_MAX_DOCS",
            2,
        ):
            result = CorpusIntelligenceSetupService.setup(self.user, self.corpus.pk)
        self.assertTrue(result.ok, result.error)
    ...
    def test_structured_profile_skips_backfill_when_cells_exist(self):
        ...
        from doclatticeserver.extracts.models import Column, Datacell, Extract
        ...
        with patch(
            "doclatticeserver.corpuses.services.corpus_documents."
