...
class TestAnnotationSignals(unittest.TestCase):
    ...
    @patch(
        "doclatticeserver.annotations.signals.calculate_embedding_for_annotation_text.delay"
    )
    @patch("doclatticeserver.annotations.signals.transaction")
    @patch("doclatticeserver.annotations.signals.apps.get_model")
    def test_process_structural_annotation_for_corpuses(
        ...
        with patch("doclatticeserver.annotations.signals.settings") as mock_settings:
    ...
    @patch("doclatticeserver.annotations.signals.refresh_annotation_summary_mv")
    @patch(
        "doclatticeserver.annotations.signals.process_structural_annotation_for_corpuses"
    )
    @patch(
    ...
    @patch("doclatticeserver.annotations.signals.refresh_annotation_navigation_mv")
    @patch("doclatticeserver.annotations.signals.refresh_annotation_summary_mv")
    @patch(
        "doclatticeserver.annotations.signals.process_structural_annotation_for_corpuses"
    )
...
class TestEmbeddingTask(unittest.TestCase):
    ...
    @patch("doclatticeserver.tasks.embeddings_task.generate_embeddings_from_text")
    ...
    @patch("doclatticeserver.tasks.embeddings_task.Annotation")
    @patch("doclatticeserver.tasks.embeddings_task.generate_embeddings_from_text")
    @patch("doclatticeserver.tasks.embeddings_task.settings")
