...
from doclatticeserver.tasks.embeddings_task import get_embedder_for_corpus, store_embeddings
...
class TestEmbeddingsTask(unittest.TestCase):
    ...
    @patch('doclatticeserver.tasks.embeddings_task.find_embedder_for_filetype_and_dimension')
    ...
    @patch('doclatticeserver.tasks.embeddings_task.Embedding')
