...
from doclatticeserver.utils.prompt_sanitization import UNTRUSTED_CONTENT_NOTICE
...
class ExtractPromptWiringTestCase(TransactionTestCase):
    ...
    def _capture_prompt(self, column, document=None) -> str:
        ...
        # The task does ``from doclatticeserver.llms import agents`` then calls
        ...
        import doclatticeserver.llms.agents as agents_mod
    ...
    def test_oversized_document_skips_full_text_read(self):
        ...
        import doclatticeserver.tasks.data_extract_tasks as det
