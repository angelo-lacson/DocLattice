...
MOCK_LLAMA_INDEX_DOC_AGENT_PATH = (
    "doclatticeserver.llms.agents.llama_index_agents.LlamaIndexDocumentAgent"
)
MOCK_PYDANTIC_AI_DOC_AGENT_PATH = (
    "doclatticeserver.llms.agents.pydantic_ai_agents.PydanticAIDocumentAgent"
)
MOCK_LLAMA_INDEX_CORPUS_AGENT_PATH = (
    "doclatticeserver.llms.agents.llama_index_agents.LlamaIndexCorpusAgent"
)
MOCK_PYDANTIC_AI_CORPUS_AGENT_PATH = (
    "doclatticeserver.llms.agents.pydantic_ai_agents.PydanticAICorpusAgent"
)
