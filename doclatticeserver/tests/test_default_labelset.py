...
Covers:
- ``doclatticeserver.annotations.label_set_seeds.create_default_labelset``
  (idempotent seeding, backfill of pre-existing labelsets, no-superuser path).
- ``doclatticeserver.annotations.label_set_seeds.reverse_migration``.
...
from doclatticeserver.annotations.label_set_seeds import (
    DEFAULT_LABELS,
