...
from doclatticeserver.utils.annotation_anchoring import anchor_annotations
...
class TestSourceReingestability(TestCase):
    ...
    def test_read_guarded_source_bytes_rejects_metadata_lie_on_read(self):
        ...
        with zipfile.ZipFile(buf) as real_zf:
            ...
            with self.assertLogs(
                "doclatticeserver.utils.zip_security", level="WARNING"
            ) as captured:
    ...
    def test_oversized_member_read_guard_not_called_twice_on_reingest_reject(self):
        ...
        with zipfile.ZipFile(buf) as zf:
            with mock.patch(
                "doclatticeserver.tasks.import_tasks_v2._read_guarded_source_bytes",
...
from doclatticeserver.tests.fixtures import SAMPLE_PDF_FILE_ONE_PATH  # noqa: E402
...
from doclatticeserver.tests.test_zip_import_integration import (  # noqa: E402
    _DUMB_ANCHOR_PDF_PARSER_PATH,
    DUMB_ANCHOR_HEADING_BBOX,
    DUMB_ANCHOR_HEADING_TEXT,
)
from doclatticeserver.users.models import UserExport  # noqa: E402
