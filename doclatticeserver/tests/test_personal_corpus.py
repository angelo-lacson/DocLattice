...
class TestSharedStructuralAnnotationSet(TestCase):
    ...
    @patch("doclatticeserver.corpuses.models.transaction.on_commit")
...
class TestEnsureEmbeddingsForCorpus(TestCase):
    ...
    @patch(
        "doclatticeserver.tasks.corpus_tasks.get_default_embedder_path",
        return_value="default.embedder.path",
    )
    @patch(
        "doclatticeserver.tasks.embeddings_task.calculate_embeddings_for_annotation_batch"
    )
...
class TestPersonalCorpusSignalErrorHandling(TransactionTestCase):
    ...
    def test_signal_handles_integrity_error_gracefully(self):
        ...
        from doclatticeserver.users.signals import _create_personal_corpus_for_user
...
class TestDocumentVersioningHelpers(TestCase):
    ...
    def test_is_text_file_returns_true_for_text_plain(self):
        ...
        from doclatticeserver.documents.versioning import _is_text_file
    ...
    def test_create_content_file_handles_none_file_type(self):
        ...
        from doclatticeserver.documents.versioning import _create_content_file
