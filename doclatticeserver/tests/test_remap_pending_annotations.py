...
from doclatticeserver.documents.models import Document, PendingDocumentAnnotations
from doclatticeserver.tasks.doc_tasks import remap_pending_annotations
...
class TestRemapPendingAnnotations(TestCase):
    ...
    def test_concurrent_claim_guard_skips_already_processed_row(self):
        ...
        """
        from doclatticeserver.tasks.doc_tasks import _remap_one_pending_row
    ...
    def test_standard_chain_includes_remap_step(self):
        ...
        with patch("doclatticeserver.documents.signals.chain") as mock_chain:
        ...
        self.assertLess(
            task_names.index("doclatticeserver.tasks.doc_tasks.ingest_doc"),
            task_names.index(
                "doclatticeserver.tasks.doc_tasks.remap_pending_annotations"
            ),
        )
        self.assertLess(
            ...
            task_names.index("doclatticeserver.tasks.doc_tasks.set_doc_lock_state"),
        )
