...
from doclatticeserver.llms.tools.tool_factory import CoreTool, create_document_tools
...
from doclatticeserver.llms.vector_stores.llama_index_vector_stores import DjangoAnnotationVectorStore
...
class TestLlamaIndexAgents(TestCase):
    ...
    def test_legacy_compatibility_interface(self) -> None:
        ...
        from doclatticeserver.llms.agents.llama_index_agents import DocLatticeDbAgent
        from doclatticeserver.llms.agents.core_agents import CoreAgent, CoreConversationManager
