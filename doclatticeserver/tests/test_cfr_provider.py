...
from ``doclatticeserver/tests/fixtures/authority_sources/``.
...
from doclatticeserver.pipeline.authority_source_providers.cfr_provider import (
    _SNAPSHOT_DATE,
...
class TestCFRFetchImpl(SimpleTestCase):
    ...
    @patch(
        "doclatticeserver.pipeline.authority_source_providers.cfr_provider.requests.get"
    )
