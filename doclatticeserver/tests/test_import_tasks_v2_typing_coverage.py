...
from doclatticeserver.tasks.import_tasks_v2 import _setup_corpus_and_labels
...
class SetupCorpusAndLabelsGuardsTestCase(TestCase):
    ...
    @mock.patch(
        "doclatticeserver.tasks.import_tasks_v2.unpack_label_set_from_export",
        return_value=None,
    )
    ...
    @mock.patch(
        "doclatticeserver.tasks.import_tasks_v2.unpack_corpus_from_export",
        return_value=None,
    )
    @mock.patch(
        "doclatticeserver.tasks.import_tasks_v2.unpack_label_set_from_export",
