"""Coverage for doclatticeserver.users.tasks under USE_AUTH0=True.
...
from doclatticeserver.users.models import Auth0APIToken
...
def _reload_users_tasks():
    ...
    """
    import doclatticeserver.users.tasks as users_tasks
...
class GetNewAuth0TokenTaskTests(TestCase):
    ...
    @patch("doclatticeserver.users.tasks.requests.post")
    ...
    @patch("doclatticeserver.users.tasks.requests.get")
