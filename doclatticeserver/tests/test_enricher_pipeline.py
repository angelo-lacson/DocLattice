...
_PARSER_PATH = "doclatticeserver.pipeline.parsers.oc_text_parser.TxtParser"
...
class RunEnrichersTests(TestCase):
    ...
    def test_empty_list_returns_input_unchanged(self):
        export = cast(DocLatticeDocExport, {"labelled_text": []})
    ...
    def test_chain_composes_in_order(self):
        result = run_enrichers(
            ...
            1,
            1,
            cast(DocLatticeDocExport, {"labelled_text": []}),
        )
...
class ProcessDocumentEnrichmentWiringTests(TestCase):
    ...
    def _run(self) -> dict:
        ...
        DocLatticeDocExport that would have been persisted."""
        parser = _StubParser()
        ...
        if len(call.args) > 2:
            return call.args[2]
        return call.kwargs["doclattice_data"]
    ...
    def test_enrichment_stage_swallows_resolution_failure(self):
        ...
        """
        parser = _StubParser()
        parsed = cast(DocLatticeDocExport, {"labelled_text": [], "content": ""})
