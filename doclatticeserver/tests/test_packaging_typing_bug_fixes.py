...
graduating ``doclatticeserver.utils.{packaging,sharing}`` from the
...
from doclatticeserver.utils.sharing import make_analysis_public
...
class UnpackFromExportIntUserIdTests(TestCase):
    ...
    def test_unpack_label_set_accepts_integer_user_id(self) -> None:
        ...
        label_set_data: DocLatticeLabelSetType = {
            "id": "ignored",
    ...
    def test_unpack_corpus_accepts_integer_user_id(self) -> None:
        ...
        corpus_data: DocLatticeCorpusType = {
...
class MakeAnalysisPublicMissingCorpusTests(TestCase):
    ...
    def setUpTestData(cls) -> None:
        ...
        cls.analyzer = Analyzer.objects.create(
            ...
            task_name="doclatticeserver.tests.test_packaging_typing_bug_fixes.noop",
        )
