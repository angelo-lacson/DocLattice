...
from doclatticeserver.annotations.models import SPAN_LABEL, TOKEN_LABEL, Annotation
from doclatticeserver.corpuses.models import Corpus
from doclatticeserver.documents.models import Document
from doclatticeserver.llms.tools.core_tools._privacy_filter_client import Detection
from doclatticeserver.llms.tools.core_tools.pii import (
    ENTITY_GROUP_LABELS,
...
class _PiiPersistEmbeddingNoopMixin:
    ...
    def setUp(self) -> None:  # noqa: D401
        ...
        self._embed_patcher = patch(
            "doclatticeserver.llms.tools.core_tools.pii._queue_embed",
...
class ScanAndAnnotateTextTests(_PiiPersistEmbeddingNoopMixin, TransactionTestCase):
    ...
    async def test_text_doc_creates_span_label_annotations(self) -> None:
        ...
        with patch(
            "doclatticeserver.llms.tools.core_tools.pii.adetect_pii",
...
class PersistAnnotationsLabelRaceTests(
    ...
    def test_persist_annotations_sync_duplicate_label_race(self) -> None:
        ...
        # (doclatticeserver/corpuses/models.py). If that method grows a
