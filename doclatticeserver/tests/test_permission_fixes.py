...
from doclatticeserver.badges.models import Badge, BadgeTypeChoices
...
class TestRemoveRelationshipIDORProtection(TestCase):
    ...
    def setUp(self):
        """Create test users and relationships."""
        from doclatticeserver.annotations.models import AnnotationLabel, Relationship
        from doclatticeserver.documents.models import Document
