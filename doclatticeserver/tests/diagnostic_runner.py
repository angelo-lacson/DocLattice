...
Usage:
    Add to settings:
        TEST_RUNNER = 'doclatticeserver.tests.diagnostic_runner.DiagnosticTestRunner'

    Or run directly:
        python manage.py test --testrunner=doclatticeserver.tests.diagnostic_runner.DiagnosticTestRunner
"""
