...
from doclatticeserver.constants.zip_export import get_export_spool_max_size_bytes
from doclatticeserver.corpuses.models import Corpus
from doclatticeserver.documents.models import DocumentPath
from doclatticeserver.tasks.export_tasks import finalize_export
...
from doclatticeserver.utils.text import only_alphanumeric_chars
...
def build_corpus_v2_zip(
    ...
    corpus_export = cast(DocLatticeCorpusV2Type, _corpus_export)
    ...
    # (see doclatticeserver/tasks/import_tasks_v2.py and docs/architecture/
    ...
    # ===== PART 12: Assemble =====
    export_data: DocLatticeExportDataJsonPythonTypeV3 = {
        "version": "3.0",
