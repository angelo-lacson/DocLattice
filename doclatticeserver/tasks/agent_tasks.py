...
def generate_agent_response(
    ...
    from doclatticeserver.llms.api import agents as agent_api
...
def _resolve_action_tools(action: CorpusAction, trigger: str) -> list[str]:
    ...
    """
    from doclatticeserver.constants.corpus_actions import DEFAULT_TOOLS_BY_TRIGGER
...
def _build_document_action_system_prompt(
    ...
    """
    from doclatticeserver.constants.corpus_actions import TRIGGER_DESCRIPTIONS
...
async def _run_agent_thread_action_async(
    ...
    from doclatticeserver.corpuses.models import CorpusAction
    from doclatticeserver.llms import agents
    from doclatticeserver.llms.tools.moderation_tools import (
