...
from doclatticeserver.constants.zip_import import ZIP_MAX_SIDECAR_SIZE_BYTES
...
def _apply_sidecar_annotations(
    ...
    Args:
        doc_data: Pre-parsed sidecar JSON data (DocLatticeDocExport).
...
def import_zip_with_folder_structure(
    ...
    4. Extracts and creates documents with proper folder assignments.
       If a document has a co-located .json sidecar (DocLatticeDocExport):
