...
if TYPE_CHECKING:
    ...
    from doclatticeserver.utils.zip_security import ZipFileEntry
...
def _import_document_with_sidecar(
    ...
    The sidecar is an ``DocLatticeDocExport`` JSON that contains
        ...
        with temporary_file_handle.file.open("rb") as import_file, zipfile.ZipFile(
            ...
            for entry in manifest.valid_files:
                try:
                    ...
                    # A) Sidecar import: pre-annotated via DocLatticeDocExport JSON
