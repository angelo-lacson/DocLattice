...
if TYPE_CHECKING:
    ...
    from doclatticeserver.utils.metadata_file_parser import DocumentMetadata
...
from doclatticeserver.constants.zip_import import get_zip_max_sidecar_size_bytes
...
from doclatticeserver.utils.validate_export import validate_dumb_anchor_sidecar
...
def import_document_to_corpus(
    ...
    user_id: int,
    document_import_data: DocLatticeAnnotatedDocumentImportType,
) -> str | None:
    """
...
def create_relationships_from_parsed(
    ...
    """
    from doclatticeserver.annotations.models import AnnotationLabel
    from doclatticeserver.documents.models import DocumentRelationship
...
def _read_sidecar(
    ...
    # doclatticeserver/constants/zip_import.py).
...
def import_zip_with_folder_structure(
    ...
    """
    from doclatticeserver.constants.zip_import import get_zip_document_batch_size
    ...
    # import — see doclatticeserver/constants/zip_import.py).
    ...
    try:
        ...
        with temporary_file_handle.file.open("rb") as import_file, zipfile.ZipFile(
            ...
            if manifest.metadata_file:
                from doclatticeserver.utils.metadata_file_parser import (
                    parse_metadata_file,
                )
            ...
            if manifest.relationship_file:
                from doclatticeserver.utils.relationship_file_parser import (
