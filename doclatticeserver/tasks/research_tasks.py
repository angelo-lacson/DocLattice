...
:func:`doclatticeserver.tasks.agent_tasks.run_agent_corpus_action` —
...
from doclatticeserver.enrichment.finding_cards import (
...
from doclatticeserver.research.constants import (
...
from doclatticeserver.research.services.research_reports import (
    ResearchCancelled,
    ResearchMemoryError,
...
def _load_obligation_schema(report: ResearchReport, corpus: Any) -> ObligationSchema:
    ...
    the run.
    """
    from doclatticeserver.corpuses.caml_intelligence import parse_component_props
    from doclatticeserver.corpuses.services import CorpusDocumentService
    from doclatticeserver.corpuses.services.description_cache import read_caml_body
...
def _build_finding_card(
    *,
    ...
    # (doclatticeserver/enrichment/finding_cards.py). The guard clauses above
