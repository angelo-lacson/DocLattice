...
from doclatticeserver.pipeline.utils import get_preferred_embedder
from doclatticeserver.shared.decorators import doc_analyzer_task, async_doc_analyzer_task
...
def agentic_highlighter_claude(
    ...
    **kwargs: Any,
    ...
    analyzer_kwargs = kwargs.get("doclatticeserver.tasks.doc_analysis_tasks.agentic_highlighter_claude", {})
