...
def annotation_window(document_id: int, annotation_id: str, window_size: str) -> str:
    ...
    from doclatticeserver.types.dicts import TextSpanData, PawlsPagePythonType
    ...
    try:
        if file_type.startswith("text/"):
            ...
            from doclatticeserver.types.dicts import DocLatticeSinglePageAnnotationType
            ...
            try:
                if is_single_page_annotation(anno_json):
                    ...
                    pages_dict[page_index] = DocLatticeSinglePageAnnotationType(**anno_json)
                else:
                    for k, v in anno_json.items():
                        page_index = int(k)
                        pages_dict[page_index] = DocLatticeSinglePageAnnotationType(**v)
            except Exception:
                return (
            ...
            from doclatticeserver.types.dicts import PawlsPagePythonType
