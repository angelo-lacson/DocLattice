...
def calculate_embedding_for_doc_text(
    ...
    try:
        ...
        logger.error(f"calculate_embedding_for_doc_text() - failed to generate embeddings due to error: {e}")
...
def calculate_embedding_for_annotation_text(
    ...
    try:
        ...
        logger.error(f"calculate_embedding_for_annotation_text() - failed to generate embeddings due to error: {e}")
