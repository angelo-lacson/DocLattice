...
class UsersConfig(AppConfig):
    name: str = "doclatticeserver.users"
    ...
    def ready(self) -> None:
        ...
        try:
            import doclatticeserver.users.signals  # noqa F401
        except ImportError:
            pass
        ...
        from doclatticeserver.shared import checks as _arch_checks  # noqa F401
        from doclatticeserver.users import checks  # noqa F401
