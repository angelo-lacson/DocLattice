...
class ResearchReportService(BaseService):
    ...
    def start(
        ...
        *,
        ...
        with transaction.atomic():
            ...
            from doclatticeserver.tasks.research_tasks import run_deep_research
    ...
    # mechanisms (DRY review, 2026-06): DocLattice already has two durable
    ...
    def _save_to_workspace(cls, report: ResearchReport) -> None:
        ...
        """
        from doclatticeserver.corpuses.services import WorkspaceService
...
def _normalize_for_quote_match(text: str) -> str:
    ...
    Mirrors ``doclatticeserver.utils.annotation_anchoring._norm`` so quote
