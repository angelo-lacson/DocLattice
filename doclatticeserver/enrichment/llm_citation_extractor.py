...
hallucinations, and returns :class:`~doclatticeserver.enrichment.extractor.Candidate`
...
class LLMCitationExtractor:
    ...
    Args:
        model: pydantic-ai model spec string (e.g. ``"openai:gpt-4o"``).
               ...
               :func:`~doclatticeserver.llms.llm_registry.resolve_model_spec`.
    ...
    async def _abuild_model(self) -> Any:
        ...
        :func:`~doclatticeserver.pipeline.utils.get_default_llm_spec` so a
