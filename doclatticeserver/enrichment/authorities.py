...
def find_authority_target(canonical_key: str, user) -> Document | None:
    ...
    candidate keys.
    """
    from doclatticeserver.annotations.models import AuthorityKeyEquivalence
    ...
    from doclatticeserver.enrichment.data import mappings as _enrichment_mappings
...
class AuthorityCorpusBootstrapper:
    ...
    def bootstrap(
        ...
        *,
        ...
        from doclatticeserver.llms.tools.core_tools.text_document_import import (
