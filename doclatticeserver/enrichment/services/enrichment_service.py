...
:mod:`doclatticeserver.enrichment.services.corpus_reference_service`.
"""
...
from doclatticeserver.constants.annotations import OC_SECTION_LABEL
from doclatticeserver.corpuses.models import Corpus
from doclatticeserver.corpuses.services.corpus_documents import CorpusDocumentService
from doclatticeserver.enrichment import constants as C
from doclatticeserver.enrichment.extractor import ReferenceExtractor
from doclatticeserver.enrichment.resolver import (
    ReferenceResolver,
    Resolution,
    SectionAnno,
)
from doclatticeserver.enrichment.writer import EnrichmentWriter, WriteResult
from doclatticeserver.types.enums import JobStatus
from doclatticeserver.utils.files import read_field_file_text
from doclatticeserver.utils.frontend_paths import document_in_corpus_path
...
class EnrichmentService:
    ...
    def _build_detection(self, documents, types, user, extra_tiers):
        ...
        never "grammar only".
        """
        from doclatticeserver.enrichment.authorities import authority_alias_registry
        from doclatticeserver.enrichment.grammars import GenericCitationExtractor
        ...
        if C.DETECTION_TIER_LLM in active_tiers:
            from doclatticeserver.enrichment.llm_citation_extractor import (
    ...
    def _resolve_doc(
        ...
        *,
        ...
        """
        from doclatticeserver.enrichment.reconcile import reconcile
    ...
    def discover(
        ...
        *,
        ...
        from doclatticeserver.enrichment.authorities import classify_canonical_key
    ...
    def _link_external(self, user, corpus) -> dict:
        ...
        * **demote** — a RESOLVED ref whose target is no longer audience-visible
        ...
        from doclatticeserver.enrichment.authorities import find_authority_target
