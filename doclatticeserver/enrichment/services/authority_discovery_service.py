...
class AuthorityDiscoveryService(BaseService):
    ...
    def _provider_for(cls, canonical_key: str) -> tuple[str | None, Any, str | None]:
        ...
        from doclatticeserver.enrichment.data import mappings as _mappings
    ...
    def discover_and_bootstrap(
        ...
        *,
        ...
        """
        from doclatticeserver.annotations.models import AuthorityKeyEquivalence
        from doclatticeserver.enrichment.authorities import bootstrap_authority_corpus
        from doclatticeserver.enrichment.services.authority_frontier_service import (
            AuthorityFrontierService,
        )
        from doclatticeserver.enrichment.services.enrichment_service import (
            EnrichmentService,
        )
