...
from doclatticeserver.enrichment.authorities import (
    bootstrap_authority_corpus,
    read_section_spec,
)
from doclatticeserver.enrichment.constants import (
    BASELINE_ORIGIN_CORE,
    BASELINE_ORIGIN_MAX_LENGTH,
)
from doclatticeserver.enrichment.data.mappings import is_valid_prefix
from doclatticeserver.enrichment.services.authority_mapping_loader import (
    AuthorityMappingLoader,
)
from doclatticeserver.enrichment.services.authority_pack_config import (
    pack_origin_name,
)
...
from doclatticeserver.pipeline.registry import authority_pack_dirs
    ...
    def _validate_corpus_entry(
        ...
        *,
        ...
        if default_weight is not None:
            from doclatticeserver.enrichment.authority_sources import AuthorityWeight
