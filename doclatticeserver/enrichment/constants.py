...
# doclatticeserver/tasks/corpus_analysis_tasks.py) so the analyzer row the
...
CRAWL_ANALYZER_TASK = "doclatticeserver.tasks.corpus_analysis_tasks.crawl_authorities"
