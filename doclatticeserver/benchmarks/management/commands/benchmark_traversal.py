...
``doclatticeserver/benchmarks/traversal_benchmark.py`` for the rationale.

Usage::

    docker compose -f local.yml run django python manage.py benchmark_traversal \\
        --questions doclatticeserver/benchmarks/fixtures/traversal_questions.yaml \\
        --user admin \\
...
from doclatticeserver.benchmarks.traversal_benchmark import (
    load_questions,
    render_markdown,
