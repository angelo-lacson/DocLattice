...
class BenchmarkTask:
    ...
    A task becomes exactly one :class:`~doclatticeserver.extracts.models.Column`
    in the generated :class:`~doclatticeserver.extracts.models.Fieldset` and
    produces one :class:`~doclatticeserver.extracts.models.Datacell` per
