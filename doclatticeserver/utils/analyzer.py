...
def install_labels_for_analyzer(
    ...
    """
    When an analysis is run, we need to have labels in the local DocLattice database to link to
...
def install_analyzers(
    ...
    analyzers in the DB of this instance of DocLattice.
    """
...
def run_analysis(
    ...
    # We need to build the url of THIS actual instance of DocLattice
