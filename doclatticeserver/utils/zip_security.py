...
from doclatticeserver.utils.metadata_file_parser import METADATA_FILE_NAMES
from doclatticeserver.utils.relationship_file_parser import RELATIONSHIP_FILE_NAMES
...
def validate_zip_for_import(
    ...
    # doclatticeserver/constants/zip_import.py for why).
