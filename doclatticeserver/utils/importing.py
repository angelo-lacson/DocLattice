...
from doclatticeserver.types.dicts import DocLatticeAnnotationPythonType, DocLatticeRelationshipPythonType
...
def import_annotations(
    ...
    doc_obj,
    corpus_obj,
    annotations_data: list[DocLatticeAnnotationPythonType],
    ...
    Args:
        ...
        annotations_data (List[DocLatticeAnnotationPythonType]): List of annotation data.
...
def import_relationships(
    ...
    Args:
        ...
        corpus_obj: The Corpus object, if any.
        relationships_data (List[DocLatticeRelationshipPythonType]): The relationship data to import.
