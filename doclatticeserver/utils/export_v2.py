...
``doclatticeserver/tasks/export_tasks_v2.py`` for the assembled payload.
"""
...
from doclatticeserver.documents.models import DocumentPath, IngestionSource
...
def package_structural_annotation_set(
    ...
    try:
        ...
        for annot in structural_set.structural_annotations.all():
            ...
            annot_data: DocLatticeAnnotationPythonType = {
                "id": str(annot.id),
                "annotationLabel": (
...
def package_relationships(
    ...
    """
    relationships_export: list[DocLatticeRelationshipPythonType] = []
...
def package_metadata_schema(corpus: Corpus) -> MetadataSchemaExport | None:
    ...
    :class:`doclatticeserver.types.dicts.MetadataSchemaExport` dict
