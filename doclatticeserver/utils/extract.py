...
Mirrors :mod:`doclatticeserver.utils.analysis`. Any user-facing flow that
creates an :class:`~doclatticeserver.extracts.models.Extract` should go
...
def create_and_setup_extract(
    ...
    *,
    ...
    filters. Mirrors :func:`doclatticeserver.utils.analysis.create_and_setup_analysis`
