...
class Column(BaseOCModel):
    ...
    task_name = django.db.models.CharField(max_length=1024, null=False, blank=False, default="doclatticeserver.tasks.data_extract_tasks.oc_llama_index_doc_query")
