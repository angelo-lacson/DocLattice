...
def parse_with_nlm(user_id: int, doc_id: int) -> Optional[DocLatticeDocExport]:
    """
    ...
    doclattice_data: Optional[DocLatticeDocExport] = response_data.get("return_dict", {}).get("doclattice_data")
