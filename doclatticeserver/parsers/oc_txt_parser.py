...
def parse_txt_document(user_id: int, doc_id: int) -> Optional[DocLatticeDocExport]:
    ...
    and constructs an DocLatticeDocExport object containing the parsed data. It creates
    ...
    # Prepare the DocLatticeDocExport
    ...
    for sentence in doc.sents:
        ...
        annotation_json: DocLatticeSinglePageAnnotationType = {
            "bounds": {},
            "tokensJsons": tokens_jsons,
            "rawText": sentence.text,
        }

        annotation_entry: DocLatticeAnnotationPythonType = {
            "id": None,
