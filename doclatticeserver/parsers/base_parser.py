...
def parse_document(
    user_id: int,
    doc_id: int,
    parse_function: Callable[[int, int], Optional[DocLatticeDocExport]],
) -> None:
    """
    ...
    Args:
        ...
        parse_function (Callable[[int, int], Optional[DocLatticeDocExport]]): The parser function to use.
    ...
    # Call the parser function to get DocLatticeDocExport
    doclattice_data = parse_function(user_id, doc_id)
