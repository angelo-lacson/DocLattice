...
class DocumentsConfig(AppConfig):
    ...
    name = "doclatticeserver.documents"
    verbose_name = _("Documents")

    def ready(self):
        try:
            import doclatticeserver.documents.signals  # noqa F401
            ...
            from doclatticeserver.utils.storage_warming import warm_storage_backend
            ...
            from doclatticeserver.documents._pipeline_settings_seed import (
            ...
            from doclatticeserver.documents import checks  # noqa F401
