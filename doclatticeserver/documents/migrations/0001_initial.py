    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('custom_meta', doclatticeserver.shared.fields.NullableJSONField(blank=True, default=doclatticeserver.shared.defaults.jsonfield_default_value, null=True)),
                ('icon', models.FileField(blank=True, max_length=1024, upload_to=functools.partial(doclatticeserver.shared.utils.calc_oc_file_path, *(), **{'sub_folder': 'pdf_icons'}))),
                ('pdf_file', models.FileField(max_length=1024, upload_to=functools.partial(doclatticeserver.shared.utils.calc_oc_file_path, *(), **{'sub_folder': 'pdf_files'}))),
                ('txt_extract_file', models.FileField(blank=True, max_length=1024, null=True, upload_to=functools.partial(doclatticeserver.shared.utils.calc_oc_file_path, *(), **{'sub_folder': 'txt_layers_files'}))),
                ('page_count', models.IntegerField(blank=True, default=-1)),
                ('pawls_parse_file', models.FileField(blank=True, max_length=1024, null=True, upload_to=functools.partial(doclatticeserver.shared.utils.calc_oc_file_path, *(), **{'sub_folder': 'pawls_layers_files'}))),
