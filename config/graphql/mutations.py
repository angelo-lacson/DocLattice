...
class ReEmbedCorpus(graphene.Mutation):
    ...
    class Arguments:
        ...
        new_embedder = graphene.String(
            ...
            description=(
                ...
                "(e.g., 'doclatticeserver.pipeline.embedders."
    ...
    def mutate(root, info, corpus_id, new_embedder):
        ...
        from doclatticeserver.pipeline.utils import get_component_by_name
        from doclatticeserver.tasks.corpus_tasks import reembed_corpus
...
class StartCorpusExport(graphene.Mutation):
    ...
    def mutate(
        ...
        try:
            ...
            elif export_format == ExportType.DOCLATTICE_V2.value:
...
class ImportZipToCorpus(graphene.Mutation):
    ...
    def mutate(
        ...
        from doclatticeserver.tasks.import_tasks import (
...
class RetryDocumentProcessing(graphene.Mutation):
    ...
    def mutate(root, info, document_id):
        ...
        from doclatticeserver.tasks.doc_tasks import retry_document_processing
        from doclatticeserver.types.enums import PermissionTypes
...
class RunCorpusAction(graphene.Mutation):
    ...
    def mutate(root, info, corpus_action_id: str, document_id: str):
        ...
        from doclatticeserver.corpuses.models import CorpusActionExecution
        from doclatticeserver.documents.models import DocumentPath
        from doclatticeserver.tasks.agent_tasks import run_agent_corpus_action
