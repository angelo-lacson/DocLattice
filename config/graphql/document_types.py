...
from doclatticeserver.constants import MAX_PROCESSING_ERROR_DISPLAY_LENGTH
...
def _resolve_DocumentType_doc_type_labels(root, info):
    from doclatticeserver.annotations.models import DOC_TYPE_LABEL
...
def _resolve_DocumentType_version_count(root, info):
    ...
    visibility filter).
    """
    from doclatticeserver.documents.services import DocumentVersionService
...
def _resolve_DocumentType_folder_in_corpus(root, info, corpus_id):
    ...
    """
    from doclatticeserver.corpuses.models import Corpus
    from doclatticeserver.corpuses.services import FolderDocumentService
