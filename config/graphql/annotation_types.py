...
from doclatticeserver.utils.permissioning import get_users_permissions_for_obj
...
def _frontier_predicted_provider(row):
    ...
    if not hasattr(row, "_predicted_provider_cache"):
        from doclatticeserver.enrichment.services.authority_discovery_service import (  # noqa: E501
...
class AnnotationType(AnnotatePermissionsForReadMixin, DjangoObjectType):
    ...
    def get_queryset(cls, queryset, info) -> Any:
        ...
        # (the ``doclattice.E001`` system check forbids inline use here),
