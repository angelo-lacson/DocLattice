...
class Query(graphene.ObjectType):
    ...
    def resolve_document(self, info, **kwargs):
        ...
        from doclatticeserver.shared.resolvers import resolve_single_oc_model_from_id
    ...
    if settings.USE_ANALYZER:
        ...
        def resolve_analysis(self, info, **kwargs):
            from doclatticeserver.annotations.query_optimizer import AnalysisQueryOptimizer
