...
# geocoding service (``doclatticeserver/utils/geocoding``) and the resolver
...
def _create_geographic_annotation(
    *,
    ...
    """
    from doclatticeserver.utils.geocoding import resolve_place
    ...
    from doclatticeserver.annotations.services.geographic_service import (
...
class AddCountryAnnotation(graphene.Mutation):
    ...
    geocoding service (see :mod:`doclatticeserver.utils.geocoding`).
