...
(``doclatticeserver.documents.services.IngestionAdminService``,
...
class IngestionAdminQueryMixin:
    ...
    def resolve_admin_document_ingestion(
        ...
        from doclatticeserver.documents.services import IngestionAdminService
    ...
    def resolve_admin_bulk_import_sessions(
        ...
        from doclatticeserver.document_imports.models import ChunkedUploadStatus
