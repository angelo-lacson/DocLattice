...
from doclatticeserver.constants.annotations import OC_RESERVED_LABEL_PREFIX
from doclatticeserver.constants.document_processing import MARKDOWN_MIME_TYPE
from doclatticeserver.constants.stats import (
...
class CorpusQueryMixin:
    ...
    corpus_group = DocLatticeNode.Field(CorpusGroupType)
    ...
    def resolve_deleted_documents_in_corpus(self, info, corpus_id) -> Any:
        ...
        """
        from doclatticeserver.corpuses.services import DocumentLifecycleService
    ...
    def resolve_corpus_stats(self, info, corpus_id) -> Any:
        ...
        from doclatticeserver.conversations.services import ConversationService
