...
from doclatticeserver.corpuses.models import Corpus, CorpusCategory, CorpusGroup
...
def _corpus_count_subqueries() -> tuple[Any, Any]:
    ...
    from doclatticeserver.corpuses.models import CAML_ARTICLE_DOCUMENT_PATH_Q
