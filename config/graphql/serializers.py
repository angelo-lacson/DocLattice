...
class CorpusSerializer(serializers.ModelSerializer):
    ...
    def validate(self, attrs) -> Any:
        ...
        from doclatticeserver.constants.licenses import LICENSE_CHOICES
...
class AnnotationSerializer(serializers.ModelSerializer):
    ...
    def validate_link_url(self, value: str | None) -> str | None:
        ...
        """
        from doclatticeserver.annotations.models import validate_link_url as _validate
    ...
    def validate_annotation_json(self, value: Any) -> Any:
        ...
        `dict[Union[int, str], DocLatticeSinglePageAnnotationType]`, ensure that
        any `BoundingBoxPythonType` values with floats are converted to ints.
        """
        if isinstance(value, dict):
            # Check if value conforms to DocLatticeSinglePageAnnotationType
    ...
    def to_representation(self, instance) -> Any:
        ...
        if isinstance(annotation_json, dict):
            # Check if annotation_json conforms to DocLatticeSinglePageAnnotationType
            is_single_page_annotation = True
