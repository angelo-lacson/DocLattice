...
from doclatticeserver.constants.stats import GOVERNANCE_GRAPH_MAX_NODES
...
class AnnotationQueryMixin:
    ...
    def resolve_governance_graph(self, info, corpus_id, limit=None) -> Any:
        ...
        from doclatticeserver.enrichment.services import GovernanceGraphService
    ...
    def resolve_authority_frontier_stats(
        ...
        from doclatticeserver.enrichment.services import AuthorityFrontierService
    ...
    def resolve_authority_namespace_stats(self, info, search=None) -> Any:
        from doclatticeserver.enrichment.services import AuthorityNamespaceService
