...
:class:`doclatticeserver.analyzer.services.AnalysisLifecycleService`;
...
from doclatticeserver.analyzer.services.analysis_lifecycle_service import (
...
class RunCorpusEnrichmentMutation(graphene.Mutation):
    ...
    dispatched :class:`~doclatticeserver.analyzer.models.Analysis` row is
