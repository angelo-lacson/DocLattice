...
from doclatticeserver.constants.auth import (  # noqa: E402
...
from doclatticeserver.shared.services.base import BaseService  # noqa: E402
from doclatticeserver.users.models import Assignment, User, UserExport, UserImport
...
def _resolve_UserType_display_name(root, info, **kwargs):
    ...
    Resolution order:
        ...
        5. ``username`` verbatim — ONLY when ``is_social_user=False``.
           ...
           ``doclatticeserver/users/validators.py``) explicitly allows
