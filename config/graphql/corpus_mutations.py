...
from doclatticeserver.analyzer.models import Analyzer
...
from doclatticeserver.documents.versioning import calculate_content_version
...
def m_re_embed_corpus(
    ...
    new_embedder: Annotated[
        ...
        strawberry.argument(
            name="newEmbedder",
            description="Fully qualified Python path to the new embedder class (e.g., 'doclatticeserver.pipeline.embedders.sent_transformer_microservice.MicroserviceEmbedder')",
        ),
    ] = strawberry.UNSET,
) -> ReEmbedCorpus | None:
...
def _mutate_CreateArtifact(
    ...
    def mutate(
        ...
        from doclatticeserver.constants.artifacts import MAX_ARTIFACT_CONFIG_BYTES
