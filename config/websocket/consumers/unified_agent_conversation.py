...
from doclatticeserver.constants.context_guardrails import WS_ERROR_CONTEXT_EXHAUSTED
from doclatticeserver.conversations.models import MessageType
...
from doclatticeserver.llms.agents.mention_extractor import (
    ExtractedMention,
    extract_agent_mentions,
)
from doclatticeserver.llms.tools.delegation_tools import (
    StreamRelay,
...
class UnifiedAgentConsumer(AuthHandshakeMixin, AsyncWebsocketConsumer):
    ...
    async def _generate_conversation_title(self, user_query: str) -> str:
        ...
        :func:`~doclatticeserver.llms.completions.agenerate_text` rather than a
    ...
    async def _stream_agent_response(
        ...
        *,
        ...
        from doclatticeserver.utils.vcr_replay import maybe_vcr_cassette
    ...
    async def _handle_approval_decision(self, payload: dict[str, Any]) -> None:
        ...
        ``doclatticeserver.llms.tools.delegation_tools.build_delegation_tool``);
