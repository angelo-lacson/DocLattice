...
if STORAGE_BACKEND == "LOCAL":
    ...
    STATICFILES_STORAGE = "doclatticeserver.utils.enhanced_storages.PooledStaticRootS3Storage"
    ...
    # ------------------------------------------------------------------------------
    # Use pooled storage backends for better performance
    DEFAULT_FILE_STORAGE = "doclatticeserver.utils.enhanced_storages.PooledMediaRootS3Storage"
