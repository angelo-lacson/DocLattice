...
if STORAGE_BACKEND == "LOCAL":
    ...
    STATICFILES_STORAGE = (
        "doclatticeserver.utils.enhanced_storages.PooledStaticRootS3Storage"
    )
    ...
    DEFAULT_FILE_STORAGE = (
        "doclatticeserver.utils.enhanced_storages.PooledMediaRootS3Storage"
    )
    ...
    # ------------------------
    STATICFILES_STORAGE = (
        "doclatticeserver.utils.storages.StaticRootGoogleCloudStorage"
    )
    ...
    # ------------------------------------------------------------------------------
    DEFAULT_FILE_STORAGE = (
        "doclatticeserver.utils.storages.MediaRootGoogleCloudStorage"
    )
