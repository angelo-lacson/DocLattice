...
from doclatticeserver.annotations.views import AnnotationImagesView
...
urlpatterns = [
    ...
    path("", include("doclatticeserver.discovery.urls")),
    ...
    path(
        "api/worker-uploads/",
        include("doclatticeserver.worker_uploads.urls", namespace="worker_uploads"),
    ),
    path(
        "api/imports/",
        include(
            "doclatticeserver.document_imports.urls",
