...
- **Superuser permissions**: `doclatticeserver/utils/permissioning.py` — added superuser check for guardian-enabled models, with comment explaining the richer permission set (comment, publish, permission) vs basic CRUD
