...
- Integration tests verifying headers appear on real responses through the full middleware stack (`doclatticeserver/tests/test_security_headers_middleware.py`)
