...
- **Lazy logging in export_v2.py** (PR #1197): Replaced remaining f-string logger calls with `%s`-style lazy formatting in `doclatticeserver/utils/export_v2.py` for corpus folders, relationships, and conversations error handlers.
