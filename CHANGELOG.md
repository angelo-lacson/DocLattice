...
- Tests in `doclatticeserver/tests/test_security_headers_middleware.py` — unit tests, integration test against `/api/health/`, and Auth0 domain sanitization tests
