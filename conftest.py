"""
Root pytest configuration for DocLattice.
...
from doclatticeserver.utils.vcr_replay import ensure_aiohttp_vcr_compat
...
# runs. See doclatticeserver/utils/vcr_replay.py and issue #1920.
