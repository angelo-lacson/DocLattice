...
class UserQueryOptimizer:
    ...
    def get_visible_users(
        ...
        from doclatticeserver.corpuses.models import CorpusUserObjectPermission
...
def resolve_assignments(self, info, **kwargs):
    ...
    See doclatticeserver/users/models.py:203-206
    """
    import warnings
...
### Test File: `doclatticeserver/tests/permissioning/test_user_visibility.py`
...
### Test File: `doclatticeserver/tests/permissioning/test_badge_visibility.py`
...
### Test File: `doclatticeserver/tests/permissioning/test_document_actions_permissions.py`
