...
This document specifies the permission model for @ mentions in DocLattice, ensuring users can only:
...
- [x] Add backend tests for mention permission filtering (**31 tests total** in `doclatticeserver/tests/test_mention_permissions.py`)
