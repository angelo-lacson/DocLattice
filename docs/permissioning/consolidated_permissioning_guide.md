...
**CRITICAL**: The function `user_has_permission_for_obj` in `doclatticeserver/utils/permissioning.py` is THE single source of truth for ALL permission checks in the system. Never bypass this function or implement custom permission logic.
