...
This guide covers the GPU-enabled Docker setup for DocLattice and the GitHub Actions workflows for building and publishing container images.
...
**Images built:**
- `ghcr.io/[owner]/doclatticeserver_django:[version]` - Used by django, celeryworker, celerybeat, and flower services
- `ghcr.io/[owner]/doclatticeserver_frontend:[version]`
- `ghcr.io/[owner]/doclatticeserver_postgres:[version]`
- `ghcr.io/[owner]/doclatticeserver_traefik:[version]`
...
**Images built:**
- `ghcr.io/[owner]/doclatticeserver_django:cuda-latest` - GPU-enabled image used by django, celeryworker, celerybeat, and flower services
...
- Release images: `ghcr.io/[owner]/doclatticeserver_django:[version]`
- CUDA images: `ghcr.io/[owner]/doclatticeserver_django:cuda-latest`
