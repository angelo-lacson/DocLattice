...
qs = Analyzer.objects.filter(
    task_name='doclatticeserver.tasks.doc_analysis_tasks.pii_scanner_privacy_filter'
)
...
from doclatticeserver.tasks.doc_analysis_tasks import pii_scanner_privacy_filter
...
with patch(
    'doclatticeserver.tasks.doc_analysis_tasks.adetect_pii',
