...
docker compose -f test.yml run --rm django pytest \
  doclatticeserver/tests/architecture/test_graphql_dependencies.py \
  doclatticeserver/tests/test_schema_parity.py \
  doclatticeserver/tests/test_api_id_contract.py \
  doclatticeserver/tests/test_jwt_auth_contract.py \
  doclatticeserver/tests/test_jwt_refresh_contract.py \
  doclatticeserver/tests/test_coverage_core_relay.py \
  doclatticeserver/tests/test_coverage_core_scalars.py \
  doclatticeserver/tests/test_security_hardening.py \
  doclatticeserver/tests/test_jwt_utils.py \
  doclatticeserver/tests/test_token_expiration.py \
  doclatticeserver/tests/test_user_mutations_rate_limiting.py \
  doclatticeserver/tests/test_websocket_auth.py \
  doclatticeserver/tests/permissioning \
  doclatticeserver/tests/test_fk_visibility_traversal.py \
  doclatticeserver/tests/test_singular_node_idor.py
