...
-->
![Discovery Landing Page - The new homepage showcasing trending corpuses, recent discussions, and community statistics](../assets/images/screenshots/releases/v3.0.0.b3/landing-page.png)
...
-->
![Version History Panel - Browse and restore previous document versions with full change tracking](../assets/images/screenshots/releases/v3.0.0.b3/version-history.png)
...
-->
![Discussion Thread - Forum-style conversations with @mentions, voting, and rich document previews](../assets/images/screenshots/releases/v3.0.0.b3/discussion-thread.png)
...
-->
![AI Agent Response - The Research Assistant answering a question about document contents](../assets/images/screenshots/releases/v3.0.0.b3/agent-response.png)
...
<!--
  ...
  Capture at ~800x700.
-->
![Agent Configuration - Create custom AI assistants with specific tools and personas](../assets/images/screenshots/releases/v3.0.0.b3/agent-config.png)
...
-->
![Badge Celebration - Earn achievements and get celebrated with a fun modal](../assets/images/screenshots/releases/v3.0.0.b3/badge-celebration.png)
...
-->
![Folder Tree Sidebar - Organize documents in a familiar hierarchical structure](../assets/images/screenshots/releases/v3.0.0.b3/folder-tree.png)
...
<!--
  ...
  Capture at ~1000x700.
-->
![User Profile - View contributor statistics, badges, and recent activity](../assets/images/screenshots/releases/v3.0.0.b3/user-profile.png)
...
<!--
  ...
  Capture at ~800x600.
-->
![Leaderboard - See top contributors and compete for reputation](../assets/images/screenshots/releases/v3.0.0.b3/leaderboard.png)
...
<!--
  ...
  Capture at ~1000x600.
-->
![Analytics Dashboard - Track engagement with interactive charts and real-time metrics](../assets/images/screenshots/releases/v3.0.0.b3/analytics.png)
