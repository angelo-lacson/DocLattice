...
This guide documents the patterns, design language, and practical steps for migrating DocLattice frontend components from Semantic UI to `@os-legal/ui` (OS-Legal-Style).
