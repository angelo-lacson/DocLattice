...
You will need Docker and Docker Compose installed to run DocLattice. We've developed and run the application a Linux x86_64 environment. We haven't tested on Windows, and it's known that celery is
