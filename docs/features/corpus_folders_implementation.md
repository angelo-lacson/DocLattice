...
### 1. Database Models (`doclatticeserver/corpuses/models.py`)
...
**Model Tests (`doclatticeserver/tests/test_corpus_folders.py`):**
- 19 tests covering model creation, hierarchy, constraints, permissions, tree traversal

**Mutation Tests (`doclatticeserver/tests/test_corpus_folder_mutations.py`):**
...
- **Backend Models**: `doclatticeserver/corpuses/models.py`
