...
(`doclatticeserver/llms/tools/core_tools/multi_corpus.py::asearch_across_corpora`).
...
`doclatticeserver/corpuses/admin.py` in favour of this GUI (#2141) so there is
