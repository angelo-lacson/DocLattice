...
**File**: `doclatticeserver/constants/zip_import.py`
...
**File**: `doclatticeserver/utils/zip_security.py`
...
1. `doclatticeserver/constants/zip_import.py` - Security constants
2. `doclatticeserver/utils/zip_security.py` - Path sanitization and validation
3. `doclatticeserver/tests/test_zip_security.py` - Security utility tests
4. `doclatticeserver/tests/test_zip_import_integration.py` - Integration tests

### Modified Files

1. `doclatticeserver/constants/__init__.py` - Import new constants
2. `doclatticeserver/tasks/import_tasks.py` - Add new task
