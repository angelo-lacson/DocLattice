...
### 1. Models (`doclatticeserver/badges/models.py`)
...
### 2. Criteria Registry (`doclatticeserver/badges/criteria_registry.py`)
...
### 4. Signal Handlers (`doclatticeserver/badges/signals.py`)
...
### 5. Badge Evaluation (`doclatticeserver/tasks/badge_tasks.py`)
...
**Backend Tests (`doclatticeserver/tests/test_badges.py`):**
...
**Backend:**
- Models: `doclatticeserver/badges/models.py`
- Registry: `doclatticeserver/badges/criteria_registry.py`
- Tasks: `doclatticeserver/tasks/badge_tasks.py`
- Signals: `doclatticeserver/badges/signals.py`
...
- Default Badges Migration: `doclatticeserver/badges/migrations/0005_install_default_badges.py`
- Tests: `doclatticeserver/tests/test_badges.py`
