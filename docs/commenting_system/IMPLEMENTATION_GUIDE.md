...
const THREAD_PREFS_KEY = "doclattice_thread_preferences";
...
- **Created**:
  ...
  - `doclatticeserver/tests/test_mention_permissions.py`
...
- **Deleted**:
  - `doclatticeserver/tests/test_mention_graphql_integration.py` (experimental, replaced by unit tests)
...
- `doclatticeserver/tests/test_badges.py` - IDOR prevention tests
- `doclatticeserver/tests/test_moderation.py` - IDOR prevention tests
...
This section provides detailed instructions for integrating the discussion system into existing DocLattice views, following the centralized routing architecture and maintaining UI/UX consistency.
