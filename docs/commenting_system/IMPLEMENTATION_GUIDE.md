...
| Component | Location |
|-----------|----------|
| Conversation Models | `doclatticeserver/conversations/models.py` |
| Conversation Signals | `doclatticeserver/conversations/signals.py` |
...
| Mention Permission Tests | `doclatticeserver/tests/test_mention_permissions.py` |
...
docker compose -f test.yml run django pytest doclatticeserver/tests/test_mention_permissions.py -v
