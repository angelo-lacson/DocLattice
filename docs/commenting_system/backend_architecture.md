...
All models are defined in `doclatticeserver/conversations/models.py`.
...
**Location**: `doclatticeserver/conversations/models.py:402-776`
...
**Location**: `doclatticeserver/conversations/models.py:778-970`
...
**Location**: `doclatticeserver/conversations/models.py:1004-1055`
...
**Location**: `doclatticeserver/conversations/models.py:1144-1203`
...
**Location**: `doclatticeserver/conversations/models.py:1235-1295`
...
**Location**: `doclatticeserver/conversations/models.py:1326-1392`
...
**Location**: `doclatticeserver/conversations/models.py:60-106`
...
**Location**: `doclatticeserver/conversations/models.py:305-329`
...
**Location**: `doclatticeserver/conversations/signals.py`
...
DocLattice uses Django Guardian for object-level permissions. The collaboration system integrates with this:
...
**Location**: `doclatticeserver/corpuses/models.py:600-676`
...
**Location**: `doclatticeserver/tasks/corpus_tasks.py:240-362`
...
**Location**: `doclatticeserver/tasks/corpus_tasks.py:365-397`
...
from doclatticeserver.tasks.corpus_tasks import update_all_corpus_engagement_metrics
...
app.conf.beat_schedule = {
    'update-engagement-metrics-hourly': {
        'task': 'doclatticeserver.tasks.corpus_tasks.update_all_corpus_engagement_metrics',
