...
**Signal Handler** (`doclatticeserver/conversations/signals.py:18-24`):
...
**Test Files**:
- `doclatticeserver/tests/test_voting.py` - Model and signal tests
- `doclatticeserver/tests/test_voting_mutations_graphql.py` - GraphQL mutation tests
...
docker compose -f test.yml run django python manage.py test \
    doclatticeserver.tests.test_voting \
    doclatticeserver.tests.test_voting_mutations_graphql
```
