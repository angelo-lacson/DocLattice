...
**Location**: `config/graphql/queries.py`, `doclatticeserver/utils/mention_parser.py`
...
**Location**: `doclatticeserver/utils/mention_parser.py`
...
```python
from doclatticeserver.utils.mention_parser import parse_mentions_from_content
...
- **ChatMessage.mentioned_agents** — M2M to `AgentConfiguration` (see [`conversations/models.py`](../../doclatticeserver/conversations/models.py))
- **AgentConfiguration.slug** — Unique `SlugField` for URL-friendly mentions (see [`agents/models.py`](../../doclatticeserver/agents/models.py))
...
- `doclatticeserver/tests/test_agents.py` - Backend tests for search query and mention parsing
