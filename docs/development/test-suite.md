...
docker compose -f test.yml run --rm django pytest doclatticeserver/tests/test_analyzers.py -v

# Run a specific test class
docker compose -f test.yml run --rm django pytest doclatticeserver/tests/test_analyzers.py::TestAnalyzerClass -v

# Run a specific test method
docker compose -f test.yml run --rm django pytest doclatticeserver/tests/test_analyzers.py::TestAnalyzerClass::test_method -v
...
ASYNC_FUNC_PATH = "doclatticeserver.tasks.agent_tasks._run_agent_corpus_action_async"
...
@patch("doclatticeserver.llms.agents")
...
@patch("doclatticeserver.tasks.agent_tasks._run_agent_corpus_action_async")
...
This creates certificates for `localhost`, `doclattice.opensource.legal`, and other testing domains.
