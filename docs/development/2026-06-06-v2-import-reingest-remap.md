...
Run targeted: `docker compose -f test.yml run django pytest doclatticeserver/tests/test_import_v2_reingest_remap.py doclatticeserver/tests/test_remap_pending_annotations.py -n 4 --dist loadscope --create-db`.
