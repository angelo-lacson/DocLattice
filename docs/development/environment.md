We use Black and Flake8 for Python Code Styling. These are run via pre-commit before all commits. If you want to develop extensions or code based on DocLattice, you'll need to setup pre-commit. First, make sure the requirements in `./requirements/local.txt` are installed in your local environment.
