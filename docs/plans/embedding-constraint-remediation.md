...
### Issue 1 & 3: Fixed in `doclatticeserver/shared/Managers.py`
...
### Issue 2: Fixed in `doclatticeserver/annotations/migrations/0059_add_embedding_unique_constraints.py`
...
**File:** `doclatticeserver/shared/Managers.py:368-423`
