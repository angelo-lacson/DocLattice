...
**File: `doclatticeserver/types/enums.py`**
...
**Files:**
- `doclatticeserver/pipeline/parsers/docling_parser_rest.py`
- `doclatticeserver/pipeline/parsers/llamaparse_parser.py`
...
**File: `doclatticeserver/annotations/utils.py`** (new or existing)
