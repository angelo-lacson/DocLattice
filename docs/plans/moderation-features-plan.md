...
**Location**: `doclatticeserver/tasks/agent_tasks.py:859-898`
...
**Files to Modify**:
- `doclatticeserver/tasks/agent_tasks.py`

**Tests**:
- Add concurrent execution test in `doclatticeserver/tests/test_agent_tasks.py`
...
- `doclatticeserver/tests/test_moderation_api.py`

### Modified Files
- `doclatticeserver/tasks/agent_tasks.py` (race condition fix)
