...
**File:** `doclatticeserver/llms/tools/tool_registry.py`
...
**File:** `doclatticeserver/llms/agents/agent_factory.py`
...
3. **Key Files:**
   - `doclatticeserver/llms/tools/tool_factory.py` - CoreTool with permission flags
   - `doclatticeserver/llms/tools/tool_registry.py` - Tool definitions with flags
   - `doclatticeserver/llms/agents/agent_factory.py` - Permission-based filtering
   - `doclatticeserver/llms/tools/pydantic_ai_tools.py` - Runtime permission check
...
**File:** `doclatticeserver/tests/test_tool_write_permission.py`
...
| File | Changes |
|------|---------|
| `doclatticeserver/llms/tools/tool_factory.py` | Add `requires_write_permission` to `CoreTool`, update `from_function()` |
| `doclatticeserver/llms/tools/tool_registry.py` | Add `requires_write_permission` to `ToolDefinition`, mark write tools |
| `doclatticeserver/llms/agents/agent_factory.py` | Add permission check, filter write tools |
