...
This document describes the architecture for extracting, storing, and serving image tokens from PDF documents in DocLattice. The system enables:
...
```python
def _convert_json_to_doclattice(self, document, json_results, ...):
...
```python
from doclatticeserver.utils.pdf_token_extraction import get_image_as_base64
...
**Key Utilities** (`doclatticeserver/utils/multimodal_embeddings.py`):
...
| Component | Path |
|-----------|------|
| Type definitions | `doclatticeserver/types/dicts.py` |
| ContentModality enum | `doclatticeserver/types/enums.py` |
| Extraction utilities | `doclatticeserver/utils/pdf_token_extraction.py` |
| Multimodal embedding utils | `doclatticeserver/utils/multimodal_embeddings.py` |
| Docling parser | `doclatticeserver/pipeline/parsers/docling_parser_rest.py` |
| LlamaParse parser | `doclatticeserver/pipeline/parsers/llamaparse_parser.py` |
| Base embedder | `doclatticeserver/pipeline/base/embedder.py` |
| Multimodal embedder | `doclatticeserver/pipeline/embedders/multimodal_microservice.py` |
| Embedding task | `doclatticeserver/tasks/embeddings_task.py` |
| Image tools for agents | `doclatticeserver/llms/tools/image_tools.py` |
| GIN index migration | `doclatticeserver/annotations/migrations/0054_add_content_modalities_gin_index.py` |
| Tests | `doclatticeserver/tests/test_pdf_token_extraction.py` |
