...
```
doclatticeserver/tests/websocket/
...
| File | Action | Purpose |
|------|--------|---------|
| `doclatticeserver/tests/websocket/test_agent_permission_escalation.py` | CREATE | Main test file |
| `doclatticeserver/tests/websocket/conftest.py` | MODIFY | Add shared fixtures |
| `doclatticeserver/tests/fixtures/permission_fixtures.py` | CREATE | Reusable permission setups |
