...
2. `doclatticeserver/tasks/fork_tasks.py` - fork_corpus task
3. `doclatticeserver/utils/corpus_forking.py` - build_fork_corpus_task utility (CONFIRMED: needs update)
4. `doclatticeserver/tests/test_corpus_fork_round_trip.py` - Add metadata tests
