...
DocLattice frontend uses PostHog for optional, consent-based analytics tracking. This helps understand how users interact with the interface to improve the experience.
