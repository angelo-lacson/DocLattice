...
DocLattice backend uses PostHog to collect anonymous usage telemetry. This data helps guide development priorities by understanding how the platform is used.
