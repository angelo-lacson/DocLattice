...
`DocLatticeAnnotatedDocumentImportType` structure:
...
This follows the same `DocLatticeDocExport` structure used in corpus exports:
...
- **External NLP pipelines**: Run annotation models outside DocLattice and
  import the results
