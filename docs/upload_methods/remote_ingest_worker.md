...
The remote ingest worker runs the **full DocLattice ingestion pipeline**
...
- You want to **offload parsing and embedding** to your own machines instead of
  paying for it on the DocLattice server.
...
```bash
git clone <doclattice repo>          # the worker runs the real parser code
cd doclattice/scripts/remote_ingest

export OC_TARGET_URL=https://doclattice.example.com
...
structure. See [`scripts/remote_ingest/README.md`](https://github.com/angelo-lacson/DocLattice/blob/main/scripts/remote_ingest/README.md)
...
[accelerated images](https://github.com/angelo-lacson/DocLattice/blob/main/compose/accelerated/README.md)
...
[`scripts/remote_ingest/README.md`](https://github.com/angelo-lacson/DocLattice/blob/main/scripts/remote_ingest/README.md#gpu-acceleration-recommended-on-beefy-workstations)
and the [accelerated images README](https://github.com/angelo-lacson/DocLattice/blob/main/compose/accelerated/README.md).
...
DocLattice has two ways to attach document metadata, and the enrichment stage
supports both:
