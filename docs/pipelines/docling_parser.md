...
services:
  docling-parser:
    image: doclattice/docling-parser:latest
    ports:
      - "8000:8000"
    environment:
      - DOCLING_MODELS_PATH=/models/docling
...
4. **Response Processing**
   ...
   - Converts to DocLatticeDocExport format
