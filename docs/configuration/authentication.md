...
This represents your DocLattice backend and defines the audience for access tokens.

1. Go to **Applications > APIs > Create API**
2. Name it (e.g., "DocLattice API")
...
DOCLATTICE_REACT_APP_APPLICATION_DOMAIN=<your-tenant>.auth0.com
DOCLATTICE_REACT_APP_APPLICATION_CLIENT_ID=<your-spa-client-id>
DOCLATTICE_REACT_APP_AUDIENCE=https://your-domain.com/contracts
DOCLATTICE_REACT_APP_API_ROOT_URL=https://your-domain.com
```
