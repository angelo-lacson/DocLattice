...
```python
# doclatticeserver/extracts/migrations/0021_add_extract_filtering_indexes.py
...
```python
# doclatticeserver/extracts/migrations/0022_add_extract_materialized_views.py
...
class DocumentType(DjangoObjectType):
    ...
    def resolve_page_relationships(
        ...
        from doclatticeserver.annotations.query_optimizer import RelationshipQueryOptimizer
...
class ApproveDatacell(graphene.Mutation):
    ...
    def mutate(root, info, datacell_id):
        from doclatticeserver.tasks.materialized_view_tasks import refresh_extract_annotation_mv
        from graphql_relay import from_global_id
...
```python
# doclatticeserver/tasks/extract_orchestrator_tasks.py
...
```python
# doclatticeserver/annotations/signals.py
...
# Add to doclatticeserver/annotations/apps.py:
#
...
```python
# doclatticeserver/tasks/materialized_view_tasks.py
