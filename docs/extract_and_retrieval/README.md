...
DocLattice provides a unified system for extracting structured data from documents and answering questions about document collections using state-of-the-art AI agents.
