...
**Source:** [`doclatticeserver/extracts/models.py`](../../doclatticeserver/extracts/models.py)
...
CELERY_TASK_ROUTES = {
    ...
    'doclatticeserver.tasks.data_extract_tasks.*': {
        'queue': 'ml'
    }
}
```
...
```python
from doclatticeserver.annotations.models import generate_embeddings_from_text
