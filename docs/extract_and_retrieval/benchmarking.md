# Benchmarking DocLattice against LegalBench-RAG

DocLattice ships a benchmark harness under
[`doclatticeserver/benchmarks/`](../../doclatticeserver/benchmarks/) that
...
```python
from doclatticeserver.benchmarks.adapters.legalbench_rag import LegalBenchRAGAdapter
...
(`doclatticeserver/benchmarks/adapters/base.py`) and register it in
`doclatticeserver/benchmarks/management/commands/run_benchmark.py`'s
