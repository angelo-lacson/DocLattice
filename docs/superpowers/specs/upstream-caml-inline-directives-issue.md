...
We have a working prototype in DocLattice ([branch `claude/caml-citation-flagging-AwKgO`](https://github.com/angelo-lacson/DocLattice/tree/claude/caml-citation-flagging-AwKgO)) that includes:
...
3. **Host apps register handlers** — DocLattice registers `@cite`, another app might register `@translate`
