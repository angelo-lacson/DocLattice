...
**File**: `doclatticeserver/constants/document_processing.py`
...
**File**: `doclatticeserver/pipeline/base/embedder.py`
...
**File**: `doclatticeserver/pipeline/embedders/sent_transformer_microservice.py`
...
**File**: `doclatticeserver/tasks/embeddings_task.py`
...
**File**: `doclatticeserver/pipeline/embedders/test_embedder.py`
...
**File**: `doclatticeserver/tests/test_batch_embedding.py`
...
| File | Change |
|------|--------|
| `doclatticeserver/constants/document_processing.py` | Add `EMBEDDING_API_BATCH_SIZE` |
| `doclatticeserver/pipeline/base/embedder.py` | Add `embed_texts_batch()` default |
| `doclatticeserver/pipeline/embedders/sent_transformer_microservice.py` | Add `embed_texts_batch()` override |
| `doclatticeserver/pipeline/embedders/test_embedder.py` | Add `embed_texts_batch()` to both test embedders |
| `doclatticeserver/tasks/embeddings_task.py` | Add `_batch_embed_text_annotations()`, refactor task |
| `doclatticeserver/tests/test_batch_embedding.py` | New test file |

## What does NOT change

- `doclatticeserver/tasks/corpus_tasks.py` — callers already pass `embedder_path`
- `doclatticeserver/pipeline/embedders/multimodal_microservice.py` — already has `embed_texts_batch()`
