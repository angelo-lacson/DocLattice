...
the host application (DocLattice) **resolves** them against the corpus
...
### Phase 2 — Resolution (DocLattice frontend)

DocLattice already has `SEMANTIC_SEARCH_ANNOTATIONS` — a GraphQL query
