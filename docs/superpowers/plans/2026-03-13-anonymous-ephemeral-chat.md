...
**Files:**
- Modify: `doclatticeserver/llms/agents/core_agents.py:1108-1116` (__init__)
- Modify: `doclatticeserver/llms/agents/core_agents.py:1181-1204` (create_for_corpus)
- Test: `doclatticeserver/tests/test_core_agents.py`

- [ ] **Step 1: Write test for ephemeral buffer initialization**

In `doclatticeserver/tests/test_core_agents.py`, add:

```python
import pytest
from types import SimpleNamespace
from unittest.mock import MagicMock, AsyncMock
from doclatticeserver.llms.agents.core_agents import CoreConversationManager, AgentConfig
...
Run: `docker compose -f test.yml run --rm django pytest doclatticeserver/tests/test_core_agents.py::TestEphemeralConversationManager::test_ephemeral_manager_has_empty_buffer -v`

Expected: FAIL — `_ephemeral_messages` attribute not found.

- [ ] **Step 3: Implement ephemeral buffer fields in __init__**

In `doclatticeserver/llms/agents/core_agents.py`, modify `__init__` (line 1108):
...
```bash
git add doclatticeserver/llms/agents/core_agents.py doclatticeserver/tests/test_core_agents.py
...
**Files:**
- Modify: `doclatticeserver/llms/agents/core_agents.py:483-487` (CoreAgentBase.create_placeholder_message — fix delegation)
- Modify: `doclatticeserver/llms/agents/core_agents.py:1308-1330` (CoreConversationManager.create_placeholder_message)
- Modify: `doclatticeserver/llms/agents/core_agents.py:1393-1410` (CoreConversationManager.store_user_message)
- Test: `doclatticeserver/tests/test_core_agents.py`

- [ ] **Step 1: Write tests for ephemeral message storage**

Add to `TestEphemeralConversationManager` in `doclatticeserver/tests/test_core_agents.py`:
...
Run: `docker compose -f test.yml run --rm django pytest doclatticeserver/tests/test_core_agents.py::TestEphemeralConversationManager -k "store_user_message or placeholder or sequential" -v`
...
**Files:**
- Modify: `doclatticeserver/llms/agents/core_agents.py:1241-1260` (get_conversation_messages)
- Modify: `doclatticeserver/llms/agents/core_agents.py:1343-1377` (complete_message)
- Modify: `doclatticeserver/llms/agents/core_agents.py:1444-1470` (update_message)
- Test: `doclatticeserver/tests/test_core_agents.py`
...
Run: `docker compose -f test.yml run --rm django pytest doclatticeserver/tests/test_core_agents.py::TestEphemeralConversationManager -k "complete_message or update_message or get_conversation or token_estimate" -v`
...
Run: `docker compose -f test.yml run --rm django pytest doclatticeserver/tests/test_core_agents.py::TestEphemeralConversationManager -v`
...
**Files:**
- Modify: `doclatticeserver/llms/agents/core_agents.py` (add property after __init__)
- Test: `doclatticeserver/tests/test_core_agents.py`
...
Run: `docker compose -f test.yml run --rm django pytest doclatticeserver/tests/test_core_agents.py::TestEphemeralConversationManager -k "context_exhausted or context_not_exhausted" -v`
...
**Files:**
- Modify: `doclatticeserver/llms/agents/core_agents.py` (complete_message ephemeral branch)
- Test: `doclatticeserver/tests/test_core_agents.py`
...
Run: `docker compose -f test.yml run --rm django pytest doclatticeserver/tests/test_core_agents.py::TestEphemeralConversationManager -k "skips_none or skips_zero" -v`
...
- Test: `doclatticeserver/tests/websocket/test_unified_agent_consumer.py`

- [ ] **Step 1: Write test for context exhaustion cutoff**

Add a new test class to `doclatticeserver/tests/websocket/test_unified_agent_consumer.py` (or create the file if it doesn't exist). If the existing test infrastructure is too complex to unit-test the consumer directly, write a focused integration test:
...
Run: `docker compose -f test.yml run --rm django pytest doclatticeserver/tests/websocket/test_unified_agent_consumer.py::TestContextExhaustionCutoff -v`
...
Run: `docker compose -f test.yml run --rm django pytest doclatticeserver/tests/test_core_agents.py -v`
...
```bash
git add config/websocket/consumers/unified_agent_conversation.py doclatticeserver/tests/websocket/test_unified_agent_consumer.py
