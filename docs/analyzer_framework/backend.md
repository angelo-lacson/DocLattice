...
The DocLattice backend supports two distinct analyzer frameworks for processing documents and creating annotations:
...
**File**: `/doclatticeserver/utils/analysis.py`
...
**File**: `/doclatticeserver/analyzer/models.py`
...
**File**: `/doclatticeserver/shared/decorators.py`
...
**File**: `/doclatticeserver/utils/analyzer.py`
...
**File**: `/doclatticeserver/documents/models.py`
