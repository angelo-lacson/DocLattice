...
- IDOR rule (CLAUDE.md): query by id, return the *same* message for
  ...
  `doclatticeserver/utils/permissioning.py`) already does this.
...
**Files:**
- Create: `doclatticeserver/corpuses/services/corpus_service.py`
- Modify: `doclatticeserver/corpuses/services/__init__.py`
...
**Files:**
- Create: `doclatticeserver/tests/test_corpus_service.py`
...
- [ ] **Step 2:** Run `pytest doclatticeserver/tests/test_corpus_service.py
...
For each file: replace `from doclatticeserver.corpuses.corpus_objs_service
import CorpusObjsService` with imports of the specific owning service(s) from
`doclatticeserver.corpuses.services`, and rewrite each `CorpusObjsService.X`
...
- `doclatticeserver/discovery/views.py` → `CorpusDocumentService`
- `doclatticeserver/documents/document_service.py` → `CorpusDocumentService`
- `doclatticeserver/llms/agents/core_agents.py` → `CorpusDocumentService`
- `doclatticeserver/llms/tools/core_tools/annotations.py` → `CorpusDocumentService`
- `doclatticeserver/llms/tools/core_tools/caml_article.py` → `CorpusDocumentService`
- `doclatticeserver/llms/tools/core_tools/document_indexing.py` → `CorpusDocumentService`
- `doclatticeserver/llms/tools/core_tools/documents.py` → `FolderCRUDService` (get_folder_by_id), `FolderDocumentService` (move_document_to_folder)
- `doclatticeserver/llms/tools/core_tools/pii.py` → `CorpusDocumentService`
- `doclatticeserver/mcp/resources.py` → `CorpusDocumentService`
- `doclatticeserver/mcp/server.py` → `CorpusDocumentService`
- `doclatticeserver/mcp/tools.py` → `CorpusDocumentService`
- `doclatticeserver/tasks/badge_tasks.py` → `CorpusDocumentService`
- `doclatticeserver/tasks/import_tasks.py` → `FolderCRUDService`
- `doclatticeserver/utils/import_v2.py` → `FolderCRUDService`
...
- [ ] Delete `doclatticeserver/corpuses/corpus_objs_service.py`.
...
- [ ] `grep -rn "CorpusObjsService\|corpus_objs_service" --include=*.py .`
  returns nothing.
- [ ] `pytest doclatticeserver/tests/test_corpus_objs_service.py
  doclatticeserver/tests/test_corpus_services_package.py
  doclatticeserver/tests/test_corpus_service.py
  doclatticeserver/tests/test_base_service.py -n 4 --dist loadscope --create-db`
  — all PASS.
