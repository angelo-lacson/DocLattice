...
This tutorial walks through extracting structured data from documents using DocLattice' extraction system.
...
- DocLattice instance running with Celery workers
