...
DocLattice integrates with a powerful NLP engine called Gremlin Engine ("Gremlin"). If you run a Gremlin analyzer
...
and reflect this in DocLattice. It's on our roadmap to improve this integration. In the meantime, the example analyzers
