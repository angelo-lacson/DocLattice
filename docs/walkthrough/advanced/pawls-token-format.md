# Understanding Document Ground Truth in DocLattice

DocLattice utilizes the [PAWLs format](https://github.com/allenai/pawls) for representing documents and
...
In DocLattice, every document is processed through a pipeline that extracts and structures text and layout
...
DocLattice allows users to annotate documents using the PAWLs layer. Annotations are stored as a dictionary mapping
...
The PAWLs format in DocLattice provides a powerful and flexible way to represent and annotate complex documents. By
...
annotation and analysis tasks in the DocLattice project.
