...
This guide shows you how to create custom data extraction pipelines for DocLattice using our modern agent framework.
...
- **[Django Annotation Vector Store](../../extract_and_retrieval/intro_to_django_annotation_vector_store.md)** - How DocLattice integrates with vector search
...
DocLattice' default extraction pipeline uses our agent framework to run queries specified for a
...
- **Corpus Integration**: Works with DocLattice' vector store and annotation system
...
1. **Add your task** to `doclatticeserver/tasks/data_extract_tasks.py`
