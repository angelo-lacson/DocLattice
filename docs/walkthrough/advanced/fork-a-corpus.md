...
techniques and data and collectively achieve what we could never do alone. DocLattice is designed to make it
super easy to share and re-use annotation data.

In DocLattice, we introduce the concept of "forking" a corpus - basically creating a copy of public or private corpus,
