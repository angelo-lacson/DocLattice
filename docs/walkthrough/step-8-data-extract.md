...
You can easily use DocLattice to create an "Extract" - a collection of queries and natural language-specified data
...
DocLattice. We hope to do more performance optimization in a v2 minor release. We haven't optimized for performance
*at all*.
