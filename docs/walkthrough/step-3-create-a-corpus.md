...
3. Click "Create Corpus" to bring up the Create Corpus dialog. If you've already created a labelset or have a
   ...
   ![](../assets/images/screenshots/auto/corpus--corpus-modal--initial.png)
...
3. A dialog will pop up asking you to select a corpus to add the documents to. Select the desired corpus.
   ![](../assets/images/screenshots/auto/corpus--add-to-corpus-modal--initial.png)
...
**Note**: If you have an DocLattice export file and proper permissions, you can also import a corpus, documents,
