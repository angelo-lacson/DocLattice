...
The DocLattice application implements rate limiting at two levels:
...
- **Domains**: `doclattice.opensource.legal`, `www.doclattice.opensource.legal`
...
docker compose -f test.yml run django python manage.py test doclatticeserver.tests.test_rate_limiting
...
- Verify Traefik is healthy: `docker logs doclattice-traefik-1`
- Check Redis connectivity: `docker exec doclattice-redis-1 redis-cli ping`
...
- Check Django logs: `docker logs doclattice-django-1`
- Verify frontend is running: `docker logs doclattice-frontend-1`
