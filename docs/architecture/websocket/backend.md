...
`UnifiedAgentConsumer` uses the unified LLM agent API (`doclatticeserver.llms.agents`) which provides:
...
- [`doclatticeserver/llms/agents/`](../../../doclatticeserver/llms/agents/): Agent implementations
- [`doclatticeserver/conversations/models.py`](../../../doclatticeserver/conversations/models.py): Database models
