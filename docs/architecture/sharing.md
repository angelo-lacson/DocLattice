# DocLattice Sharing Architecture
...
| File | Purpose |
|------|---------|
| `doclatticeserver/utils/permissioning.py` | Core permission utilities |
| `doclatticeserver/types/enums.py` | `PermissionTypes` enum |
...
| `doclatticeserver/utils/sharing.py` | `make_corpus_public()` logic |
...
**File**: New migration in `doclatticeserver/corpuses/migrations/`
