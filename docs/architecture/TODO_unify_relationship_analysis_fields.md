...
See: `doclatticeserver/annotations/models.py` - `Relationship.clean()` method (lines 275-305)
...
See: `doclatticeserver/annotations/query_optimizer.py` (lines 401-450)
...
### Tests
Comprehensive tests added in `doclatticeserver/tests/permissioning/test_query_optimizer_methods.py`:
...
- `doclatticeserver/annotations/models.py` - Model definition
- `doclatticeserver/annotations/query_optimizer.py` - Query logic (already updated with privacy filtering)
...
- Privacy filtering: `doclatticeserver/annotations/query_optimizer.py` (lines 401-450)
