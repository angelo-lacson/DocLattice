...
This document provides a high-level overview of DocLattice' core Django models, their relationships, and primary use cases.
...
│  │              │  M:N    │ (annotation) │         │   (shared across docs)   │    │
│  └──────┬───────┘         └──────────────┘         └──────────────────────────┘    │
│         │                                                                           │
│         │ 1:N                                                                       │
│         ▼                                                                           │
...
#### Document
**Location:** `doclatticeserver/documents/models.py`
...
#### Corpus
**Location:** `doclatticeserver/corpuses/models.py`
...
Immutable, shared structural annotations for document content.
...
| `pawls_parse_file` | Shared PAWLS data |

**Uses:** Deduplicates structural annotations across corpus-isolated copies of the same document content.
...
#### Analyzer
**Location:** `doclatticeserver/analyzer/models.py`
...
#### Fieldset
**Location:** `doclatticeserver/extracts/models.py`
...
DocLattice uses django-guardian for object-level permissions.
