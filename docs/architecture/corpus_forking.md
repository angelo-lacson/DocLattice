...
| Fork Task | `doclatticeserver/tasks/fork_tasks.py` | Async Celery task that clones all data |
| Utility Function | `doclatticeserver/utils/corpus_forking.py` | Programmatic fork (used by tests) |
...
Location: `doclatticeserver/tests/test_corpus_fork_round_trip.py`
...
docker compose -f test.yml run django pytest doclatticeserver/tests/test_corpus_forking.py -v
```
