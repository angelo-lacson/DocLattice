...
DocLattice distinguishes between two fundamentally different types of annotations:
...
```python
# In doclatticeserver/annotations/query_optimizer.py
...
```python
# In doclatticeserver/llms/vector_stores/core_vector_stores.py
...
`doclatticeserver/utils/subtree_groups.py`) between the relationship-import
