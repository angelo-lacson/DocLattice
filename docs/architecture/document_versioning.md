...
DocLattice implements a **dual-tree versioning architecture** for document management that provides:
...
### Document Model (`doclatticeserver/documents/models.py`)
...
### DocumentPath Model (`doclatticeserver/documents/models.py`)
...
### StructuralAnnotationSet Model (`doclatticeserver/annotations/models.py`)
...
All operations in `doclatticeserver/documents/versioning.py`:
...
**Location**: `doclatticeserver/tests/test_document_versioning.py`
...
- **Models**: `doclatticeserver/documents/models.py`
- **Operations**: `doclatticeserver/documents/versioning.py`
- **Corpus Integration**: `doclatticeserver/corpuses/models.py` (add_document, import_content)
- **Annotations**: `doclatticeserver/annotations/models.py` (StructuralAnnotationSet)
- **Tests**: `doclatticeserver/tests/test_document_versioning.py`
