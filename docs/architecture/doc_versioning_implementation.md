...
Successfully implemented the complete dual-tree versioning architecture for document management in DocLattice. This implementation provides full version history tracking, time-travel capabilities, **corpus-isolated document management** with optional provenance tracking, and **shared structural annotations** for storage efficiency.
...
- `doclatticeserver/annotations/migrations/0048_add_structural_annotation_set.py` - Adds model and XOR constraints
- `doclatticeserver/documents/migrations/0026_add_structural_annotation_set.py` - Adds FK to Document
...
**Phase 1**:
- `doclatticeserver/documents/models.py` - Added TreeNode, DocumentPath model
- `doclatticeserver/documents/versioning.py` - All operations (367 lines)
- `doclatticeserver/tests/test_document_versioning.py` - 33 tests

**Phase 2**:
- `doclatticeserver/documents/models.py` - Added `source_document` field
- `doclatticeserver/corpuses/models.py` - Updated `add_document()`, `import_content()`
- `doclatticeserver/tests/test_document_path_migration.py` - Migration tests

**Phase 2.5**:
- `doclatticeserver/annotations/models.py` - Added StructuralAnnotationSet, XOR constraints
- `doclatticeserver/annotations/query_optimizer.py` - Dual-query support
- `doclatticeserver/llms/vector_stores/core_vector_stores.py` - Version filtering updates
...
- `doclatticeserver/tests/test_query_optimizer_structural_sets.py` - 10 tests
