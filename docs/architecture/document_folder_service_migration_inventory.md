...
|---|------|------|-------|------------------|--------------|
| 1 | `import_corpus()` | doclatticeserver/tasks/import_tasks.py | 40-227 | Uses legacy `corpus.documents.add()` pattern, direct `Document.objects.create()` | Use `DocumentFolderService.add_document_to_corpus()` |
| 2 | `import_document_to_corpus()` | doclatticeserver/tasks/import_tasks.py | 230-343 | Uses legacy `corpus.documents.add()`, direct `Document.objects.create()` | Use `DocumentFolderService.add_document_to_corpus()` |
