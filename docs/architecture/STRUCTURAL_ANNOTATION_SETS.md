...
**File**: `doclatticeserver/pipeline/parsers/base_parser.py`
...
**File**: `doclatticeserver/annotations/query_optimizer.py`
...
### Backend
- [ ] `doclatticeserver/annotations/models.py` - Add StructuralAnnotationSet model
- [ ] `doclatticeserver/documents/models.py` - Add structural_annotation_set FK
- [ ] `doclatticeserver/documents/versioning.py` - Update import_document
- [ ] `doclatticeserver/corpuses/models.py` - Update add_document, import_content
- [ ] `doclatticeserver/annotations/query_optimizer.py` - Update query methods
- [ ] `doclatticeserver/annotations/signals.py` - Update process_structural_annotation_for_corpuses
- [ ] `doclatticeserver/pipeline/parsers/base_parser.py` - Create annotation sets
- [ ] `doclatticeserver/pipeline/parsers/nlm_ingest_parser.py` - Use annotation sets
- [ ] `doclatticeserver/pipeline/parsers/docling_parser.py` - Use annotation sets
- [ ] `config/graphql/graphene_types.py` - Add new resolvers
- [ ] `doclatticeserver/shared/QuerySets.py` - Update annotation visibility queries
- [ ] `doclatticeserver/llms/vector_stores/core_vector_stores.py` - Handle structural set
