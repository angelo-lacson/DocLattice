...
This plan outlines how to expose the dual-tree versioning architecture (content + path history) in the DocLattice frontend while maintaining performance and providing an intuitive, filesystem-like user experience.
...
```python
# In doclatticeserver/documents/versioning.py
...
- [x] **Phase 1.1 Tests: Backend GraphQL Tests**
  - Created comprehensive test suite: `doclatticeserver/tests/test_document_versioning_graphql.py`
  - Test classes:
...
- [x] **Phase 1.3 Tests: Mutation Tests** (COMPLETED)
  ...
  - **File**: `doclatticeserver/tests/test_document_versioning_graphql.py`
...
- `doclatticeserver/tests/test_document_versioning_graphql.py` - NEW: GraphQL tests
