...
**File**: `doclatticeserver/annotations/signals.py`
...
**File**: `doclatticeserver/llms/vector_stores/core_vector_stores.py`
...
**File**: `doclatticeserver/tests/test_dual_embeddings.py`
...
**File**: `doclatticeserver/tests/test_global_search.py`
...
class TestGlobalSearch(TestCase):
    ...
    def test_global_search_finds_corpus_document(self):
        ...
        # See doclatticeserver/corpuses/models.py for implementation
...
**File**: `doclatticeserver/tests/test_document_embedding_lifecycle.py`
...
**File**: `doclatticeserver/annotations/management/commands/backfill_default_embeddings.py`
