...
implement simple, span-based analytics directly within the DocLattice ecosystem.

## Action Execution Overview

The following flowchart illustrates the CorpusAction system in DocLattice, demonstrating the process that occurs when
...
processing based on predefined rules, enabling efficient and flexible handling of new documents within the DocLattice
platform.
...
This system provides a flexible framework for automating document processing in DocLattice. By configuring
