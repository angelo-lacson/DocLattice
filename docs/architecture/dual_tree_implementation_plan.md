...
> - Models: [doclatticeserver/documents/models.py](../../doclatticeserver/documents/models.py) (Document, DocumentPath)
> - Operations: [doclatticeserver/documents/versioning.py](../../doclatticeserver/documents/versioning.py)
> - Tests: [doclatticeserver/tests/test_document_versioning.py](../../doclatticeserver/tests/test_document_versioning.py)
>
...
> **IMPLEMENTED**: See [doclatticeserver/documents/models.py](../../doclatticeserver/documents/models.py)
...
> **IMPLEMENTED**: See [doclatticeserver/documents/versioning.py](../../doclatticeserver/documents/versioning.py)
...
> **IMPLEMENTED**: See migrations in `doclatticeserver/documents/migrations/`
...
> - [`doclatticeserver/documents/migrations/`](../../doclatticeserver/documents/migrations/) - DocumentPath model creation
> - [`doclatticeserver/corpuses/models.py`](../../doclatticeserver/corpuses/models.py) - `Corpus.add_document()` and `Corpus.get_documents()` methods
...
> **IMPLEMENTED**: See [doclatticeserver/tests/test_document_versioning.py](../../doclatticeserver/tests/test_document_versioning.py)
