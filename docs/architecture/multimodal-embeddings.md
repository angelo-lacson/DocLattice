...
The `doclatticeserver/utils/multimodal_embeddings.py` module provides:
...
docker compose -f test.yml run django pytest \
    doclatticeserver/tests/test_multimodal_integration.py -v
```
