...
DocLattice makes extensive use of celery, a powerful, mature python framework for distributed and asynchronous
...
We are always working to make DocLattice more fault-tolerant and stable. That said, due to
...
DocLattice should be able to process the pdfs and make them compatible with our annotation tools.
