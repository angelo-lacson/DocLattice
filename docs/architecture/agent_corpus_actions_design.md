...
**Source**: [`doclatticeserver/corpuses/models.py`](../../doclatticeserver/corpuses/models.py) (lines 830-942)
...
**Source**: [`doclatticeserver/agents/models.py`](../../doclatticeserver/agents/models.py) (lines 223-379)
...
**Source**: [`doclatticeserver/tasks/agent_tasks.py`](../../doclatticeserver/tasks/agent_tasks.py)
...
**Source**: [`doclatticeserver/tasks/corpus_tasks.py`](../../doclatticeserver/tasks/corpus_tasks.py) (lines 146-354)
...
The agent factory (`doclatticeserver/llms/api.py`) supports `skip_approval_gate` parameter for automated corpus actions. When enabled, all tools run without requiring user approval.
...
| Category | File |
|----------|------|
| **Models** | [`doclatticeserver/corpuses/models.py`](../../doclatticeserver/corpuses/models.py) - CorpusAction, CorpusActionExecution |
| **Models** | [`doclatticeserver/agents/models.py`](../../doclatticeserver/agents/models.py) - AgentActionResult |
| **Tasks** | [`doclatticeserver/tasks/agent_tasks.py`](../../doclatticeserver/tasks/agent_tasks.py) - Agent execution tasks |
| **Tasks** | [`doclatticeserver/tasks/corpus_tasks.py`](../../doclatticeserver/tasks/corpus_tasks.py) - Action dispatch |
| **Tasks** | [`doclatticeserver/tasks/doc_tasks.py`](../../doclatticeserver/tasks/doc_tasks.py) - Document unlock triggers |
...
| **Tests** | [`doclatticeserver/tests/test_agent_corpus_action_task.py`](../../doclatticeserver/tests/test_agent_corpus_action_task.py) |
| **Tests** | [`doclatticeserver/tests/test_corpus_document_actions.py`](../../doclatticeserver/tests/test_corpus_document_actions.py) |
...
**Source**: [`doclatticeserver/corpuses/models.py`](../../doclatticeserver/corpuses/models.py) (lines 443-624)
...
**Source**: [`doclatticeserver/documents/versioning.py`](../../doclatticeserver/documents/versioning.py)

Same pattern as `add_document()` - triggers actions directly if document is ready.

#### Direct Trigger: set_doc_lock_state()

**Source**: [`doclatticeserver/tasks/doc_tasks.py`](../../doclatticeserver/tasks/doc_tasks.py) (lines 60-118)
...
**Source**: [`doclatticeserver/tests/test_corpus_document_actions.py`](../../doclatticeserver/tests/test_corpus_document_actions.py)
...
**Source**: [`doclatticeserver/tests/test_agent_corpus_action_task.py`](../../doclatticeserver/tests/test_agent_corpus_action_task.py)
