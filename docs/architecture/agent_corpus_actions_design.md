...
**File**: `doclatticeserver/tasks/agent_tasks.py` (new file)
...
**File**: `doclatticeserver/tasks/corpus_tasks.py` (modify existing)
...
**File**: `doclatticeserver/llms/api.py`
...
**File**: `doclatticeserver/llms/agents/core_agents.py`
...
**File**: `doclatticeserver/llms/tools/pydantic_ai_tools.py`
...
- **Models**: `doclatticeserver/corpuses/models.py`, `doclatticeserver/agents/models.py`
- **Tasks**: `doclatticeserver/tasks/agent_tasks.py`, `doclatticeserver/tasks/corpus_tasks.py`, `doclatticeserver/tasks/doc_tasks.py`
- **Versioning**: `doclatticeserver/documents/versioning.py` (import_document triggers actions)
...
def add_document(self, document, path, user, folder=None, ...):
    ...
    if not corpus_copy.backend_lock:
        from doclatticeserver.tasks.corpus_tasks import process_corpus_action
...
def set_doc_lock_state(*args, locked: bool, doc_id: int):
    ...
    """
    from doclatticeserver.corpuses.models import CorpusActionTrigger
...
See `doclatticeserver/tests/test_corpus_document_actions.py` for tests covering:
