...
| **Supersedes / builds on** | 0001 — Generic scheduled scraping + corpus groups ([PR #1444](https://github.com/angelo-lacson/DocLattice/pull/1444); doc lands at `./0001-scheduled-scraping-and-corpus-groups.md` once merged) |
