...
The original export/import system was designed early in DocLattice development and only handled:
...
```typescript
interface DocLatticeExportDataJsonV2Type {
  // Version marker
  version: "2.0";

  // ===== V1 FIELDS (maintained for compatibility) =====
  annotated_docs: Record<string, DocLatticeDocExport>;
  ...
  relationships: DocLatticeRelationshipType[];
...
This enables reliable backup/restore and seamless dataset sharing for the DocLattice community.
