...
DocLattice auto-assigns every user a Reddit-style display handle (e.g.
...
| Concern | Where |
|---|---|
| Field declaration | `doclatticeserver/users/models.py` (`User.handle`) |
| Word lists | `doclatticeserver/users/handle_wordlists.py` |
| Pure generator | `doclatticeserver/users/handle_generator.py::generate_handle` |
| GraphQL exposure | `config/graphql/user_types.py::UserType.resolve_display_name` |
| Schema migration | `doclatticeserver/users/migrations/0027_user_handle.py` |
| Backfill migration | `doclatticeserver/users/migrations/0028_backfill_user_handles.py` |
| Re-run command | `doclatticeserver/users/management/commands/regenerate_user_handles.py` |
| Tunables (constants) | `doclatticeserver/constants/users.py` |
...
`doclatticeserver/constants/users.py`:
...
`doclatticeserver/tests/test_user_handle.py` covers:
