# DocLattice Corpus Export Format Specification

## Overview

DocLattice exports a corpus as a **ZIP archive** containing a `data.json`
...
DocLattice supports a **hierarchical document index** (within-document table
...
To include a document index in an `DocLatticeDocExport`:
