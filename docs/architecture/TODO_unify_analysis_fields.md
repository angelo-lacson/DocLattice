...
See: `doclatticeserver/annotations/models.py` - `Annotation.clean()` method
...
- `doclatticeserver/annotations/query_optimizer.py` - Query logic
- `doclatticeserver/graphql/types.py` - GraphQL schema
- `doclatticeserver/graphql/mutations/` - Mutation logic
- `doclatticeserver/utils/analyzer.py` - Analysis import logic
