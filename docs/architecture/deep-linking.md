...
This document describes DocLattice' deep-linking conventions, implementation patterns, and known gaps.
...
Deep-linking in DocLattice allows users to share URLs that restore the complete application state, including:
