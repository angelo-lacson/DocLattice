...
- `doclatticeserver/corpuses/models.py` (`get_document_count` methods)
...
### Location
```
doclatticeserver/corpuses/folder_service.py
```
...
def _update_document_folder_assignment(
    ...
    from doclatticeserver.corpuses.models import CorpusDocumentFolder
...
1. Create `doclatticeserver/corpuses/folder_service.py`
