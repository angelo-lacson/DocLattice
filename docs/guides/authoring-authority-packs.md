...
`doclatticeserver/enrichment/data/authority_packs/bolivia/` — read it alongside
...
Tests for the mechanics live in `doclatticeserver/tests/test_authority_pack.py`,
